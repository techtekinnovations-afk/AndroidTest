...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> collector, Continuation<? super Unit> $completion) {
        ...
        Object combineInternal = CombineKt.combineInternal(collector, new Flow[]{this.$this_combine$inlined, this.$flow$inlined}, FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt(), new FlowKt__ZipKt$combine$1$1(this.$transform$inlined, (Continuation<? super FlowKt__ZipKt$combine$1$1>) null), $completion);
