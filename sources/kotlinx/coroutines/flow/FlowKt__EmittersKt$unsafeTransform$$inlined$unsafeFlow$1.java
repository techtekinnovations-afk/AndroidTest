...
public final class FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> collector, Continuation<? super Unit> $completion) {
        ...
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowKt__EmittersKt$unsafeTransform$1$1(this.$transform$inlined, collector), $completion);
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        ...
        this.$this_unsafeTransform$inlined.collect(new FlowKt__EmittersKt$unsafeTransform$1$1(this.$transform$inlined, collector), $completion);
        return Unit.INSTANCE;
    }
}
