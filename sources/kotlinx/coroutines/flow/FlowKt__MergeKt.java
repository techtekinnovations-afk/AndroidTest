...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    public static final <T> Flow<T> flattenMerge(Flow<? extends Flow<? extends T>> $this$flattenMerge, int concurrency) {
        if (!(concurrency > 0)) {
            ...
            return new ChannelFlowMerge<>($this$flattenMerge, concurrency, (CoroutineContext) null, 0, (BufferOverflow) null, 28, (DefaultConstructorMarker) null);
        } else {
            Flow<? extends Flow<? extends T>> flow = $this$flattenMerge;
            int i = concurrency;
            return FlowKt.flattenConcat($this$flattenMerge);
        }
    }
