...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2 implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> collector, Continuation<? super Unit> $completion) {
        ...
        Intrinsics.needClassReification();
        Object combineInternal = CombineKt.combineInternal(collector, flowArr, new FlowKt__ZipKt$combine$5$1(this.$flows$inlined), new FlowKt__ZipKt$combine$5$2(this.$transform$inlined, (Continuation<? super FlowKt__ZipKt$combine$5$2>) null), $completion);
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        ...
        Intrinsics.needClassReification();
        Intrinsics.needClassReification();
        CombineKt.combineInternal(collector, flowArr, new FlowKt__ZipKt$combine$5$1(this.$flows$inlined), new FlowKt__ZipKt$combine$5$2(this.$transform$inlined, (Continuation<? super FlowKt__ZipKt$combine$5$2>) null), $completion);
        return Unit.INSTANCE;
    }
}
