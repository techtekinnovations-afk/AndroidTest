...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public Object collect(FlowCollector<? super T> collector, Continuation<? super Unit> $completion) {
        ...
        Object emit = collector.emit(this.$this_asFlow$inlined.invoke(), $completion);
