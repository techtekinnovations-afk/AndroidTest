...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    static /* synthetic */ <S, T> Object collectTo$suspendImpl(ChannelFlowOperator<S, T> $this, ProducerScope<? super T> scope, Continuation<? super Unit> $completion) {
        Object flowCollect = $this.flowCollect(new SendingCollector(scope), $completion);
        return flowCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? flowCollect : Unit.INSTANCE;
    }

    static /* synthetic */ <S, T> Object collect$suspendImpl(ChannelFlowOperator<S, T> $this, FlowCollector<? super T> collector, Continuation<? super Unit> $completion) {
        if ($this.capacity == -3) {
            ...
            if (Intrinsics.areEqual((Object) newContext, (Object) collectContext)) {
                ...
                Object collectWithContextUndispatched = $this.collectWithContextUndispatched(collector, newContext, $completion);
