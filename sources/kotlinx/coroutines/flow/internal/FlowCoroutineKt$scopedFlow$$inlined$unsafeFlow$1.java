...
public final class FlowCoroutineKt$scopedFlow$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> collector, Continuation<? super Unit> $completion) {
        ...
        Object flowScope = FlowCoroutineKt.flowScope(new FlowCoroutineKt$scopedFlow$1$1(this.$block$inlined, collector, (Continuation<? super FlowCoroutineKt$scopedFlow$1$1>) null), $completion);
