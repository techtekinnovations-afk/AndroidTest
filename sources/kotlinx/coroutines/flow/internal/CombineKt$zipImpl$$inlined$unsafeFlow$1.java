...
public final class CombineKt$zipImpl$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> collector, Continuation<? super Unit> $completion) {
        ...
        Object coroutineScope = CoroutineScopeKt.coroutineScope(new CombineKt$zipImpl$1$1(this.$flow2$inlined, this.$flow$inlined, collector, this.$transform$inlined, (Continuation<? super CombineKt$zipImpl$1$1>) null), $completion);
