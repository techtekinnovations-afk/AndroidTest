...
public final class FlowKt__TransformKt$withIndex$$inlined$unsafeFlow$1 implements Flow<IndexedValue<? extends T>> {
    ...
    public Object collect(FlowCollector<? super IndexedValue<? extends T>> collector, Continuation<? super Unit> $completion) {
        Continuation<? super Unit> continuation = $completion;
        Object collect = this.$this_withIndex$inlined.collect(new FlowKt__TransformKt$withIndex$1$1(collector, new Ref.IntRef()), $completion);
