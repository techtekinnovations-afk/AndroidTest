...
final class SafeFlow<T> extends AbstractFlow<T> {
    ...
    public SafeFlow(Function2<? super FlowCollector<? super T>, ? super Continuation<? super Unit>, ? extends Object> block2) {
        this.block = block2;
    }

    public Object collectSafely(FlowCollector<? super T> collector, Continuation<? super Unit> $completion) {
