...
public final class FlowKt__TransformKt$runningReduce$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public Object collect(FlowCollector<? super T> collector, Continuation<? super Unit> $completion) {
        ...
        Object collect = this.$this_runningReduce$inlined.collect(new FlowKt__TransformKt$runningReduce$1$1(accumulator, this.$operation$inlined, collector), $completion);
