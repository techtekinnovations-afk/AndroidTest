...
public final class FlowKt__LimitKt$take$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r11, kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        ...
        L_0x002c:
            ...
            kotlin.ResultKt.throwOnFailure(r1)     // Catch:{ AbortFlowException -> 0x0033 }
            goto L_0x0061
        L_0x0033:
            r3 = move-exception
            goto L_0x0065
        L_0x0035:
            ...
            r6.<init>()
            kotlinx.coroutines.flow.Flow r7 = r3.$this_take$inlined     // Catch:{ AbortFlowException -> 0x0062 }
            kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1 r8 = new kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1     // Catch:{ AbortFlowException -> 0x0062 }
            int r9 = r3.$count$inlined     // Catch:{ AbortFlowException -> 0x0062 }
            r8.<init>(r6, r9, r11, r5)     // Catch:{ AbortFlowException -> 0x0062 }
            kotlinx.coroutines.flow.FlowCollector r8 = (kotlinx.coroutines.flow.FlowCollector) r8     // Catch:{ AbortFlowException -> 0x0062 }
            r0.L$0 = r5     // Catch:{ AbortFlowException -> 0x0062 }
            r9 = 1
            r0.label = r9     // Catch:{ AbortFlowException -> 0x0062 }
            java.lang.Object r7 = r7.collect(r8, r0)     // Catch:{ AbortFlowException -> 0x0062 }
