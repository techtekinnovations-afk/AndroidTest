...
final /* synthetic */ class FlowKt__ContextKt {
    ...
    public static final <T> Flow<T> buffer(Flow<? extends T> $this$buffer, int capacity, BufferOverflow onBufferOverflow) {
        ...
        if (capacity >= 0 || capacity == -2 || capacity == -1) {
            ...
            if (z) {
                ...
                BufferOverflow onBufferOverflow3 = onBufferOverflow;
                if (capacity3 == -1) {
                    capacity2 = 0;
                    onBufferOverflow2 = BufferOverflow.DROP_OLDEST;
                } else {
                    capacity2 = capacity3;
                    onBufferOverflow2 = onBufferOverflow3;
                }
                if ($this$buffer instanceof FusibleFlow) {
                    Flow<? extends T> flow = $this$buffer;
                ...
                BufferOverflow onBufferOverflow4 = onBufferOverflow2;
                int capacity4 = capacity2;
                ChannelFlowOperatorImpl channelFlowOperatorImpl = new ChannelFlowOperatorImpl($this$buffer, (CoroutineContext) null, capacity4, onBufferOverflow4, 2, (DefaultConstructorMarker) null);
                int i = capacity4;
                BufferOverflow bufferOverflow = onBufferOverflow4;
    ...
    public static final <T> Flow<T> flowOn(Flow<? extends T> $this$flowOn, CoroutineContext context) {
        ...
        if (Intrinsics.areEqual((Object) context, (Object) EmptyCoroutineContext.INSTANCE)) {
            ...
            return $this$flowOn;
        } else if ($this$flowOn instanceof FusibleFlow) {
            Flow<? extends T> flow = $this$flowOn;
