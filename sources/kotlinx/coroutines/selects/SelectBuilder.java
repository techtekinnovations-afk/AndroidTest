...
public interface SelectBuilder<R> {
    ...
    public static final class DefaultImpls {
        public static <R, P, Q> void invoke(SelectBuilder<? super R> $this, SelectClause2<? super P, ? extends Q> $receiver, Function2<? super Q, ? super Continuation<? super R>, ? extends Object> block) {
            $this.invoke($receiver, null, block);
        }

        @Deprecated(level = DeprecationLevel.ERROR, message = "Replaced with the same extension function", replaceWith = @ReplaceWith(expression = "onTimeout", imports = {"kotlinx.coroutines.selects.onTimeout"}))
        public static <R> void onTimeout(SelectBuilder<? super R> $this, long timeMillis, Function1<? super Continuation<? super R>, ? extends Object> block) {
