...
final class OnTimeout {
    ...
    public OnTimeout(long timeMillis2) {
    ...
    public final void register(SelectInstance<?> select, Object ignoredParam) {
        ...
        ((SelectImplementation) select).disposeOnCompletion(DelayKt.getDelay(context).invokeOnTimeout(this.timeMillis, new OnTimeout$register$$inlined$Runnable$1(select, this), context));
    }
}
