...
public final class SelectKt {
    ...
    public static final <R> Object select(Function1<? super SelectBuilder<? super R>, Unit> builder, Continuation<? super R> $completion) {
        SelectImplementation $this$select_u24lambda_u240 = new SelectImplementation($completion.getContext());
    ...
    /* access modifiers changed from: private */
    public static final boolean tryResume(CancellableContinuation<? super Unit> $this$tryResume, Function3<? super Throwable, Object, ? super CoroutineContext, Unit> onCancellation) {
        Object token = $this$tryResume.tryResume(Unit.INSTANCE, (Object) null, onCancellation);
        if (token == null) {
            return false;
        }
