...
public final class Concurrent_commonKt {
    ...
    public static final <T> T getValue(AtomicReference<T> $this$value) {
        return $this$value.get();
    }

    public static final <T> void setValue(AtomicReference<T> $this$value, T value) {
        $this$value.set(value);
    }

    public static final <T> void loop(AtomicReference<T> $this$loop, Function2<? super AtomicReference<T>, ? super T, Unit> action) {
        while (true) {
