...
public final class SupervisorKt {
    ...
    public static final <R> Object supervisorScope(Function2<? super CoroutineScope, ? super Continuation<? super R>, ? extends Object> block, Continuation<? super R> $completion) {
        Continuation uCont = $completion;
        SupervisorCoroutine coroutine = new SupervisorCoroutine(uCont.getContext(), uCont);
