...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    public V get(Object key) {
        ...
        return ((Core) core$volatile$FU.get(this)).getImpl(key);
    }

    public V put(K key, V value) {
        Object key2 = key;
        Object value2 = value;
        Object oldValue = Core.putImpl$default((Core) core$volatile$FU.get(this), key2, value2, (HashedWeakRef) null, 4, (Object) null);
        if (oldValue == ConcurrentWeakMapKt.REHASH) {
            oldValue = putSynchronized(key2, value2);
        }
        if (oldValue == null) {
    ...
    public V remove(Object key) {
        ...
        Object key2 = key;
        Object oldValue = Core.putImpl$default((Core) core$volatile$FU.get(this), key2, (Object) null, (HashedWeakRef) null, 4, (Object) null);
        if (oldValue == ConcurrentWeakMapKt.REHASH) {
            oldValue = putSynchronized(key2, (Object) null);
        }
        if (oldValue != null) {
            _size$volatile$FU.decrementAndGet(this);
        }
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=K, code=java.lang.Object, for r8v0, types: [K] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final synchronized V putSynchronized(java.lang.Object r8, V r9) {
        /*
            r7 = this;
            monitor-enter(r7)
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r0 = core$volatile$FU     // Catch:{ all -> 0x002d }
            java.lang.Object r0 = r0.get(r7)     // Catch:{ all -> 0x002d }
            kotlinx.coroutines.debug.internal.ConcurrentWeakMap$Core r0 = (kotlinx.coroutines.debug.internal.ConcurrentWeakMap.Core) r0     // Catch:{ all -> 0x002d }
            r1 = r0
        L_0x000c:
            r5 = 4
            r6 = 0
            ...
            r2 = r8
            r3 = r9
            java.lang.Object r8 = kotlinx.coroutines.debug.internal.ConcurrentWeakMap.Core.putImpl$default(r1, r2, r3, r4, r5, r6)     // Catch:{ all -> 0x002d }
            kotlinx.coroutines.internal.Symbol r9 = kotlinx.coroutines.debug.internal.ConcurrentWeakMapKt.REHASH     // Catch:{ all -> 0x002d }
            if (r8 == r9) goto L_0x001e
            monitor-exit(r7)
            return r8
        L_0x001e:
            kotlinx.coroutines.debug.internal.ConcurrentWeakMap$Core r9 = r1.rehash()     // Catch:{ all -> 0x002d }
            r1 = r9
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r9 = core$volatile$FU     // Catch:{ all -> 0x002d }
            r9.set(r7, r1)     // Catch:{ all -> 0x002d }
            r8 = r2
            r9 = r3
            goto L_0x000c
        L_0x002d:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.debug.internal.ConcurrentWeakMap.putSynchronized(java.lang.Object, java.lang.Object):java.lang.Object");
    }
    ...
    private final class Core {
        ...
        private final /* synthetic */ AtomicReferenceArray keys = new AtomicReferenceArray(this.allocated);
        private volatile /* synthetic */ int load$volatile;
        private final int shift = (Integer.numberOfLeadingZeros(this.allocated) + 1);
        private final int threshold = ((this.allocated * 2) / 3);
        private final /* synthetic */ AtomicReferenceArray values = new AtomicReferenceArray(this.allocated);
        ...
        private final void removeCleanedAt(int index) {
            ...
            } while (!Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(getValues(), index, oldValue, (Object) null));
        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            while (true) {
                ...
                if (w == null) {
                    if (value != null) {
                        if (!loadIncremented) {
                            AtomicIntegerFieldUpdater handler$atomicfu$iv = load$volatile$FU;
                            do {
                            ...
                            } while (!handler$atomicfu$iv.compareAndSet(this, i, n + 1));
            ...
            } while (!Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(getValues(), index, oldValue, value));
            return oldValue;
        }
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (!(value instanceof Marked)) {
                            if (Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(getValues(), index, value, ConcurrentWeakMapKt.mark(value))) {
                                break;
                            }
                        } else {
        ...
        private final class KeyValueIterator<E> implements Iterator<E>, KMutableIterator {
            ...
            public E next() {
                if (this.index < Core.this.allocated) {
                    ...
                    V v = this.value;
                    if (v == null) {
                        Intrinsics.throwUninitializedPropertyAccessException(Values.VECTOR_MAP_VECTORS_KEY);
                        v = Unit.INSTANCE;
                    }
