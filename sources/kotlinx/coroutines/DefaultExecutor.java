...
public final class DefaultExecutor extends EventLoopImplBase implements Runnable {
    ...
    static {
        Long l;
        EventLoop.incrementUseCount$default(INSTANCE, false, 1, (Object) null);
            ...
            if (notifyStartup()) {
                while (true) {
                    ...
                    if (parkNanos == Long.MAX_VALUE) {
                        ...
                        long now = access$getTimeSource$p2 != null ? access$getTimeSource$p2.nanoTime() : System.nanoTime();
                    ...
                    if (parkNanos > 0) {
                        ...
                        if (access$getTimeSource$p5 != null) {
                            access$getTimeSource$p5.parkNanos(this, parkNanos);
                        } else {
    ...
    private final synchronized Thread createThreadSync() {
        ...
        if (thread == null) {
            ...
            Thread $this$createThreadSync_u24lambda_u240 = thread;
    ...
    public final synchronized void shutdownForTests(long timeout) {
        ...
        while (debugStatus != 3 && _thread != null) {
            ...
            if (it != null) {
                AbstractTimeSource access$getTimeSource$p = AbstractTimeSourceKt.timeSource;
                if (access$getTimeSource$p != null) {
                    access$getTimeSource$p.unpark(it);
                } else {
