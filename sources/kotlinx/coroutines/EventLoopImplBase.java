...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    private final void setCompleted(boolean value) {
        _isCompleted$volatile$FU.set(this, value);
    }
    ...
    public void scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        ...
        if (timeNanos < DurationKt.MAX_MILLIS) {
            AbstractTimeSource access$getTimeSource$p = AbstractTimeSourceKt.timeSource;
            long now = access$getTimeSource$p != null ? access$getTimeSource$p.nanoTime() : System.nanoTime();
    ...
    private final boolean enqueueImpl(Runnable task) {
        ...
        while (true) {
            ...
            if (queue == null) {
                ...
                Intrinsics.checkNotNull(queue, "null cannot be cast to non-null type kotlinx.coroutines.internal.LockFreeTaskQueueCore<java.lang.Runnable>");
            ...
            do {
                ...
                synchronized (this_$iv) {
                    ...
                    if (first$iv != null) {
                        ...
                        if (z) {
                            threadSafeHeapNode = this_$iv.removeAtImpl(0);
                        }
                    }
                }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v7, resolved type: kotlinx.coroutines.EventLoopImplBase$DelayedTaskQueue} */
    ...
    private final int scheduleImpl(long r6, kotlinx.coroutines.EventLoopImplBase.DelayedTask r8) {
        /*
            ...
            return r0
        L_0x0008:
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r0 = _delayed$volatile$FU
            ...
            r1 = 0
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r2 = _delayed$volatile$FU
            ...
            synchronized (this) {
                ...
                synchronized (this_$iv) {
                    ...
                    if (firstTask == null) {
                        ...
                        long minTime = firstTime - j2 >= 0 ? j2 : firstTime;
                        if (minTime - delayedTaskQueue.timeNow > 0) {
                            delayedTaskQueue.timeNow = minTime;
                        }
                    }
                    if (this.nanoTime - delayedTaskQueue.timeNow < j) {
