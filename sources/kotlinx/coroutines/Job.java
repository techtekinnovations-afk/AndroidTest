...
public interface Job extends CoroutineContext.Element {
    ...
    public static final class DefaultImpls {
        ...
        public static <R> R fold(Job $this, R initial, Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
            return CoroutineContext.Element.DefaultImpls.fold($this, initial, operation);
        }

        public static <E extends CoroutineContext.Element> E get(Job $this, CoroutineContext.Key<E> key) {
