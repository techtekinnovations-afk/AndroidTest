...
public interface ThreadContextElement<S> extends CoroutineContext.Element {
    ...
    public static final class DefaultImpls {
        public static <S, R> R fold(ThreadContextElement<S> $this, R initial, Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
            return CoroutineContext.Element.DefaultImpls.fold($this, initial, operation);
        }

        public static <S, E extends CoroutineContext.Element> E get(ThreadContextElement<S> $this, CoroutineContext.Key<E> key) {
            return CoroutineContext.Element.DefaultImpls.get($this, key);
        }

        public static <S> CoroutineContext minusKey(ThreadContextElement<S> $this, CoroutineContext.Key<?> key) {
            return CoroutineContext.Element.DefaultImpls.minusKey($this, key);
        }

        public static <S> CoroutineContext plus(ThreadContextElement<S> $this, CoroutineContext context) {
