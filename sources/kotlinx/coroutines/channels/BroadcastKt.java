...
public final class BroadcastKt {
    ...
    public static final <E> BroadcastChannel<E> broadcast(ReceiveChannel<? extends E> $this$broadcast, int capacity, CoroutineStart start) {
        return broadcast$default(CoroutineScopeKt.plus(CoroutineScopeKt.plus(GlobalScope.INSTANCE, Dispatchers.getUnconfined()), new BroadcastKt$broadcast$$inlined$CoroutineExceptionHandler$1(CoroutineExceptionHandler.Key)), (CoroutineContext) null, capacity, start, new BroadcastKt$$ExternalSyntheticLambda0($this$broadcast), new BroadcastKt$broadcast$2($this$broadcast, (Continuation<? super BroadcastKt$broadcast$2>) null), 1, (Object) null);
    }

    /* access modifiers changed from: private */
    public static final Unit broadcast$lambda$1(ReceiveChannel $this_broadcast, Throwable it) {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "BroadcastChannel is deprecated in the favour of SharedFlow and is no longer supported")
    public static final <E> BroadcastChannel<E> broadcast(CoroutineScope $this$broadcast, CoroutineContext context, int capacity, CoroutineStart start, Function1<? super Throwable, Unit> onCompletion, Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> block) {
