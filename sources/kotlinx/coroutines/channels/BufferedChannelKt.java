...
public final class BufferedChannelKt {
    ...
    /* access modifiers changed from: private */
    public static final <E> ChannelSegment<E> createSegment(long id, ChannelSegment<E> prev) {
        return new ChannelSegment<>(id, prev, prev.getChannel(), 0);
    }
    ...
    /* access modifiers changed from: private */
    public static final <T> boolean tryResume0(CancellableContinuation<? super T> $this$tryResume0, T value, Function3<? super Throwable, ? super T, ? super CoroutineContext, Unit> onCancellation) {
        Object token = $this$tryResume0.tryResume(value, (Object) null, onCancellation);
        if (token == null) {
            return false;
        }
    ...
    private static final boolean getEbPauseExpandBuffers(long $this$ebPauseExpandBuffers) {
        return (4611686018427387904L & $this$ebPauseExpandBuffers) != 0;
    }

    /* access modifiers changed from: private */
    public static final long constructEBCompletedAndPauseFlag(long counter, boolean pauseEB) {
        return (pauseEB ? 4611686018427387904L : 0) + counter;
    }
}
