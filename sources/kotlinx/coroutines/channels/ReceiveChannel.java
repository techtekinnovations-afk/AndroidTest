...
public interface ReceiveChannel<E> {
    ...
    Object m1563receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    Object m1564tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in the favour of 'tryReceive'. Please note that the provided replacement does not rethrow channel's close cause as 'poll' did, for the precise replacement please refer to the 'poll' documentation", replaceWith = @ReplaceWith(expression = "tryReceive().getOrNull()", imports = {}))
        public static <E> E poll(ReceiveChannel<? extends E> $this) {
            Object result = $this.m1564tryReceivePtdJZtk();
            if (ChannelResult.m1550isSuccessimpl(result)) {
                return ChannelResult.m1546getOrThrowimpl(result);
            }
            Throwable r1 = ChannelResult.m1544exceptionOrNullimpl(result);
            if (r1 == null) {
                return null;
            }
        ...
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L_0x002c:
                ...
                java.lang.Object r4 = r4.m1552unboximpl()
                goto L_0x0044
            L_0x0037:
                kotlin.ResultKt.throwOnFailure(r1)
                r3 = 1
                r0.label = r3
                java.lang.Object r4 = r4.m1563receiveCatchingJP2dKIU(r0)
                if (r4 != r2) goto L_0x0044
                return r2
            L_0x0044:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1545getOrNullimpl(r4)
                return r4
            */
        ...
        public static <E> SelectClause1<E> getOnReceiveOrNull(ReceiveChannel<? extends E> $this) {
