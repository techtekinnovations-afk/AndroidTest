    ...
    public void onCancelling(Throwable cause) {
        ...
        if (cause != null) {
            ...
            if (cancellationException == null) {
                cancellationException = ExceptionsKt.CancellationException(DebugStringsKt.getClassSimpleName(this) + " was cancelled", it);
            }
        }
