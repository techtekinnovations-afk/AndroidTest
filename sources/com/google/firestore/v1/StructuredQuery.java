...
public final class StructuredQuery extends GeneratedMessageLite<StructuredQuery, Builder> implements StructuredQueryOrBuilder {
    ...
    public static final class FieldFilter extends GeneratedMessageLite<FieldFilter, Builder> implements FieldFilterOrBuilder {
        ...
        public void mergeField(FieldReference value) {
            value.getClass();
            if (this.field_ == null || this.field_ == FieldReference.getDefaultInstance()) {
                this.field_ = value;
            } else {
    ...
    public void mergeSelect(Projection value) {
        value.getClass();
        if (this.select_ == null || this.select_ == Projection.getDefaultInstance()) {
            this.select_ = value;
        } else {
    ...
    public void mergeWhere(Filter value) {
        value.getClass();
        if (this.where_ == null || this.where_ == Filter.getDefaultInstance()) {
            this.where_ = value;
        } else {
    ...
    public void mergeStartAt(Cursor value) {
        value.getClass();
        if (this.startAt_ == null || this.startAt_ == Cursor.getDefaultInstance()) {
            this.startAt_ = value;
        } else {
    ...
    public void mergeEndAt(Cursor value) {
        value.getClass();
        if (this.endAt_ == null || this.endAt_ == Cursor.getDefaultInstance()) {
            this.endAt_ = value;
        } else {
    ...
    public void mergeLimit(Int32Value value) {
        value.getClass();
        if (this.limit_ == null || this.limit_ == Int32Value.getDefaultInstance()) {
            this.limit_ = value;
        } else {
