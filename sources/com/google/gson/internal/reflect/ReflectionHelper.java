...
public class ReflectionHelper {
    ...
    public static void makeAccessible(AccessibleObject object) throws JsonIOException {
        try {
            ...
            throw new JsonIOException("Failed making " + getAccessibleObjectDescription(object, false) + " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.", exception);
        }
    }
    ...
    public static String getAccessibleObjectDescription(AccessibleObject object, boolean uppercaseFirstLetter) {
        ...
        if (object instanceof Field) {
            ...
            description = "method '" + method.getDeclaringClass().getName() + "#" + methodSignatureBuilder.toString() + "'";
    ...
    private static class RecordSupportedHelper extends RecordHelper {
        ...
        /* access modifiers changed from: package-private */
        public boolean isRecord(Class<?> raw) {
            try {
