...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public LinkedTreeMap(boolean allowNullValues2) {
        this(NATURAL_ORDER, allowNullValues2);
    }

    public LinkedTreeMap(Comparator<? super K> comparator2, boolean allowNullValues2) {
        ...
        this.allowNullValues = allowNullValues2;
        this.header = new Node<>(allowNullValues2);
    }
    ...
    public Node<K, V> find(K key, boolean create) {
        ...
        if (nearest2 != null) {
            ...
            while (true) {
                if (comparableKey != null) {
                    ...
                    i = comparator2.compare(key, nearest2.key);
                }
                comparison = i;
                if (comparison == 0) {
                    return nearest2;
        ...
        Node<K, V> header2 = this.header;
        if (nearest != null) {
            created = new Node<>(this.allowNullValues, nearest, key, header2, header2.prev);
            if (comparison < 0) {
    ...
    static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        Node(boolean allowNullValue2) {
            this.key = null;
            this.allowNullValue = allowNullValue2;
            this.prev = this;
            this.next = this;
        }

        Node(boolean allowNullValue2, Node<K, V> parent2, K key2, Node<K, V> next2, Node<K, V> prev2) {
            this.parent = parent2;
            this.key = key2;
            this.allowNullValue = allowNullValue2;
            this.height = 1;
        ...
        public V setValue(V value2) {
            if (value2 != null || this.allowNullValue) {
