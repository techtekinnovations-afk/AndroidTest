...
public class zzaf {
    ...
    private final android.os.Bundle zzk(android.os.Bundle r9) throws java.io.IOException {
        /*
            ...
            monitor-enter(r2)
            java.util.Map<java.lang.String, java.lang.Object> r3 = r8.zzcz     // Catch:{ all -> 0x01ec }
            r3.put(r1, r0)     // Catch:{ all -> 0x01ec }
        ...
        L_0x00e6:
            ...
            r3.obj = r2
            android.os.Messenger r5 = r8.zzda     // Catch:{ RemoteException -> 0x00fe }
            r5.send(r3)     // Catch:{ RemoteException -> 0x00fe }
            goto L_0x018f
        L_0x00fe:
            r3 = move-exception
            java.lang.String r3 = "InstanceID"
        ...
        L_0x010e:
            ...
            monitor-enter(r9)
            android.content.BroadcastReceiver r3 = zzcy     // Catch:{ all -> 0x014f }
            if (r3 != 0) goto L_0x0148
            com.google.android.gms.iid.zzah r3 = new com.google.android.gms.iid.zzah     // Catch:{ all -> 0x014f }
            r3.<init>(r8)     // Catch:{ all -> 0x014f }
            zzcy = r3     // Catch:{ all -> 0x014f }
            java.lang.String r3 = "InstanceID"
            boolean r3 = android.util.Log.isLoggable(r3, r4)     // Catch:{ all -> 0x014f }
            if (r3 == 0) goto L_0x012e
            java.lang.String r3 = "InstanceID"
            java.lang.String r4 = "Registered GSF callback receiver"
            android.util.Log.d(r3, r4)     // Catch:{ all -> 0x014f }
        L_0x012e:
            android.content.IntentFilter r3 = new android.content.IntentFilter     // Catch:{ all -> 0x014f }
            java.lang.String r4 = "com.google.android.c2dm.intent.REGISTRATION"
            r3.<init>(r4)     // Catch:{ all -> 0x014f }
            android.content.Context r4 = r8.zzl     // Catch:{ all -> 0x014f }
            java.lang.String r4 = r4.getPackageName()     // Catch:{ all -> 0x014f }
            r3.addCategory(r4)     // Catch:{ all -> 0x014f }
            android.content.Context r4 = r8.zzl     // Catch:{ all -> 0x014f }
            android.content.BroadcastReceiver r5 = zzcy     // Catch:{ all -> 0x014f }
            java.lang.String r6 = "com.google.android.c2dm.permission.SEND"
            r7 = 0
            r4.registerReceiver(r5, r3, r6, r7)     // Catch:{ all -> 0x014f }
        L_0x0148:
            monitor-exit(r9)     // Catch:{ all -> 0x014f }
        ...
        L_0x0152:
            ...
            r9.obj = r2
            com.google.android.gms.iid.MessengerCompat r3 = r8.zzdb     // Catch:{ RemoteException -> 0x0170 }
            r3.send(r9)     // Catch:{ RemoteException -> 0x0170 }
            goto L_0x018f
        L_0x0170:
            r9 = move-exception
        ...
        L_0x018f:
            ...
            monitor-enter(r9)
            java.util.Map<java.lang.String, java.lang.Object> r0 = r8.zzcz     // Catch:{ all -> 0x01e1 }
            java.lang.Object r0 = r0.remove(r1)     // Catch:{ all -> 0x01e1 }
            boolean r1 = r0 instanceof android.os.Bundle     // Catch:{ all -> 0x01e1 }
            if (r1 == 0) goto L_0x01a7
            android.os.Bundle r0 = (android.os.Bundle) r0     // Catch:{ all -> 0x01e1 }
            monitor-exit(r9)     // Catch:{ all -> 0x01e1 }
            return r0
        L_0x01a7:
            boolean r1 = r0 instanceof java.lang.String     // Catch:{ all -> 0x01e1 }
            if (r1 == 0) goto L_0x01b3
            java.io.IOException r1 = new java.io.IOException     // Catch:{ all -> 0x01e1 }
        ...
        L_0x01b3:
            ...
            java.lang.String r0 = java.lang.String.valueOf(r0)     // Catch:{ all -> 0x01e1 }
            java.lang.String r2 = java.lang.String.valueOf(r0)     // Catch:{ all -> 0x01e1 }
            int r2 = r2.length()     // Catch:{ all -> 0x01e1 }
            int r2 = r2 + 12
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x01e1 }
            r3.<init>(r2)     // Catch:{ all -> 0x01e1 }
            java.lang.String r2 = "No response "
            java.lang.StringBuilder r2 = r3.append(r2)     // Catch:{ all -> 0x01e1 }
            java.lang.StringBuilder r0 = r2.append(r0)     // Catch:{ all -> 0x01e1 }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x01e1 }
            android.util.Log.w(r1, r0)     // Catch:{ all -> 0x01e1 }
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x01e1 }
            java.lang.String r1 = "TIMEOUT"
            r0.<init>(r1)     // Catch:{ all -> 0x01e1 }
