...
public class MethodInvocation extends AbstractSafeParcelable {
    ...
    @Deprecated
    public MethodInvocation(int methodKey, int resultStatusCode, int connectionResultStatusCode, long startTimeMillis, long endTimeMillis, String callingModuleId, String callingEntryPoint, int serviceId) {
        this(methodKey, resultStatusCode, connectionResultStatusCode, startTimeMillis, endTimeMillis, callingModuleId, callingEntryPoint, serviceId, -1);
    }
