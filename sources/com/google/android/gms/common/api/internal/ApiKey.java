...
public final class ApiKey<O extends Api.ApiOptions> {
    ...
    public static <O extends Api.ApiOptions> ApiKey<O> getSharedApiKey(Api<O> api, O apiOptions, String attributionTag) {
        return new ApiKey<>(api, apiOptions, attributionTag);
    }
