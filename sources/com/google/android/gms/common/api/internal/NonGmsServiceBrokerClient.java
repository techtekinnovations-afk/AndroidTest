...
public final class NonGmsServiceBrokerClient implements Api.Client, ServiceConnection {
    ...
    public NonGmsServiceBrokerClient(Context context, Looper looper, ComponentName componentName, ConnectionCallbacks callbacks, OnConnectionFailedListener connectionFailedListener) {
        this(context, looper, (String) null, (String) null, componentName, callbacks, connectionFailedListener);
    }
    ...
    /* Debug info: failed to restart local var, previous not found, register: 8 */
    public NonGmsServiceBrokerClient(Context context, Looper looper, String packageName, String action, ConnectionCallbacks callbacks, OnConnectionFailedListener connectionFailedListener) {
        this(context, looper, packageName, action, (ComponentName) null, callbacks, connectionFailedListener);
    }
