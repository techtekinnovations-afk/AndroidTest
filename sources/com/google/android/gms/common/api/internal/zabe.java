...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    private final void zal(int i) {
        ...
        if (this.zal == null) {
            ...
            zabe.zal = new zabi(zabe.zan, zabe, zabe.zaj, zabe.zao, zabe.zat, zabe.zac, zabe.zae, zabe.zaf, zabe.zag, zabe.zav, this);
        }
    }
    ...
    public final void zap(com.google.android.gms.common.api.internal.zada r3) {
        /*
            ...
            r0.lock()
            java.util.Set r0 = r2.zah     // Catch:{ all -> 0x0055 }
            java.lang.String r1 = "GoogleApiClientImpl"
            if (r0 != 0) goto L_0x0016
            java.lang.Exception r3 = new java.lang.Exception     // Catch:{ all -> 0x0055 }
            r3.<init>()     // Catch:{ all -> 0x0055 }
            java.lang.String r0 = "Attempted to remove pending transform when no transforms are registered."
            android.util.Log.wtf(r1, r0, r3)     // Catch:{ all -> 0x0055 }
            goto L_0x0048
        L_0x0016:
            boolean r3 = r0.remove(r3)     // Catch:{ all -> 0x0055 }
            ...
            goto L_0x0048
        L_0x0027:
            java.util.concurrent.locks.Lock r3 = r2.zaj     // Catch:{ all -> 0x0055 }
            r3.lock()     // Catch:{ all -> 0x0055 }
            java.util.Set r3 = r2.zah     // Catch:{ all -> 0x004e }
            if (r3 != 0) goto L_0x0036
            java.util.concurrent.locks.Lock r3 = r2.zaj     // Catch:{ all -> 0x0055 }
            r3.unlock()     // Catch:{ all -> 0x0055 }
            goto L_0x0041
        L_0x0036:
            boolean r3 = r3.isEmpty()     // Catch:{ all -> 0x004e }
            java.util.concurrent.locks.Lock r0 = r2.zaj     // Catch:{ all -> 0x0055 }
            r0.unlock()     // Catch:{ all -> 0x0055 }
            if (r3 == 0) goto L_0x0048
        L_0x0041:
            com.google.android.gms.common.api.internal.zaca r3 = r2.zal     // Catch:{ all -> 0x0055 }
            if (r3 == 0) goto L_0x0048
            r3.zat()     // Catch:{ all -> 0x0055 }
        L_0x0048:
