...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        SafeParcelWriter.writeParcelable(out, 3, this.zzd, flags, false);
    ...
    public Status(int statusCode, String statusMessage) {
        this(statusCode, statusMessage, (PendingIntent) null);
    }

    @Deprecated
    public Status(ConnectionResult connectionResult, String statusMessage, int statusCode) {
        this(statusCode, statusMessage, connectionResult.getResolution(), connectionResult);
    }

    public Status(int statusCode, String statusMessage, PendingIntent pendingIntent) {
        this(statusCode, statusMessage, pendingIntent, (ConnectionResult) null);
    }
