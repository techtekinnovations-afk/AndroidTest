...
public class GcmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (isOrderedBroadcast()) {
            setResultCode(LogSeverity.ERROR_VALUE);
        }
    ...
    private static int zze(Context context, Intent intent) {
        ...
        try {
            ...
            Log.e("GcmReceiver", new StringBuilder(String.valueOf(valueOf4).length() + 45).append("Failed to start service while in background: ").append(valueOf4).toString());
