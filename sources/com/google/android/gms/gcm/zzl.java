...
public final class zzl {
    ...
    public final String toString() {
        int i = this.zzas;
        int i2 = this.zzat;
        return new StringBuilder(74).append("policy=").append(i).append(" initial_backoff=").append(i2).append(" maximum_backoff=").append(this.zzau).toString();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        zzl zzl = (zzl) obj;
        if (zzl.zzas == this.zzas && zzl.zzat == this.zzat && zzl.zzau == this.zzau) {
            return true;
        }
        return false;
    }
