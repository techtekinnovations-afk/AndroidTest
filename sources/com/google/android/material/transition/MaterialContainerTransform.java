...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View viewOverride, int viewIdOverride, ShapeAppearanceModel shapeAppearanceModelOverride) {
        ...
        if (snapshotView.isLaidOut() || snapshotView.getWidth() != 0 || snapshotView.getHeight() != 0) {
            RectF bounds = snapshotView.getParent() == null ? TransitionUtils.getRelativeBounds(snapshotView) : TransitionUtils.getLocationInWindow(snapshotView);
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (startBounds == null || startShapeAppearanceModel2 == null) {
        ...
        if (endBounds == null || endShapeAppearanceModel2 == null) {
            Log.w(TAG, "Skipping due to null end bounds. Ensure end view is laid out and measured.");
            return null;
        }
        final View startView2 = transitionValues.view;
        ...
        RectF drawingViewBounds = TransitionUtils.getLocationInWindow(drawingView);
        ...
        View drawingBaseView2 = drawingBaseView;
        if (!this.appliedThemeValues) {
            maybeApplyThemeValues(drawingBaseView2.getContext(), entering);
        }
        float offsetY2 = offsetY;
        PathMotion pathMotion = getPathMotion();
        float elevationOrDefault = getElevationOrDefault(this.startElevation, startView2);
        float offsetY3 = getElevationOrDefault(this.endElevation, endView2);
        ...
        FadeModeEvaluator fadeModeEvaluator = FadeModeEvaluators.get(this.fadeMode, entering);
        FitModeEvaluator fitModeEvaluator = FitModeEvaluators.get(this.fitMode, entering, startBounds, endBounds);
        int i5 = i;
        int i6 = i4;
        FadeModeEvaluator fadeModeEvaluator2 = fadeModeEvaluator;
        ProgressThresholdsGroup buildThresholdsGroup = buildThresholdsGroup(entering);
        int i7 = i2;
        boolean entering2 = entering;
        float f = elevationOrDefault;
        int i8 = i7;
        float f2 = offsetY2;
        float offsetY4 = offsetX;
        RectF drawableBounds2 = drawableBounds;
        final TransitionDrawable transitionDrawable = new TransitionDrawable(pathMotion, startView2, startBounds, startShapeAppearanceModel2, f, endView2, endBounds, endShapeAppearanceModel2, offsetY3, i5, i8, i3, i6, entering2, z, fadeModeEvaluator2, fitModeEvaluator, buildThresholdsGroup, this.drawDebugEnabled);
        ...
        addListener(new TransitionListenerAdapter() {
            ...
            public void onTransitionEnd(Transition transition) {
                ...
                if (!MaterialContainerTransform.this.holdAtEndEnabled) {
                    ...
                    endView3.setAlpha(1.0f);
                    drawingView2.getOverlay().remove(transitionDrawable2);
                }
            }
        });
        return animator;
    ...
    private static RectF calculateDrawableBounds(View drawingView, View boundingView, float offsetX, float offsetY) {
        ...
        RectF drawableBounds = TransitionUtils.getLocationInWindow(boundingView);
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private TransitionDrawable(PathMotion pathMotion, View startView2, RectF startBounds2, ShapeAppearanceModel startShapeAppearanceModel2, float startElevation2, View endView2, RectF endBounds2, ShapeAppearanceModel endShapeAppearanceModel2, float endElevation2, int containerColor, int startContainerColor, int endContainerColor, int scrimColor, boolean entering2, boolean elevationShadowEnabled2, FadeModeEvaluator fadeModeEvaluator2, FitModeEvaluator fitModeEvaluator2, ProgressThresholdsGroup progressThresholds2, boolean drawDebugEnabled2) {
            ...
            View view = startView2;
            this.startView = view;
            this.startBounds = rectF;
            this.startShapeAppearanceModel = startShapeAppearanceModel2;
            this.startElevation = startElevation2;
            this.endView = endView2;
            RectF rectF2 = endBounds2;
            ...
            PointF startPoint = getMotionPathPoint(rectF);
            PointF endPoint = getMotionPathPoint(rectF2);
            PointF pointF = startPoint;
            PointF pointF2 = endPoint;
            this.motionPathMeasure = new PathMeasure(pathMotion.getPath(startPoint.x, startPoint.y, endPoint.x, endPoint.y), false);
        ...
        private void updateProgress(float progress2) {
            ...
            if (f > 1.0f || f < 0.0f) {
                ...
                this.motionPathMeasure.getPosTan(this.motionPathLength * trajectoryProgress, this.motionPathPosition, (float[]) null);
                motionPathX = motionPathX2 + ((motionPathX2 - this.motionPathPosition[0]) * trajectoryMultiplier);
                motionPathY = motionPathY2 + ((motionPathY2 - this.motionPathPosition[1]) * trajectoryMultiplier);
            } else {
            ...
            float f2 = scaleStartFraction;
            float f3 = scaleEndFraction;
            this.fitModeResult = this.fitModeEvaluator.evaluate(f, scaleStartFraction, scaleEndFraction, this.startBounds.width(), this.startBounds.height(), this.endBounds.width(), this.endBounds.height());
            ...
            this.currentElevationDy = (float) ((int) (this.currentElevation * calculateElevationDyMultiplier(this.currentMaskBounds, this.displayHeight)));
            this.shadowPaint.setShadowLayer(this.currentElevation, (float) ((int) (this.currentElevation * dxMultiplier)), this.currentElevationDy, SHADOW_COLOR);
