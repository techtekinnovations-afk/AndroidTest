...
class TransitionUtils {
    ...
    static ShapeAppearanceModel lerp(ShapeAppearanceModel startValue, ShapeAppearanceModel endValue, RectF startBounds, RectF endBounds, float startFraction, float endFraction, float fraction) {
        ...
        final RectF startBounds2 = startBounds;
        final RectF endBounds2 = endBounds;
        final float startFraction2 = startFraction;
        final float endFraction2 = endFraction;
        final float fraction2 = fraction;
        return transformCornerSizes(startValue, endValue, startBounds2, new CornerSizeBinaryOperator() {
            public CornerSize apply(CornerSize cornerSize1, CornerSize cornerSize2) {
                return new AbsoluteCornerSize(TransitionUtils.lerp(cornerSize1.getCornerSize(startBounds2), cornerSize2.getCornerSize(endBounds2), startFraction2, endFraction2, fraction2));
            }
        });
    }
