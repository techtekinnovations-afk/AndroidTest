...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public boolean onMeasureChild(CoordinatorLayout parent, View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        } else if (header.getFitsSystemWindows()) {
    ...
    public void layoutChild(CoordinatorLayout parent, View child, int layoutDirection) {
        ...
        if (header != null) {
            ...
            Gravity.apply(resolveGravity(lp.gravity), child.getMeasuredWidth(), child.getMeasuredHeight(), available, out, layoutDirection);
