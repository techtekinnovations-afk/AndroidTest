...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    public MaterialAlertDialogBuilder(Context context, int overrideThemeResId) {
        ...
        int surfaceColor = MaterialColors.getColor(context2, com.google.android.material.R.attr.colorSurface, getClass().getCanonicalName());
        TypedArray a = context2.obtainStyledAttributes((AttributeSet) null, com.google.android.material.R.styleable.MaterialAlertDialog, DEF_STYLE_ATTR, DEF_STYLE_RES);
        int backgroundColor = a.getColor(com.google.android.material.R.styleable.MaterialAlertDialog_backgroundTint, surfaceColor);
        a.recycle();
    ...
    public AlertDialog create() {
        ...
        if (this.background instanceof MaterialShapeDrawable) {
            ((MaterialShapeDrawable) this.background).setElevation(decorView.getElevation());
        }
