...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        MaterialShapeDrawable background = new MaterialShapeDrawable(context, (AttributeSet) null, R.attr.materialTimePickerStyle, R.style.Widget_MaterialComponents_TimePicker);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.modeButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                int unused = MaterialTimePicker.this.inputMode = MaterialTimePicker.this.inputMode == 0 ? 1 : 0;
    ...
    public /* synthetic */ void m1738lambda$onViewCreated$0$comgoogleandroidmaterialtimepickerMaterialTimePicker() {
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
    ...
    public void onDestroyView() {
        ...
        if (this.timePickerView != null) {
            this.timePickerView.setOnDoubleTapListener((TimePickerView.OnDoubleTapListener) null);
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int mode, TimePickerView timePickerView2, ViewStub textInputStub2) {
        ...
        if (mode == 0) {
            if (this.timePickerClockPresenter == null) {
                ...
                timePickerClockPresenter2 = this.timePickerClockPresenter;
            }
