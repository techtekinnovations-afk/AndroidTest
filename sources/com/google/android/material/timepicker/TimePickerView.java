...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.toggle.addOnButtonCheckedListener(new TimePickerView$$ExternalSyntheticLambda0(this));
    ...
    public /* synthetic */ void m1740lambda$new$0$comgoogleandroidmaterialtimepickerTimePickerView(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
        if (isChecked && this.onPeriodChangeListener != null) {
            this.onPeriodChangeListener.onPeriodChange(checkedId == R.id.material_clock_period_pm_button ? 1 : 0);
        }
    }
