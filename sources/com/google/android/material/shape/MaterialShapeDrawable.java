...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float elevation) {
        return createWithElevationOverlay(context, elevation, (ColorStateList) null);
    }
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float elevation, ColorStateList backgroundTint) {
        if (backgroundTint == null) {
            backgroundTint = ColorStateList.valueOf(MaterialColors.getColor(context, R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName()));
        }
    ...
    protected MaterialShapeDrawable(MaterialShapeDrawableState drawableState2) {
    ...
    public void setShapeAppearanceModel(ShapeAppearanceModel shapeAppearanceModel) {
        ...
        this.drawableState.stateListShapeAppearanceModel = null;
    ...
    public void setStateListShapeAppearanceModel(StateListShapeAppearanceModel stateListShapeAppearanceModel) {
        if (this.drawableState.stateListShapeAppearanceModel != stateListShapeAppearanceModel) {
            this.drawableState.stateListShapeAppearanceModel = stateListShapeAppearanceModel;
    ...
    public void setCornerSpringForce(SpringForce springForce) {
        if (this.cornerSpringForce != springForce) {
            ...
            for (int i = 0; i < this.cornerSpringAnimations.length; i++) {
                if (this.cornerSpringAnimations[i] == null) {
                    this.cornerSpringAnimations[i] = new SpringAnimation(this, CORNER_SIZES_IN_PX[i]);
                }
    ...
    public void onBoundsChange(Rect bounds) {
        ...
        if (this.drawableState.stateListShapeAppearanceModel != null && !bounds.isEmpty()) {
            updateShape(getState(), this.boundsIsEmpty);
        }
        this.boundsIsEmpty = bounds.isEmpty();
    }
    ...
    public void drawShape(Canvas canvas, Paint paint, Path path2, RectF bounds) {
        drawShape(canvas, paint, path2, this.drawableState.shapeAppearanceModel, this.springAnimatedCornerSizes, bounds);
    }

    private void drawShape(Canvas canvas, Paint paint, Path path2, ShapeAppearanceModel shapeAppearanceModel, float[] cornerSizeOverrides, RectF bounds) {
        float roundRectRadius = calculateRoundRectCornerSize(bounds, shapeAppearanceModel, cornerSizeOverrides);
        if (roundRectRadius >= 0.0f) {
            float roundRectRadius2 = roundRectRadius * this.drawableState.interpolation;
            canvas.drawRoundRect(bounds, roundRectRadius2, roundRectRadius2, paint);
            return;
        }
    ...
    private float calculateRoundRectCornerSize(RectF bounds, ShapeAppearanceModel shapeAppearanceModel, float[] cornerSizeOverrides) {
        if (cornerSizeOverrides == null) {
            ...
            return -1.0f;
        } else if (!MathUtils.areAllElementsEqual(cornerSizeOverrides) || !shapeAppearanceModel.hasRoundedCorners()) {
            return -1.0f;
        } else {
    ...
    public final void calculatePathForSize(RectF bounds, Path path2) {
        this.pathProvider.calculatePath(this.drawableState.shapeAppearanceModel, this.springAnimatedCornerSizes, this.drawableState.interpolation, bounds, this.pathShadowListener, path2);
    }
    ...
    private void updateStrokeShapeAppearanceModels() {
        ...
        if (this.springAnimatedStrokeCornerSizes == null) {
            this.springAnimatedStrokeCornerSizes = new float[this.springAnimatedCornerSizes.length];
        }
        float strokeInset = getStrokeInsetLength();
        for (int i = 0; i < this.springAnimatedCornerSizes.length; i++) {
            this.springAnimatedStrokeCornerSizes[i] = Math.max(0.0f, this.springAnimatedCornerSizes[i] - strokeInset);
        }
    }
    ...
    public void getOutline(Outline outline) {
        if (this.drawableState.shadowCompatMode != 2) {
            ...
            if (!bounds.isEmpty()) {
                float roundRectRadius = calculateRoundRectCornerSize(bounds, this.drawableState.shapeAppearanceModel, this.springAnimatedCornerSizes);
                if (roundRectRadius >= 0.0f) {
                    outline.setRoundRect(getBounds(), this.drawableState.interpolation * roundRectRadius);
                    return;
                }
                if (this.pathDirty) {
                    calculatePath(bounds, this.path);
                    this.pathDirty = false;
                }
    ...
    public boolean isStateful() {
        return super.isStateful() || (this.drawableState.tintList != null && this.drawableState.tintList.isStateful()) || ((this.drawableState.strokeTintList != null && this.drawableState.strokeTintList.isStateful()) || ((this.drawableState.strokeColor != null && this.drawableState.strokeColor.isStateful()) || ((this.drawableState.fillColor != null && this.drawableState.fillColor.isStateful()) || (this.drawableState.stateListShapeAppearanceModel != null && this.drawableState.stateListShapeAppearanceModel.isStateful()))));
    }
    ...
    private void updateShape(int[] state) {
        updateShape(state, false);
    }

    private void updateShape(int[] state, boolean skipAnimation) {
        RectF bounds = getBoundsAsRectF();
        if (this.drawableState.stateListShapeAppearanceModel != null && !bounds.isEmpty()) {
            boolean skipAnimation2 = skipAnimation | (this.cornerSpringForce == null);
            if (this.springAnimatedCornerSizes == null) {
                this.springAnimatedCornerSizes = new float[4];
            }
            ShapeAppearanceModel shapeAppearanceModel = this.drawableState.stateListShapeAppearanceModel.getShapeForState(state);
            for (int i = 0; i < 4; i++) {
                float targetCornerSize = this.pathProvider.getCornerSizeForIndex(i, shapeAppearanceModel).getCornerSize(bounds);
                if (skipAnimation2) {
                    this.springAnimatedCornerSizes[i] = targetCornerSize;
                }
                if (this.cornerSpringAnimations[i] != null) {
                    this.cornerSpringAnimations[i].animateToFinalPosition(targetCornerSize);
                    if (skipAnimation2) {
    ...
    public float getTopLeftCornerResolvedSize() {
        if (this.springAnimatedCornerSizes != null) {
            return this.springAnimatedCornerSizes[3];
        }
    ...
    public float getTopRightCornerResolvedSize() {
        if (this.springAnimatedCornerSizes != null) {
            return this.springAnimatedCornerSizes[0];
        }
    ...
    public float getBottomLeftCornerResolvedSize() {
        if (this.springAnimatedCornerSizes != null) {
            return this.springAnimatedCornerSizes[2];
        }
    ...
    public float getBottomRightCornerResolvedSize() {
        if (this.springAnimatedCornerSizes != null) {
            return this.springAnimatedCornerSizes[1];
        }
        return this.drawableState.shapeAppearanceModel.getBottomRightCornerSize().getCornerSize(getBoundsAsRectF());
    }

    public boolean isRoundRect() {
        return this.drawableState.shapeAppearanceModel.isRoundRect(getBoundsAsRectF()) || (this.springAnimatedCornerSizes != null && MathUtils.areAllElementsEqual(this.springAnimatedCornerSizes) && this.drawableState.shapeAppearanceModel.hasRoundedCorners());
    }
    ...
    public float getCornerSizeDiffX() {
        if (this.springAnimatedCornerSizes != null) {
            return (((this.springAnimatedCornerSizes[3] + this.springAnimatedCornerSizes[2]) - this.springAnimatedCornerSizes[1]) - this.springAnimatedCornerSizes[0]) / 2.0f;
        }
        RectF bounds = getBoundsAsRectF();
        return (((this.pathProvider.getCornerSizeForIndex(3, getShapeAppearanceModel()).getCornerSize(bounds) + this.pathProvider.getCornerSizeForIndex(2, getShapeAppearanceModel()).getCornerSize(bounds)) - this.pathProvider.getCornerSizeForIndex(1, getShapeAppearanceModel()).getCornerSize(bounds)) - this.pathProvider.getCornerSizeForIndex(0, getShapeAppearanceModel()).getCornerSize(bounds)) / 2.0f;
    }

    private static class SpringAnimatedCornerSizeProperty extends FloatPropertyCompat<MaterialShapeDrawable> {
        private final int index;

        SpringAnimatedCornerSizeProperty(int index2) {
            super("cornerSizeAtIndex" + index2);
            this.index = index2;
        }

        public float getValue(MaterialShapeDrawable drawable) {
            if (drawable.springAnimatedCornerSizes != null) {
                return drawable.springAnimatedCornerSizes[this.index];
            }
            return 0.0f;
        }

        public void setValue(MaterialShapeDrawable drawable, float value) {
            if (drawable.springAnimatedCornerSizes != null && drawable.springAnimatedCornerSizes[this.index] != value) {
                drawable.springAnimatedCornerSizes[this.index] = value;
    ...
    protected static class MaterialShapeDrawableState extends Drawable.ConstantState {
        ...
        public MaterialShapeDrawableState(MaterialShapeDrawableState orig) {
            ...
            this.stateListShapeAppearanceModel = orig.stateListShapeAppearanceModel;
        ...
        public Drawable newDrawable() {
            ...
            boolean unused2 = msd.strokePathDirty = true;
            return msd;
        }
