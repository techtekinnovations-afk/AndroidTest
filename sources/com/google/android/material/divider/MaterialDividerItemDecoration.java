...
public class MaterialDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public MaterialDividerItemDecoration(Context context, AttributeSet attrs, int defStyleAttr, int orientation2) {
        ...
        this.color = MaterialResources.getColorStateList(context2, attributes, R.styleable.MaterialDivider_dividerColor).getDefaultColor();
        this.thickness = attributes.getDimensionPixelSize(R.styleable.MaterialDivider_dividerThickness, context2.getResources().getDimensionPixelSize(R.dimen.material_divider_thickness));
    ...
    public void setDividerColor(int color2) {
        ...
        this.dividerDrawable.setTint(color2);
    }
    ...
    private void drawForVerticalOrientation(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (shouldDrawDivider(parent, child)) {
                ...
                this.dividerDrawable.setAlpha(Math.round(child.getAlpha() * 255.0f));
