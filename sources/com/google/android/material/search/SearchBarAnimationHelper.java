...
class SearchBarAnimationHelper {
    ...
    public void startOnLoadAnimation(SearchBar searchBar) {
        dispatchOnLoadAnimation(new SearchBarAnimationHelper$$ExternalSyntheticLambda1());
        ...
        if (centerView instanceof AnimatableView) {
            ...
            ((AnimatableView) centerView).startAnimation(new SearchBarAnimationHelper$$ExternalSyntheticLambda2(secondaryViewAnimator2));
    ...
    public void startExpandAnimation(SearchBar searchBar, View expandedView, AppBarLayout appBarLayout, boolean skipAnimation) {
        ...
        expandedView2.post(new SearchBarAnimationHelper$$ExternalSyntheticLambda3(this, searchBar, expandedView2, appBarLayout, skipAnimation));
    }
    ...
    public /* synthetic */ void m1699lambda$startExpandAnimation$0$comgoogleandroidmaterialsearchSearchBarAnimationHelper(SearchBar searchBar, View expandedView, AppBarLayout appBarLayout, boolean skipAnimation) {
    ...
    private ValueAnimator.AnimatorUpdateListener getExpandedViewBackgroundUpdateListener(SearchBar searchBar, View expandedView) {
        ...
        return new SearchBarAnimationHelper$$ExternalSyntheticLambda4(expandedViewBackground, expandedView);
    }
    ...
    private Animator getFadeOutChildrenAnimator(SearchBar searchBar, View expandedView) {
        ...
        animator.addUpdateListener(new SearchBarAnimationHelper$$ExternalSyntheticLambda0(expandedView));
