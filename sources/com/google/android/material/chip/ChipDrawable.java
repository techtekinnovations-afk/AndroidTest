...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadFromAttributes(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(this.context, attrs2, R.styleable.Chip, defStyleAttr, defStyleRes, new int[0]);
        ...
        textAppearance.setTextSize(a.getDimension(R.styleable.Chip_android_textSize, textAppearance.getTextSize()));
        ...
        if (!(attrs2 == null || attrs2.getAttributeValue(NAMESPACE_APP, "chipIconEnabled") == null || attrs2.getAttributeValue(NAMESPACE_APP, "chipIconVisible") != null)) {
        ...
        if (!(attrs2 == null || attrs2.getAttributeValue(NAMESPACE_APP, "closeIconEnabled") == null || attrs2.getAttributeValue(NAMESPACE_APP, "closeIconVisible") != null)) {
        ...
        if (!(attrs2 == null || attrs2.getAttributeValue(NAMESPACE_APP, "checkedIconEnabled") == null || attrs2.getAttributeValue(NAMESPACE_APP, "checkedIconVisible") != null)) {
    ...
    private float getCurrentChipIconHeight() {
        ...
        float maxChipIconHeight = (float) Math.ceil((double) ViewUtils.dpToPx(this.context, 24));
    ...
    private void drawText(Canvas canvas, Rect bounds) {
        ...
        if (this.text != null) {
            ...
            CharSequence finalText2 = this.text;
            ...
            canvas2.drawText(finalText, 0, finalText.length(), this.pointF.x, this.pointF.y, this.textDrawableHelper.getTextPaint());
            if (clip) {
                canvas2.restoreToCount(saveCount);
                return;
            }
    ...
    private void drawDebug(Canvas canvas, Rect bounds) {
        Canvas canvas2;
        if (this.debugPaint != null) {
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(ViewCompat.MEASURED_STATE_MASK, WorkQueueKt.MASK));
    ...
    private boolean onStateChange(int[] chipState, int[] closeIconState) {
        ...
        if (this.chipSurfaceColor != null) {
            newChipSurfaceColor = this.chipSurfaceColor.getColorForState(iArr, this.currentChipSurfaceColor);
        } else {
        ...
        if (this.chipBackgroundColor != null) {
            newChipBackgroundColor = this.chipBackgroundColor.getColorForState(iArr, this.currentChipBackgroundColor);
        } else {
        ...
        if (this.chipStrokeColor != null) {
            newChipStrokeColor = this.chipStrokeColor.getColorForState(iArr, this.currentChipStrokeColor);
        } else {
        ...
        int newTint = this.tint != null ? this.tint.getColorForState(iArr, this.currentTint) : 0;
    ...
    private void applyChildDrawable(Drawable drawable) {
        if (drawable != null) {
            ...
            if (drawable == this.chipIcon && this.hasChipIconTint) {
                this.chipIcon.setTintList(this.chipIconTint);
            }
            if (drawable.isStateful()) {
    ...
    /* access modifiers changed from: package-private */
    public boolean refreshCloseIconFocus(boolean closeIconFocused) {
        if (this.closeIcon == null) {
            return false;
        }
        return setCloseIconState(closeIconFocused ? new int[]{16842919, 16842910} : DEFAULT_STATE);
    }
    ...
    public void setChipIconTint(ColorStateList chipIconTint2) {
        ...
        if (this.chipIconTint != chipIconTint2) {
            ...
            if (showsChipIcon()) {
                this.chipIcon.setTintList(chipIconTint2);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setCloseIconTint(ColorStateList closeIconTint2) {
        if (this.closeIconTint != closeIconTint2) {
            ...
            if (showsCloseIcon()) {
                this.closeIcon.setTintList(closeIconTint2);
            }
            onStateChange(getState());
        }
    }
