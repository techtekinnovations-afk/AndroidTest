...
public class MaterialResources {
    ...
    public static int getUnscaledLineHeight(Context context, int textAppearance, int defValue) {
        if (textAppearance == 0) {
            return defValue;
        }
        TypedArray a = context.obtainStyledAttributes(textAppearance, com.google.android.material.R.styleable.MaterialTextAppearance);
        TypedValue v = new TypedValue();
        boolean available = a.getValue(com.google.android.material.R.styleable.MaterialTextAppearance_lineHeight, v);
        if (!available) {
            available = a.getValue(com.google.android.material.R.styleable.MaterialTextAppearance_android_lineHeight, v);
        }
        a.recycle();
        if (!available) {
            return defValue;
