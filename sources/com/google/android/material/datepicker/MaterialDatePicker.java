...
public class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        TypedArray a = context.obtainStyledAttributes((AttributeSet) null, R.styleable.MaterialCalendar, R.attr.materialCalendarStyle, R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.fullscreen) {
            ...
            root.findViewById(R.id.mtrl_calendar_main_pane).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -1));
        }
        this.headerSelectionText = (TextView) root.findViewById(R.id.mtrl_picker_header_selection_text);
        this.headerSelectionText.setAccessibilityLiveRegion(1);
        ...
        this.confirmButton.setOnClickListener(new MaterialDatePicker$$ExternalSyntheticLambda1(this));
        ...
        cancelButton.setOnClickListener(new MaterialDatePicker$$ExternalSyntheticLambda2(this));
        return root;
    }

    public void onPositiveButtonClick(View view) {
        Iterator it = this.onPositiveButtonClickListeners.iterator();
        while (it.hasNext()) {
    ...
    public void onNegativeButtonClick(View view) {
        Iterator it = this.onNegativeButtonClickListeners.iterator();
        while (it.hasNext()) {
        ...
        if (!this.edgeToEdgeEnabled) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(headerLayout, new OnApplyWindowInsetsListener() {
                public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
                    ...
                    headerLayout.setPadding(originalPaddingLeft + inset.left, originalPaddingTop + inset.top, originalPaddingRight + inset.right, headerLayout.getPaddingBottom());
                    return insets;
                }
            });
    ...
    public /* synthetic */ void m1691lambda$initHeaderToggle$0$comgoogleandroidmaterialdatepickerMaterialDatePicker(View v) {
    ...
    static boolean readMaterialCalendarStyleBoolean(Context context, int attributeResId) {
        TypedArray a = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{attributeResId});
