...
class UtcDates {
    ...
    static SimpleDateFormat getDefaultTextInputFormat() {
        SimpleDateFormat format = new SimpleDateFormat(getDatePatternAsInputFormat(((SimpleDateFormat) java.text.DateFormat.getDateInstance(3, Locale.getDefault())).toPattern()), Locale.getDefault());
        format.setTimeZone(getTimeZone());
