...
public class CircularProgressIndicator extends BaseProgressIndicator<CircularProgressIndicatorSpec> {
    ...
    public void setIndeterminateAnimationType(int indeterminateAnimationType) {
        ...
        if (((CircularProgressIndicatorSpec) this.spec).indeterminateAnimationType != indeterminateAnimationType) {
            if (!visibleToUser() || !isIndeterminate()) {
                ((CircularProgressIndicatorSpec) this.spec).indeterminateAnimationType = indeterminateAnimationType;
                ((CircularProgressIndicatorSpec) this.spec).validateSpec();
                if (indeterminateAnimationType == 1) {
                    animatorDelegate = new CircularIndeterminateRetreatAnimatorDelegate(getContext(), (CircularProgressIndicatorSpec) this.spec);
                } else {
                    animatorDelegate = new CircularIndeterminateAdvanceAnimatorDelegate((CircularProgressIndicatorSpec) this.spec);
                }
