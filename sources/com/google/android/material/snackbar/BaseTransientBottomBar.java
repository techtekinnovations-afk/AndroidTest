...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    protected BaseTransientBottomBar(Context context2, ViewGroup parent, View content, ContentViewCallback contentViewCallback2) {
        ...
        this.bottomMarginGestureInsetRunnable = new Runnable() {
            public void run() {
                if (BaseTransientBottomBar.this.view != null && BaseTransientBottomBar.this.context != null) {
                    int currentInsetBottom = (WindowUtils.getCurrentWindowBounds(BaseTransientBottomBar.this.context).height() - BaseTransientBottomBar.this.getViewAbsoluteBottom()) + ((int) BaseTransientBottomBar.this.view.getTranslationY());
                    if (currentInsetBottom >= BaseTransientBottomBar.this.extraBottomMarginGestureInset) {
                        int unused = BaseTransientBottomBar.this.appliedBottomMarginGestureInset = BaseTransientBottomBar.this.extraBottomMarginGestureInset;
                        return;
                    }
                    ...
                    int unused2 = BaseTransientBottomBar.this.appliedBottomMarginGestureInset = BaseTransientBottomBar.this.extraBottomMarginGestureInset;
        ...
        if (parent == null) {
            ...
            this.view.setAccessibilityLiveRegion(1);
            ...
            this.animationFadeInDuration = MotionUtils.resolveThemeDuration(context2, R.attr.motionDurationLong2, DEFAULT_ANIMATION_FADE_IN_DURATION);
            this.animationFadeOutDuration = MotionUtils.resolveThemeDuration(context2, R.attr.motionDurationMedium1, DEFAULT_ANIMATION_FADE_OUT_DURATION);
    ...
    public void updateMargins() {
        ...
        if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
            ...
            int newBottomMargin = this.view.originalMargins.bottom + (getAnchorView() != null ? this.extraBottomMarginAnchorView : this.extraBottomMarginWindowInset);
    ...
    public void startSlideInAnimation() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animator) {
                BaseTransientBottomBar.this.view.setTranslationY((float) ((Integer) animator.getAnimatedValue()).intValue());
            }
        });
        animator.start();
    }
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attrs) {
            ...
            if (a.hasValue(R.styleable.SnackbarLayout_elevation)) {
                setElevation((float) a.getDimensionPixelSize(R.styleable.SnackbarLayout_elevation, 0));
            }
        ...
        public void setBackgroundTintList(ColorStateList backgroundTint2) {
            ...
            if (getBackground() != null) {
                ...
                wrappedBackground.setTintList(backgroundTint2);
                wrappedBackground.setTintMode(this.backgroundTintMode);
        ...
        public void setBackgroundTintMode(PorterDuff.Mode backgroundTintMode2) {
            ...
            if (getBackground() != null) {
                Drawable wrappedBackground = DrawableCompat.wrap(getBackground().mutate());
                wrappedBackground.setTintMode(backgroundTintMode2);
                if (wrappedBackground != getBackground()) {
                    super.setBackgroundDrawable(wrappedBackground);
                }
            }
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (this.maxWidth > 0 && getMeasuredWidth() > this.maxWidth) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.maxWidth, 1073741824), heightMeasureSpec);
            }
        }
        ...
        private Drawable createThemedBackground() {
            ...
            if (this.shapeAppearanceModel != null) {
                background = BaseTransientBottomBar.createMaterialShapeDrawableBackground(backgroundColor, this.shapeAppearanceModel);
            } else {
            ...
            wrappedDrawable.setTintList(this.backgroundTint);
    ...
    static class Anchor implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener {
        ...
        static Anchor anchor(BaseTransientBottomBar transientBottomBar2, View anchorView2) {
            ...
            if (anchorView2.isAttachedToWindow()) {
