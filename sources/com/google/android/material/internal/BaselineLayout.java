...
public class BaselineLayout extends ViewGroup {
    ...
    public void setMeasurePaddingFromBaseline(boolean measurePaddingFromBaseline2) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(maxWidth, getSuggestedMinimumWidth()), widthMeasureSpec, childState), View.resolveSizeAndState(Math.max(this.measurePaddingFromBaseline ? maxHeight : getPaddingBottom() + maxMeasuredHeight, getSuggestedMinimumHeight()), heightMeasureSpec, childState << 16));
    }
