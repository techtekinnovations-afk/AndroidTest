...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    public MaterialCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attrs2, R.styleable.MaterialCardView, defStyleAttr2, DEF_STYLE_RES, new int[0]);
        this.cardViewHelper = new MaterialCardViewHelper(this, attrs2, defStyleAttr2, DEF_STYLE_RES);
