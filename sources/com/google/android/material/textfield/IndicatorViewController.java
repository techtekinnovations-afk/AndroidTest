...
final class IndicatorViewController {
    ...
    private final int captionFadeInAnimationDuration = MotionUtils.resolveThemeDuration(this.context, R.attr.motionDurationMedium4, DEFAULT_CAPTION_FADE_ANIMATION_DURATION);
    private final TimeInterpolator captionFadeInAnimationInterpolator = MotionUtils.resolveThemeInterpolator(this.context, R.attr.motionEasingEmphasizedDecelerateInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
    private final int captionFadeOutAnimationDuration = MotionUtils.resolveThemeDuration(this.context, R.attr.motionDurationShort4, DEFAULT_CAPTION_FADE_ANIMATION_DURATION);
    private final TimeInterpolator captionFadeOutAnimationInterpolator = MotionUtils.resolveThemeInterpolator(this.context, R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
    private int captionToShow;
    private final int captionTranslationYAnimationDuration = MotionUtils.resolveThemeDuration(this.context, R.attr.motionDurationShort4, DEFAULT_CAPTION_TRANSLATION_Y_ANIMATION_DURATION);
    private final TimeInterpolator captionTranslationYAnimationInterpolator = MotionUtils.resolveThemeInterpolator(this.context, R.attr.motionEasingEmphasizedDecelerateInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    ...
    private boolean shouldAnimateCaptionView(TextView captionView, CharSequence captionText) {
        return this.textInputView.isLaidOut() && this.textInputView.isEnabled() && (this.captionToShow != this.captionDisplayed || captionView == null || !TextUtils.equals(captionView.getText(), captionText));
    }
    ...
    private void updateCaptionViewsVisibility(int captionToHide, int captionToShow2, boolean animate) {
        if (captionToHide != captionToShow2) {
            if (animate) {
                ...
                createCaptionAnimators(captionAnimatorList, this.helperTextEnabled, this.helperTextView, 2, i, i2);
                createCaptionAnimators(captionAnimatorList, this.errorEnabled, this.errorView, 1, i, i2);
                ...
                final TextView captionViewToShow = getCaptionViewFromDisplayState(captionToShow2);
                final int i3 = captionToHide;
    ...
    public void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            ...
            this.indicatorArea.setPaddingRelative(getIndicatorPadding(isFontScaleLarge, R.dimen.material_helper_text_font_1_3_padding_horizontal, editText.getPaddingStart()), getIndicatorPadding(isFontScaleLarge, R.dimen.material_helper_text_font_1_3_padding_top, this.context.getResources().getDimensionPixelSize(R.dimen.material_helper_text_default_padding_top)), getIndicatorPadding(isFontScaleLarge, R.dimen.material_helper_text_font_1_3_padding_horizontal, editText.getPaddingEnd()), 0);
        }
    }
    ...
    public void setErrorViewTextColor(ColorStateList errorViewTextColor2) {
        ...
        if (this.errorView != null && errorViewTextColor2 != null) {
            this.errorView.setTextColor(errorViewTextColor2);
        }
    }
    ...
    public void setErrorAccessibilityLiveRegion(int accessibilityLiveRegion) {
        ...
        if (this.errorView != null) {
            this.errorView.setAccessibilityLiveRegion(accessibilityLiveRegion);
        }
    }
    ...
    public void setHelperTextViewTextColor(ColorStateList helperTextViewTextColor2) {
        ...
        if (this.helperTextView != null && helperTextViewTextColor2 != null) {
            this.helperTextView.setTextColor(helperTextViewTextColor2);
        }
    }
