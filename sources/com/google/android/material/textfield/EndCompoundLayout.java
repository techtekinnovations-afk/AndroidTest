...
class EndCompoundLayout extends LinearLayout {
    private final AccessibilityManager accessibilityManager = ((AccessibilityManager) getContext().getSystemService("accessibility"));
    ...
    EndCompoundLayout(TextInputLayout textInputLayout2, TintTypedArray a) {
        ...
        textInputLayout2.addOnEditTextAttachedListener(this.onEditTextAttachedListener);
    ...
    private CheckableImageButton createIconView(ViewGroup root, LayoutInflater inflater, int id) {
        ...
        if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
            ((ViewGroup.MarginLayoutParams) iconView.getLayoutParams()).setMarginStart(0);
        }
        return iconView;
    }
    ...
    private void initErrorIconView(TintTypedArray a) {
        ...
        if (a.hasValue(R.styleable.TextInputLayout_errorIconTintMode)) {
            this.errorIconTintMode = ViewUtils.parseTintMode(a.getInt(R.styleable.TextInputLayout_errorIconTintMode, -1), (PorterDuff.Mode) null);
        }
    ...
    private void initEndIconView(TintTypedArray a) {
        if (!a.hasValue(R.styleable.TextInputLayout_passwordToggleEnabled)) {
            ...
            if (a.hasValue(R.styleable.TextInputLayout_endIconTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(a.getInt(R.styleable.TextInputLayout_endIconTintMode, -1), (PorterDuff.Mode) null);
            }
        }
        if (a.hasValue(R.styleable.TextInputLayout_endIconMode)) {
            ...
            if (a.hasValue(R.styleable.TextInputLayout_passwordToggleTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(a.getInt(R.styleable.TextInputLayout_passwordToggleTintMode, -1), (PorterDuff.Mode) null);
            }
            setEndIconMode(a.getBoolean(R.styleable.TextInputLayout_passwordToggleEnabled, false));
    ...
    public int getSuffixTextEndOffset() {
        ...
        if (isEndIconVisible() || isErrorIconVisible()) {
            endIconOffset = this.endIconView.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) this.endIconView.getLayoutParams()).getMarginStart();
        } else {
            endIconOffset = 0;
        }
        return getPaddingEnd() + this.suffixTextView.getPaddingEnd() + endIconOffset;
    }
    ...
    private void tintEndIconOnError(boolean tintEndIconOnError) {
        ...
        endIconDrawable.setTint(this.textInputLayout.getErrorCurrentTextColors());
        this.endIconView.setImageDrawable(endIconDrawable);
    }
