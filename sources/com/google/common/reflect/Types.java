...
final class Types {
    ...
    private enum ClassOwnership {
        ...
        private static ClassOwnership detectJvmBehavior() {
            ParameterizedType parameterizedType = (ParameterizedType) Objects.requireNonNull((ParameterizedType) new AnonymousClass1LocalClass<String>() {
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        ParameterizedTypeImpl(@CheckForNull Type ownerType2, Class<?> rawType2, Type[] typeArguments) {
        ...
        public String toString() {
            ...
            StringBuilder append = builder.append(this.rawType.getName()).append(Typography.less);
            Joiner access$400 = Types.COMMA_JOINER;
            ImmutableList<Type> immutableList = this.argumentsList;
            JavaVersion javaVersion = JavaVersion.CURRENT;
            Objects.requireNonNull(javaVersion);
            return append.append(access$400.join((Iterable<? extends Object>) Iterables.transform(immutableList, new Types$ParameterizedTypeImpl$$ExternalSyntheticLambda0(javaVersion)))).append(Typography.greater).toString();
        }
        ...
        public boolean equals(@CheckForNull Object other) {
            ...
            if (!getRawType().equals(that.getRawType()) || !com.google.common.base.Objects.equal(getOwnerType(), that.getOwnerType()) || !Arrays.equals(getActualTypeArguments(), that.getActualTypeArguments())) {
                return false;
            }
            return true;
        }
