...
public abstract class Striped<L> {
    ...
    public static Striped<Lock> lock(int stripes) {
        return custom(stripes, new Striped$$ExternalSyntheticLambda1());
    }
    ...
    public static Striped<Semaphore> semaphore(int stripes, int permits) {
        return custom(stripes, new Striped$$ExternalSyntheticLambda2(permits));
    }
    ...
    public static Striped<Semaphore> lazyWeakSemaphore(int stripes, int permits) {
        return lazy(stripes, new Striped$$ExternalSyntheticLambda3(permits));
    }
    ...
    public static Striped<ReadWriteLock> lazyWeakReadWriteLock(int stripes) {
        return lazy(stripes, new Striped$$ExternalSyntheticLambda0());
    }
