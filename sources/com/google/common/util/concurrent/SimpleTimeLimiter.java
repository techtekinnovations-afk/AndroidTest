...
public final class SimpleTimeLimiter implements TimeLimiter {
    ...
    public <T> T newProxy(T target, Class<T> interfaceType, long timeoutDuration, TimeUnit timeoutUnit) {
        ...
        final T target2 = target;
        final long timeoutDuration2 = timeoutDuration;
        final TimeUnit timeoutUnit2 = timeoutUnit;
        return newProxy(interfaceType, new InvocationHandler() {
            ...
            public Object invoke(Object obj, Method method, @CheckForNull Object[] args) throws Throwable {
                return SimpleTimeLimiter.this.callWithTimeout(new SimpleTimeLimiter$1$$ExternalSyntheticLambda0(method, target2, args), timeoutDuration2, timeoutUnit2, interruptibleMethods.contains(method));
            }
