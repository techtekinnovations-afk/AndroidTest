...
public final class MoreExecutors {
    ...
    static class Application {
        ...
        public final void addDelayedShutdownHook(ExecutorService service, long terminationTimeout, TimeUnit timeUnit) {
            ...
            final ExecutorService service2 = service;
            final long terminationTimeout2 = terminationTimeout;
            final TimeUnit timeUnit2 = timeUnit;
            addShutdownHook(MoreExecutors.newThread("DelayedShutdownHook-for-" + service, new Runnable(this) {
                public void run() {
                    try {
                        service2.shutdown();
                        service2.awaitTermination(terminationTimeout2, timeUnit2);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:52:0x00e5 A[LOOP:2: B:50:0x00df->B:52:0x00e5, LOOP_END] */
    ...
    static <T> T invokeAnyImpl(com.google.common.util.concurrent.ListeningExecutorService r22, java.util.Collection<? extends java.util.concurrent.Callable<T>> r23, boolean r24, long r25, java.util.concurrent.TimeUnit r27) throws java.lang.InterruptedException, java.util.concurrent.ExecutionException, java.util.concurrent.TimeoutException {
        ...
        L_0x0031:
            ...
            r9 = r21
        L_0x004d:
            java.lang.Object r12 = r5.poll()     // Catch:{ all -> 0x00d8 }
            java.util.concurrent.Future r12 = (java.util.concurrent.Future) r12     // Catch:{ all -> 0x00d8 }
            if (r12 != 0) goto L_0x009f
            if (r9 <= 0) goto L_0x006b
            int r9 = r9 + -1
            java.lang.Object r16 = r13.next()     // Catch:{ all -> 0x00d8 }
            r3 = r16
            java.util.concurrent.Callable r3 = (java.util.concurrent.Callable) r3     // Catch:{ all -> 0x00d8 }
            com.google.common.util.concurrent.ListenableFuture r3 = submitAndAddQueueListener(r1, r3, r5)     // Catch:{ all -> 0x00d8 }
            r4.add(r3)     // Catch:{ all -> 0x00d8 }
            int r0 = r0 + 1
            goto L_0x009f
        L_0x006b:
            if (r0 != 0) goto L_0x0079
            if (r2 != 0) goto L_0x0077
            java.util.concurrent.ExecutionException r3 = new java.util.concurrent.ExecutionException     // Catch:{ all -> 0x00d8 }
            r12 = 0
            r3.<init>(r12)     // Catch:{ all -> 0x00d8 }
            r2 = r3
        L_0x0077:
            throw r2     // Catch:{ all -> 0x00d8 }
        L_0x0079:
            if (r24 == 0) goto L_0x0098
            java.util.concurrent.TimeUnit r3 = java.util.concurrent.TimeUnit.NANOSECONDS     // Catch:{ all -> 0x00d8 }
            java.lang.Object r3 = r5.poll(r10, r3)     // Catch:{ all -> 0x00d8 }
            java.util.concurrent.Future r3 = (java.util.concurrent.Future) r3     // Catch:{ all -> 0x00d8 }
            r12 = r3
            if (r12 == 0) goto L_0x0092
            long r17 = java.lang.System.nanoTime()     // Catch:{ all -> 0x00d8 }
            long r19 = r17 - r14
            long r10 = r10 - r19
            r14 = r17
            goto L_0x009f
        L_0x0092:
            java.util.concurrent.TimeoutException r3 = new java.util.concurrent.TimeoutException     // Catch:{ all -> 0x00d8 }
            r3.<init>()     // Catch:{ all -> 0x00d8 }
            throw r3     // Catch:{ all -> 0x00d8 }
        L_0x0098:
            java.lang.Object r3 = r5.take()     // Catch:{ all -> 0x00d8 }
            java.util.concurrent.Future r3 = (java.util.concurrent.Future) r3     // Catch:{ all -> 0x00d8 }
            r12 = r3
        L_0x009f:
            if (r12 == 0) goto L_0x00d4
            int r3 = r0 + -1
            java.lang.Object r0 = r12.get()     // Catch:{ ExecutionException -> 0x00d0, RuntimeException -> 0x00c7 }
        ...
        L_0x00c7:
            r0 = move-exception
            java.util.concurrent.ExecutionException r1 = new java.util.concurrent.ExecutionException     // Catch:{ all -> 0x00d8 }
