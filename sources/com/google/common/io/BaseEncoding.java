...
public abstract class BaseEncoding {
    ...
    private static final class Alphabet {
        ...
        Alphabet(String name2, char[] chars2) {
            this(name2, chars2, decodabetFor(chars2), false);
        }

        private Alphabet(String name2, char[] chars2, byte[] decodabet2, boolean ignoreCase2) {
            ...
            try {
                ...
                for (int i = 0; i < this.bytesPerChunk; i++) {
                    validPadding2[IntMath.divide(i * 8, this.bitsPerChar, RoundingMode.CEILING)] = true;
                }
        ...
        private static byte[] decodabetFor(char[] chars2) {
        ...
        public Alphabet ignoreCase() {
            ...
            while (true) {
                ...
                if (decodeUpper == -1) {
                    ...
                    Preconditions.checkState(z, "Can't ignoreCase() since '%s' and '%s' encode different values", (char) upper, (char) lower);
        ...
        public boolean equals(@CheckForNull Object other) {
            ...
            if (this.ignoreCase != that.ignoreCase || !Arrays.equals(this.chars, that.chars)) {
                return false;
            }
            return true;
        }
    ...
    static class StandardBaseEncoding extends BaseEncoding {
        ...
        StandardBaseEncoding(String name, String alphabetChars, @CheckForNull Character paddingChar2) {
            this(new Alphabet(name, alphabetChars.toCharArray()), paddingChar2);
        }

        StandardBaseEncoding(Alphabet alphabet2, @CheckForNull Character paddingChar2) {
        ...
        public BaseEncoding ignoreCase() {
            ...
            BaseEncoding result2 = ignore == this.alphabet ? this : newInstance(ignore, this.paddingChar);
            this.ignoreCase = result2;
            return result2;
        }

        /* access modifiers changed from: package-private */
        public BaseEncoding newInstance(Alphabet alphabet2, @CheckForNull Character paddingChar2) {
        ...
        public boolean equals(@CheckForNull Object other) {
            ...
            if (!this.alphabet.equals(that.alphabet) || !Objects.equals(this.paddingChar, that.paddingChar)) {
                return false;
            }
            return true;
        }
    ...
    static final class Base16Encoding extends StandardBaseEncoding {
        ...
        /* access modifiers changed from: package-private */
        public BaseEncoding newInstance(Alphabet alphabet, @CheckForNull Character paddingChar) {
        ...
        return new Reader() {
            public int read() throws IOException {
                ...
                do {
                    ...
                    if (readChar == -1 || toIgnore.indexOf((char) readChar) < 0) {
                        return readChar;
                    }
                    readChar = delegate.read();
                    break;
