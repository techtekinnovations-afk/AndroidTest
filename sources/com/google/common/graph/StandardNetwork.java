...
class StandardNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    StandardNetwork(NetworkBuilder<? super N, ? super E> builder) {
        this(builder, builder.nodeOrder.createMap(((Integer) builder.expectedNodeCount.or(10)).intValue()), builder.edgeOrder.createMap(builder.expectedEdgeCount.or(20).intValue()));
    }
    ...
    public EndpointPair<N> incidentNodes(E edge) {
        ...
        return EndpointPair.of((Network<?, ?>) this, nodeU, ((NetworkConnections) Objects.requireNonNull(this.nodeConnections.get(nodeU))).adjacentNode(edge));
    }
