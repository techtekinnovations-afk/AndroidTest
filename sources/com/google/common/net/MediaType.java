...
public final class MediaType {
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            builder.append("; ");
            PARAMETER_JOINER.appendTo(builder, (Iterable<? extends Map.Entry<?, ?>>) Multimaps.transformValues(this.parameters, new MediaType$$ExternalSyntheticLambda0()).entries());
        }
        return builder.toString();
    }

    static /* synthetic */ String lambda$computeToString$0(String value) {
        if (!TOKEN_MATCHER.matchesAllOf(value) || value.isEmpty()) {
