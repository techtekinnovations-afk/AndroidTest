...
public final class Throwables {
    ...
    private static List<StackTraceElement> jlaStackTrace(final Throwable t) {
        ...
        return new AbstractList<StackTraceElement>() {
            public StackTraceElement get(int n) {
                return (StackTraceElement) Throwables.invokeAccessibleNonThrowingMethod((Method) Objects.requireNonNull(Throwables.getStackTraceElementMethod), Objects.requireNonNull(Throwables.jla), t, Integer.valueOf(n));
            }

            public int size() {
                return ((Integer) Throwables.invokeAccessibleNonThrowingMethod((Method) Objects.requireNonNull(Throwables.getStackTraceDepthMethod), Objects.requireNonNull(Throwables.jla), t)).intValue();
            }
        };
    }
    ...
    private static Method getSizeMethod(Object jla2) {
        try {
            ...
            getStackTraceDepth.invoke(jla2, new Object[]{new Throwable()});
