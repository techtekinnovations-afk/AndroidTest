...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> {
    ...
    private class Heap {
        ...
        public int crossOverUp(int index, E x) {
            ...
            if (!(parentIndex == 0 || (auntIndex = getRightChildIndex(getParentIndex(parentIndex))) == parentIndex || getLeftChildIndex(auntIndex) < MinMaxPriorityQueue.this.size)) {
                E auntElement = MinMaxPriorityQueue.this.elementData(auntIndex);
