...
public final class Multimaps {
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            Map<K, Collection<V>> result2 = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new Multimaps$UnmodifiableMultimap$$ExternalSyntheticLambda0()));
            this.map = result2;
            return result2;
        }
        ...
        public Collection<Map.Entry<K, V>> entries() {
            ...
            Collection<Map.Entry<K, V>> access$000 = Multimaps.unmodifiableEntries(this.delegate.entries());
            Collection<Map.Entry<K, V>> result2 = access$000;
            this.entries = access$000;
            return result2;
        }
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        public Collection<V2> m1744lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(@ParametricNullness K key, Collection<V1> values) {
        ...
        public Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new Multimaps$TransformedEntriesMultimap$$ExternalSyntheticLambda0(this));
        }
        ...
        public Collection<V2> get(@ParametricNullness K key) {
            return m1744lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(key, this.fromMultimap.get(key));
        }
        ...
        public Collection<V2> removeAll(@CheckForNull Object key) {
            return m1744lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(key, this.fromMultimap.removeAll(key));
        }
    ...
    static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        class EntrySet extends Maps.EntrySet<K, Collection<V>> {
            ...
            public Iterator<Map.Entry<K, Collection<V>>> iterator() {
                return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new Multimaps$AsMap$EntrySet$$ExternalSyntheticLambda0(this));
            }

            /* access modifiers changed from: package-private */
            /* renamed from: lambda$iterator$0$com-google-common-collect-Multimaps$AsMap$EntrySet  reason: not valid java name */
            public /* synthetic */ Collection m1743lambda$iterator$0$comgooglecommoncollectMultimaps$AsMap$EntrySet(Object key) {
