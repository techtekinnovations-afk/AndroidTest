    ...
    public static <C extends Comparable> ContiguousSet<C> create(Range<C> range, DiscreteDomain<C> domain2) {
        ...
        try {
            ...
            if (effectiveRange.isEmpty()) {
                ...
                empty = Range.compareOrThrow((Comparable) Objects.requireNonNull(range.lowerBound.leastValueAbove(domain2)), (Comparable) Objects.requireNonNull(range.upperBound.greatestValueBelow(domain2))) > 0;
            }
            if (empty) {
