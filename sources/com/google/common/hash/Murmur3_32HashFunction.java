...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    Murmur3_32HashFunction(int seed2, boolean supplementaryPlaneFix2) {
        this.seed = seed2;
        this.supplementaryPlaneFix = supplementaryPlaneFix2;
    }
    ...
    public boolean equals(@CheckForNull Object object) {
        ...
        if (this.seed == other.seed && this.supplementaryPlaneFix == other.supplementaryPlaneFix) {
            return true;
        }
        return false;
    }
