...
public class DocumentReference {
    ...
    public Task<Void> set(Object data, SetOptions options) {
        ...
        return ((Task) this.firestore.callClient(new DocumentReference$$ExternalSyntheticLambda1(Collections.singletonList(parsed.toMutation(this.key, Precondition.NONE))))).continueWith(Executors.DIRECT_EXECUTOR, Util.voidErrorTransformer());
    }
    ...
    private Task<Void> update(UserData.ParsedUpdateData parsedData) {
        return ((Task) this.firestore.callClient(new DocumentReference$$ExternalSyntheticLambda2(Collections.singletonList(parsedData.toMutation(this.key, Precondition.exists(true)))))).continueWith(Executors.DIRECT_EXECUTOR, Util.voidErrorTransformer());
    }

    public Task<Void> delete() {
        return ((Task) this.firestore.callClient(new DocumentReference$$ExternalSyntheticLambda0(Collections.singletonList(new DeleteMutation(this.key, Precondition.NONE))))).continueWith(Executors.DIRECT_EXECUTOR, Util.voidErrorTransformer());
    }
    ...
    public Task<DocumentSnapshot> get(Source source) {
        if (source == Source.CACHE) {
            return ((Task) this.firestore.callClient(new DocumentReference$$ExternalSyntheticLambda3(this))).continueWith(Executors.DIRECT_EXECUTOR, new DocumentReference$$ExternalSyntheticLambda4(this));
        }
    ...
    public /* synthetic */ Task m1791lambda$get$3$comgooglefirebasefirestoreDocumentReference(FirestoreClient client) {
    ...
    public /* synthetic */ DocumentSnapshot m1792lambda$get$4$comgooglefirebasefirestoreDocumentReference(Task task) throws Exception {
    ...
    private Task<DocumentSnapshot> getViaSnapshotListener(Source source) {
        ...
        registration.setResult(addSnapshotListenerInternal(Executors.DIRECT_EXECUTOR, options, (Activity) null, new DocumentReference$$ExternalSyntheticLambda7(res, registration, source)));
        return res.getTask();
    }
    ...
    private ListenerRegistration addSnapshotListenerInternal(Executor userExecutor, EventManager.ListenOptions options, Activity activity, EventListener<DocumentSnapshot> userListener) {
        AsyncEventListener<ViewSnapshot> asyncListener = new AsyncEventListener<>(userExecutor, new DocumentReference$$ExternalSyntheticLambda5(this, userListener));
        return (ListenerRegistration) this.firestore.callClient(new DocumentReference$$ExternalSyntheticLambda6(asQuery(), options, asyncListener, activity));
    }
    ...
    public /* synthetic */ void m1790lambda$addSnapshotListenerInternal$6$comgooglefirebasefirestoreDocumentReference(EventListener userListener, ViewSnapshot snapshot, FirebaseFirestoreException error) {
