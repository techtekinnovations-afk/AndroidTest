...
public class Transaction {
    ...
    public /* synthetic */ Task m1834lambda$lookup$0$comgooglefirebasefirestorecoreTransaction(Task task) throws Exception {
    ...
    public Task<Void> commit() {
        ...
        this.committed = true;
        return this.datastore.commit(this.mutations).continueWithTask(Executors.DIRECT_EXECUTOR, new Transaction$$ExternalSyntheticLambda1());
    }
