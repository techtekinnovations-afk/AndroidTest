...
public class NotInFilter extends FieldFilter {
    ...
    public boolean matches(Document doc) {
        Value other;
        if (!Values.contains(getValue().getArrayValue(), Values.NULL_VALUE) && (other = doc.getField(getField())) != null && !other.hasNullValue() && !Values.contains(getValue().getArrayValue(), other)) {
            return true;
        }
        return false;
    }
