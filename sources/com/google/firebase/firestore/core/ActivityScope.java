...
public class ActivityScope {
    ...
    private static void onActivityStopCallOnce(Activity activity, Runnable callback) {
        ...
        activity.runOnUiThread(new ActivityScope$$ExternalSyntheticLambda2(activity, callback));
    }
    ...
    public static ListenerRegistration bind(Activity activity, ListenerRegistration registration) {
        if (activity != null) {
            if (activity instanceof FragmentActivity) {
                ...
                onFragmentActivityStopCallOnce((FragmentActivity) activity, new ActivityScope$$ExternalSyntheticLambda0(registration));
            } else {
                Objects.requireNonNull(registration);
                onActivityStopCallOnce(activity, new ActivityScope$$ExternalSyntheticLambda0(registration));
            }
        }
        return registration;
    }
