...
public class ViewSnapshot {
    ...
    public ViewSnapshot(Query query2, DocumentSet documents2, DocumentSet oldDocuments2, List<DocumentViewChange> changes2, boolean isFromCache2, ImmutableSortedSet<DocumentKey> mutatedKeys2, boolean didSyncStateChange2, boolean excludesMetadataChanges2, boolean hasCachedResults2) {
        this.query = query2;
        ...
        this.hasCachedResults = hasCachedResults2;
    }

    public static ViewSnapshot fromInitialDocuments(Query query2, DocumentSet documents2, ImmutableSortedSet<DocumentKey> mutatedKeys2, boolean fromCache, boolean excludesMetadataChanges2, boolean hasCachedResults2) {
        ...
        return new ViewSnapshot(query2, documents2, DocumentSet.emptySet(query2.comparator()), viewChanges, fromCache, mutatedKeys2, true, excludesMetadataChanges2, hasCachedResults2);
    }
