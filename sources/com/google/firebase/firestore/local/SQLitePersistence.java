...
public final class SQLitePersistence extends Persistence {
    ...
    private long getPageSize() {
        return ((Long) query("PRAGMA page_size").firstValue(new SQLitePersistence$$ExternalSyntheticLambda1())).longValue();
    }

    private long getPageCount() {
        return ((Long) query("PRAGMA page_count").firstValue(new SQLitePersistence$$ExternalSyntheticLambda0())).longValue();
    }
    ...
    static class OpenHelper extends SQLiteOpenHelper {
        ...
        private OpenHelper(Context context, LocalSerializer serializer2, String databaseName) {
            this(context, serializer2, databaseName, 18);
        }
    ...
    static class Query {
        ...
        private Cursor startQuery() {
            if (this.cursorFactory != null) {
                return this.db.rawQueryWithFactory(this.cursorFactory, this.sql, (String[]) null, (String) null);
            }
