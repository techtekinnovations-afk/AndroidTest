...
final class MemoryMutationQueue implements MutationQueue {
    ...
    public void acknowledgeBatch(MutationBatch batch, ByteString streamToken) {
        ...
        if (batchId != check.getBatchId()) {
            z = false;
        }
        Assert.hardAssert(z, "Queue ordering failure: expected batch %d, got batch %d", Integer.valueOf(batchId), Integer.valueOf(check.getBatchId()));
    ...
    /* JADX WARNING: type inference failed for: r4v3, types: [com.google.firebase.firestore.model.BasePath] */
    ...
    public java.util.List<com.google.firebase.firestore.model.mutation.MutationBatch> getAllMutationBatchesAffectingQuery(com.google.firebase.firestore.core.Query r10) {
        ...
        L_0x0029:
            ...
            r4.<init>(r5, r1)
            com.google.firebase.database.collection.ImmutableSortedSet r1 = new com.google.firebase.database.collection.ImmutableSortedSet
            ...
            java.util.Iterator r5 = r5.iteratorFrom(r4)
        L_0x0045:
        ...
        L_0x0060:
            ...
            com.google.firebase.database.collection.ImmutableSortedSet r1 = r1.insert(r8)
        L_0x0072:
            goto L_0x0045
        L_0x0073:
            java.util.List r6 = r9.lookupMutationBatches(r1)
            return r6
        */
