...
public class LruGarbageCollector {
    ...
    public class GCScheduler implements Scheduler {
        ...
        public /* synthetic */ void m1860lambda$scheduleGC$0$comgooglefirebasefirestorelocalLruGarbageCollector$GCScheduler() {
    ...
    private static class RollingSequenceNumberBuffer {
        private static final Comparator<Long> COMPARATOR = new LruGarbageCollector$RollingSequenceNumberBuffer$$ExternalSyntheticLambda0();
    ...
    private Results runGarbageCollection(SparseArray<?> liveTargetIds) {
        ...
        if (Logger.isDebugEnabled()) {
            long startTs2 = startTs;
            long countedTargetsTs2 = countedTargetsTs;
            Logger.debug("LruGarbageCollector", (((("LRU Garbage Collection:\n" + "\tCounted targets in " + (countedTargetsTs2 - startTs2) + "ms\n") + String.format(Locale.ROOT, "\tDetermined least recently used %d sequence numbers in %dms\n", new Object[]{Integer.valueOf(sequenceNumbers), Long.valueOf(foundUpperBoundTs - countedTargetsTs2)})) + String.format(Locale.ROOT, "\tRemoved %d targets in %dms\n", new Object[]{Integer.valueOf(numTargetsRemoved), Long.valueOf(removedTargetsTs - foundUpperBoundTs)})) + String.format(Locale.ROOT, "\tRemoved %d documents in %dms\n", new Object[]{Integer.valueOf(numDocumentsRemoved), Long.valueOf(removedDocumentsTs - removedTargetsTs)})) + String.format(Locale.ROOT, "Total Duration: %dms", new Object[]{Long.valueOf(removedDocumentsTs - startTs2)}), new Object[0]);
        } else {
            long j = countedTargetsTs;
        }
