...
public final class TargetData {
    ...
    TargetData(Target target2, int targetId2, long sequenceNumber2, QueryPurpose purpose2, SnapshotVersion snapshotVersion2, SnapshotVersion lastLimboFreeSnapshotVersion2, ByteString resumeToken2, Integer expectedCount2) {
    ...
    public TargetData(Target target2, int targetId2, long sequenceNumber2, QueryPurpose purpose2) {
        this(target2, targetId2, sequenceNumber2, purpose2, SnapshotVersion.NONE, SnapshotVersion.NONE, WatchStream.EMPTY_RESUME_TOKEN, (Integer) null);
    }

    public TargetData withSequenceNumber(long sequenceNumber2) {
        return new TargetData(this.target, this.targetId, sequenceNumber2, this.purpose, this.snapshotVersion, this.lastLimboFreeSnapshotVersion, this.resumeToken, this.expectedCount);
    }

    public TargetData withResumeToken(ByteString resumeToken2, SnapshotVersion snapshotVersion2) {
        return new TargetData(this.target, this.targetId, this.sequenceNumber, this.purpose, snapshotVersion2, this.lastLimboFreeSnapshotVersion, resumeToken2, (Integer) null);
    }

    public TargetData withExpectedCount(Integer expectedCount2) {
        return new TargetData(this.target, this.targetId, this.sequenceNumber, this.purpose, this.snapshotVersion, this.lastLimboFreeSnapshotVersion, this.resumeToken, expectedCount2);
    }

    public TargetData withLastLimboFreeSnapshotVersion(SnapshotVersion lastLimboFreeSnapshotVersion2) {
        return new TargetData(this.target, this.targetId, this.sequenceNumber, this.purpose, this.snapshotVersion, lastLimboFreeSnapshotVersion2, this.resumeToken, this.expectedCount);
    }
