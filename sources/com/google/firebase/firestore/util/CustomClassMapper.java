...
public class CustomClassMapper {
    ...
    public static <T> Object serialize(T o, ErrorPath path) {
        if (path.getLength() > 500) {
            ...
            if (o instanceof Number) {
                ...
                } else if ((o instanceof Date) || (o instanceof Timestamp) || (o instanceof GeoPoint) || (o instanceof Blob) || (o instanceof DocumentReference) || (o instanceof FieldValue) || (o instanceof VectorValue)) {
                    return o;
                } else {
    ...
    private static <T> T deserializeToClass(Object o, Class<T> clazz, DeserializeContext context) {
        ...
        if (VectorValue.class.isAssignableFrom(clazz)) {
            return convertVectorValue(o, context);
        }
        if (clazz.isArray()) {
            throw deserializeError(context.errorPath, "Converting to Arrays is not supported, please use Lists instead");
        } else if (clazz.getTypeParameters().length > 0) {
            throw deserializeError(context.errorPath, "Class " + clazz.getName() + " has generic type parameters");
    ...
    private static class BeanMapper<T> {
        ...
        BeanMapper(java.lang.Class<T> r15) {
            /*
                r14 = this;
                r14.<init>()
                r14.clazz = r15
                ...
                r0.<init>()
                r14.serverTimestamps = r0
                java.util.HashSet r0 = new java.util.HashSet
                r0.<init>()
                r14.documentIdPropertyNames = r0
                r0 = 0
                java.lang.Class[] r2 = new java.lang.Class[r0]     // Catch:{ NoSuchMethodException -> 0x004c }
                java.lang.reflect.Constructor r2 = r15.getDeclaredConstructor(r2)     // Catch:{ NoSuchMethodException -> 0x004c }
            ...
            L_0x012d:
                ...
                java.lang.StringBuilder r1 = r1.append(r5)
                java.lang.String r5 = " has multiple setter overloads with name "
                java.lang.StringBuilder r1 = r1.append(r5)
            ...
            L_0x015a:
                ...
                java.lang.StringBuilder r1 = new java.lang.StringBuilder
                r1.<init>()
                java.lang.String r5 = "Found conflicting setters with name: "
                java.lang.StringBuilder r1 = r1.append(r5)
                java.lang.String r5 = r8.getName()
                java.lang.StringBuilder r1 = r1.append(r5)
            ...
            L_0x019d:
                ...
                java.lang.StringBuilder r1 = new java.lang.StringBuilder
                r1.<init>()
                java.lang.String r5 = "Found setter on "
                java.lang.StringBuilder r1 = r1.append(r5)
                java.lang.String r5 = r3.getName()
                java.lang.StringBuilder r1 = r1.append(r5)
                java.lang.String r5 = " with invalid case-sensitive name: "
                java.lang.StringBuilder r1 = r1.append(r5)
                java.lang.String r5 = r8.getName()
                java.lang.StringBuilder r1 = r1.append(r5)
                java.lang.String r1 = r1.toString()
            ...
            L_0x020c:
                java.util.Map<java.lang.String, java.lang.String> r0 = r14.properties
                boolean r0 = r0.isEmpty()
                if (r0 != 0) goto L_0x0266
                java.util.HashSet<java.lang.String> r0 = r14.documentIdPropertyNames
            ...
            L_0x021a:
                ...
                java.util.Map<java.lang.String, java.lang.reflect.Method> r5 = r14.setters
                boolean r5 = r5.containsKey(r1)
                if (r5 != 0) goto L_0x0264
                java.util.Map<java.lang.String, java.lang.reflect.Field> r5 = r14.fields
                boolean r5 = r5.containsKey(r1)
            ...
            L_0x0237:
                ...
                r5.<init>()
                java.lang.String r6 = "@DocumentId is annotated on property "
                java.lang.StringBuilder r5 = r5.append(r6)
                java.lang.StringBuilder r5 = r5.append(r1)
                java.lang.String r6 = " of class "
                java.lang.StringBuilder r5 = r5.append(r6)
                java.lang.String r6 = r15.getName()
                java.lang.StringBuilder r5 = r5.append(r6)
                java.lang.String r6 = " but no field or public setter was found"
                java.lang.StringBuilder r5 = r5.append(r6)
            ...
            if (this.constructor != null) {
                ...
                for (Map.Entry<String, Object> entry : values.entrySet()) {
                    ...
                    if (this.setters.containsKey(propertyName)) {
                        ...
                        if (params.length == 1) {
                            ApiUtil.invoke(setter, instance, CustomClassMapper.deserializeToType(entry.getValue(), resolveType(params[0], types), context.newInstanceWithErrorPath(childPath)));
                        ...
                        try {
                            field.set(instance, CustomClassMapper.deserializeToType(entry.getValue(), resolveType(field.getGenericType(), types), context.newInstanceWithErrorPath(childPath)));
                            deserialzedProperties.add(propertyName);
