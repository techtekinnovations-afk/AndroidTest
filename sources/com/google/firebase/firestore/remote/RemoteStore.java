...
public final class RemoteStore implements WatchChangeAggregator.TargetMetadataProvider {
    ...
    public RemoteStore(DatabaseId databaseId2, RemoteStoreCallback remoteStoreCallback2, LocalStore localStore2, Datastore datastore2, AsyncQueue workerQueue, ConnectivityMonitor connectivityMonitor2) {
        ...
        this.onlineStateTracker = new OnlineStateTracker(workerQueue, new RemoteStore$$ExternalSyntheticLambda1(remoteStoreCallback2));
        ...
        connectivityMonitor2.addCallback(new RemoteStore$$ExternalSyntheticLambda2(this, workerQueue));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$new$1$com-google-firebase-firestore-remote-RemoteStore  reason: not valid java name */
    public /* synthetic */ void m1923lambda$new$1$comgooglefirebasefirestoreremoteRemoteStore(AsyncQueue workerQueue, ConnectivityMonitor.NetworkStatus networkStatus) {
        workerQueue.enqueueAndForget(new RemoteStore$$ExternalSyntheticLambda0(this, networkStatus));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$new$0$com-google-firebase-firestore-remote-RemoteStore  reason: not valid java name */
    public /* synthetic */ void m1922lambda$new$0$comgooglefirebasefirestoreremoteRemoteStore(ConnectivityMonitor.NetworkStatus networkStatus) {
    ...
    private void raiseWatchSnapshot(SnapshotVersion snapshotVersion) {
        ...
        for (Map.Entry<Integer, QueryPurpose> entry2 : remoteEvent.getTargetMismatches().entrySet()) {
            ...
            if (targetData2 != null) {
                ...
                sendWatchRequest(new TargetData(targetData2.getTarget(), targetId2, targetData2.getSequenceNumber(), entry2.getValue()));
            }
        }
