...
public abstract class WatchChange {
    ...
    public static final class DocumentChange extends WatchChange {
        ...
        public int hashCode() {
            return (((((this.updatedTargetIds.hashCode() * 31) + this.removedTargetIds.hashCode()) * 31) + this.documentKey.hashCode()) * 31) + (this.newDocument != null ? this.newDocument.hashCode() : 0);
        }
    }
    ...
    public static final class WatchTargetChange extends WatchChange {
        ...
        public int hashCode() {
            return (((((this.changeType.hashCode() * 31) + this.targetIds.hashCode()) * 31) + this.resumeToken.hashCode()) * 31) + (this.cause != null ? this.cause.getCode().hashCode() : 0);
        }
    }
}
