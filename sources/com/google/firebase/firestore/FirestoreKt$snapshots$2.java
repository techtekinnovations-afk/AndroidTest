...
final class FirestoreKt$snapshots$2 extends SuspendLambda implements Function2<ProducerScope<? super QuerySnapshot>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                ListenerRegistration registration = this.$this_snapshots.addSnapshotListener(Executors.BACKGROUND_EXECUTOR, this.$metadataChanges, (EventListener<QuerySnapshot>) new FirestoreKt$snapshots$2$$ExternalSyntheticLambda0($this$callbackFlow));
                Intrinsics.checkNotNullExpressionValue(registration, "addSnapshotListener(...)");
                this.label = 1;
                if (ProduceKt.awaitClose($this$callbackFlow, new FirestoreKt$snapshots$2$$ExternalSyntheticLambda1(registration), this) == coroutine_suspended) {
    ...
    public static final void invokeSuspend$lambda$0(ProducerScope $$this$callbackFlow, QuerySnapshot snapshot, FirebaseFirestoreException exception) {
        if (exception != null) {
