...
public final class LoadBundleTaskProgress {
    ...
    public int hashCode() {
        return (((((((((this.documentsLoaded * 31) + this.totalDocuments) * 31) + ((int) (this.bytesLoaded ^ (this.bytesLoaded >>> 32)))) * 31) + ((int) (this.totalBytes ^ (this.totalBytes >>> 32)))) * 31) + this.taskState.hashCode()) * 31) + (this.exception != null ? this.exception.hashCode() : 0);
    }
}
