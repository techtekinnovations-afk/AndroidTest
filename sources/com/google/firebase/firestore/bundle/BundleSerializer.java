...
public class BundleSerializer {
    ...
    public NamedQuery decodeNamedQuery(JSONObject namedQuery) throws JSONException {
        return new NamedQuery(namedQuery.getString("name"), decodeBundledQuery(namedQuery.getJSONObject("bundledQuery")), decodeSnapshotVersion(namedQuery.get("readTime")));
    }
    ...
    public BundleDocument decodeDocument(JSONObject document) throws JSONException {
        DocumentKey key = DocumentKey.fromPath(decodeName(document.getString("name")));
    ...
    /* JADX WARNING: type inference failed for: r8v5, types: [com.google.firebase.firestore.model.BasePath] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private com.google.firebase.firestore.bundle.BundledQuery decodeBundledQuery(org.json.JSONObject r20) throws org.json.JSONException {
        /*
            r19 = this;
            r0 = r19
            r1 = r20
        ...
        L_0x0044:
            ...
            java.util.List r11 = r0.decodeWhere(r3)
            java.lang.String r3 = "orderBy"
            org.json.JSONArray r3 = r2.optJSONArray(r3)
            java.util.List r12 = r0.decodeOrderBy(r3)
            java.lang.String r3 = "startAt"
            org.json.JSONObject r3 = r2.optJSONObject(r3)
            com.google.firebase.firestore.core.Bound r16 = r0.decodeStartAtBound(r3)
            java.lang.String r3 = "endAt"
            org.json.JSONObject r3 = r2.optJSONObject(r3)
            com.google.firebase.firestore.core.Bound r17 = r0.decodeEndAtBound(r3)
            r0.verifyNoOffset(r2)
            int r3 = r0.decodeLimit(r2)
            com.google.firebase.firestore.core.Query$LimitType r7 = r19.decodeLimitType(r20)
            com.google.firebase.firestore.bundle.BundledQuery r8 = new com.google.firebase.firestore.bundle.BundledQuery
            r13 = r8
            com.google.firebase.firestore.core.Query r8 = new com.google.firebase.firestore.core.Query
            r15 = r13
            long r13 = (long) r3
            r18 = r15
            com.google.firebase.firestore.core.Query$LimitType r15 = com.google.firebase.firestore.core.Query.LimitType.LIMIT_TO_FIRST
            r0 = r18
            r8.<init>(r9, r10, r11, r12, r13, r15, r16, r17)
            com.google.firebase.firestore.core.Target r8 = r8.toTarget()
            r0.<init>(r8, r7)
            return r0
        */
    ...
    private void decodeFieldFilter(List<Filter> result, JSONObject fieldFilter) throws JSONException {
        result.add(FieldFilter.create(decodeFieldReference(fieldFilter.getJSONObject("field")), decodeFieldFilterOperator(fieldFilter.getString("op")), decodeValue(fieldFilter.getJSONObject(Values.VECTOR_MAP_VECTORS_KEY))));
    }
            ...
            if (dayOffset != -1) {
                ...
                if (timezoneOffsetPosition != -1) {
                    ...
                    try {
                        ...
                        } else if (str.length() == timezoneOffsetPosition + 1) {
                            int i2 = dayOffset;
                        } else {
