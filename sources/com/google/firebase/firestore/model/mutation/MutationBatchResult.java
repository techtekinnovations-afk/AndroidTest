...
public final class MutationBatchResult {
    ...
    public static MutationBatchResult create(MutationBatch batch2, SnapshotVersion commitVersion2, List<MutationResult> mutationResults2, ByteString streamToken2) {
        ...
        ImmutableSortedMap<DocumentKey, SnapshotVersion> docVersions3 = docVersions2;
        for (int i = 0; i < mutations.size(); i++) {
            docVersions3 = docVersions3.insert(mutations.get(i).getKey(), mutationResults2.get(i).getVersion());
        }
        return new MutationBatchResult(batch2, commitVersion2, mutationResults2, streamToken2, docVersions3);
    }
