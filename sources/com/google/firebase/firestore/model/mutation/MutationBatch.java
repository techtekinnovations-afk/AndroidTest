...
public final class MutationBatch {
    ...
    public Map<DocumentKey, Mutation> applyToLocalDocumentSet(Map<DocumentKey, OverlayedDocument> documentMap, Set<DocumentKey> documentsWithoutRemoteVersion) {
        ...
        for (DocumentKey key : getKeys()) {
            ...
            Mutation overlay = Mutation.calculateOverlayMutation(document, documentsWithoutRemoteVersion.contains(key) ? null : applyToLocalView(document, documentMap.get(key).getMutatedFields()));
            if (overlay != null) {
