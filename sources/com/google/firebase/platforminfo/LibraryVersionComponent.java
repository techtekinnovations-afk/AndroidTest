...
public class LibraryVersionComponent {
    ...
    public static Component<?> fromContext(String sdkName, VersionExtractor<Context> extractor) {
        return Component.intoSetBuilder(LibraryVersion.class).add(Dependency.required((Class<?>) Context.class)).factory(new LibraryVersionComponent$$ExternalSyntheticLambda0(sdkName, extractor)).build();
    }
}
