...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context applicationContext2, String name2, FirebaseOptions options2) {
        ...
        FirebaseTrace.popTrace();
        this.dataCollectionConfigStorage = new Lazy<>(new FirebaseApp$$ExternalSyntheticLambda0(this, applicationContext2));
    ...
    public /* synthetic */ DataCollectionConfigStorage m1764lambda$new$0$comgooglefirebaseFirebaseApp(Context applicationContext2) {
    ...
    public /* synthetic */ void m1765lambda$new$1$comgooglefirebaseFirebaseApp(boolean background) {
        if (!background) {
    ...
    private static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context applicationContext2) {
            if (INSTANCE.get() == null) {
                ...
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(INSTANCE, (Object) null, receiver)) {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(INSTANCE, (Object) null, listener)) {
