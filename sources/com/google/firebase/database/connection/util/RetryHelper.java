    ...
    public void retry(final Runnable runnable) {
        ...
        if (this.lastWasSuccess) {
            ...
            if (this.currentRetryDelay == 0) {
                ...
                this.currentRetryDelay = Math.min((long) (((double) this.currentRetryDelay) * this.retryExponent), this.maxRetryDelay);
            }
            delay = (long) (((1.0d - this.jitterFactor) * ((double) this.currentRetryDelay)) + (this.jitterFactor * ((double) this.currentRetryDelay) * this.random.nextDouble()));
        }
