...
public final /* synthetic */ class DatabaseKt$childEvents$1$listener$1$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ DatabaseKt$childEvents$1$listener$1$$ExternalSyntheticLambda2(ProducerScope producerScope, DataSnapshot dataSnapshot, String str) {
    ...
    public final void run() {
        DatabaseKt$childEvents$1$listener$1.onChildMoved$lambda$3(this.f$0, this.f$1, this.f$2);
    }
}
