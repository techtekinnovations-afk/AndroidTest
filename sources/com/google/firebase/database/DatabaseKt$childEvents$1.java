...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;", "Lcom/google/firebase/database/ChildEvent;"}, k = 3, mv = {2, 0, 0}, xi = 48)
...
final class DatabaseKt$childEvents$1 extends SuspendLambda implements Function2<ProducerScope<? super ChildEvent>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                ChildEventListener listener = this.$this_childEvents.addChildEventListener(new DatabaseKt$childEvents$1$listener$1(this.$this_childEvents, $this$callbackFlow));
                Intrinsics.checkNotNullExpressionValue(listener, "addChildEventListener(...)");
                this.label = 1;
                if (ProduceKt.awaitClose($this$callbackFlow, new DatabaseKt$childEvents$1$$ExternalSyntheticLambda0(this.$this_childEvents, listener), this) == coroutine_suspended) {
    ...
    public static final Unit invokeSuspend$lambda$0(Query $this_childEvents2, ChildEventListener $listener) {
        $this_childEvents2.removeEventListener($listener);
        return Unit.INSTANCE;
    }
}
