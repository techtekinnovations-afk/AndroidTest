...
public final class UserWriteRecord {
    ...
    public int hashCode() {
        int i = 0;
        int result = ((((((Long.valueOf(this.writeId).hashCode() * 31) + Boolean.valueOf(this.visible).hashCode()) * 31) + this.path.hashCode()) * 31) + (this.overwrite != null ? this.overwrite.hashCode() : 0)) * 31;
        if (this.merge != null) {
