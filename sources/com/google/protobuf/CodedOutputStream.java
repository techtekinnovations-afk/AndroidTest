        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    bArr[i] = (byte) ((((int) value) & WorkQueueKt.MASK) | 128);
                    value >>>= 7;
                }
                try {
                    byte[] bArr2 = this.buffer;
                ...
                while ((value & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    UnsafeUtil.putByte(bArr3, (long) i3, (byte) ((((int) value) & WorkQueueKt.MASK) | 128));
                    value >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    private static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            ...
            while (this.position < this.limit) {
                ...
                long j4 = this.position;
                this.position = j4 + 1;
                UnsafeUtil.putByte(j4, (byte) ((((int) value) & WorkQueueKt.MASK) | 128));
                value >>>= 7;
            }
            throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.position), Long.valueOf(this.limit), 1}));
        }
        ...
        public final void bufferUInt32NoTag(int value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((value & WorkQueueKt.MASK) | 128));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
        ...
        public final void bufferUInt64NoTag(long value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((((int) value) & WorkQueueKt.MASK) | 128));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
