...
final class Utf8 {
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        public int encodeUtf8(CharSequence in, byte[] out, int offset, int length) {
            ...
            int inLimit = charSequence.length();
            ...
            while (inIx < inLimit) {
                ...
                if (c4 >= c || outIx >= outLimit) {
                    ...
                    } else if (55296 > c4 || c4 > 57343 || (inIx + 1 != inLimit && Character.isSurrogatePair(c4, charSequence.charAt(inIx + 1)))) {
        ...
        public void encodeUtf8Direct(CharSequence in, ByteBuffer out) {
            ...
            if (((long) inLimit) <= outLimit - outIx2) {
                ...
                while (inIx < inLimit) {
                    char c2 = charSequence.charAt(inIx);
                    if (c2 >= i || outIx >= outLimit) {
                        ...
                        if (c2 >= 2048 || outIx > outLimit - 2) {
                            ...
                            if ((c2 < 55296 || 57343 < c2) && outIx <= outLimit - 3) {
                                ...
                                throw new UnpairedSurrogateException(inIx - 1, inLimit);
                            } else if (55296 > c2 || c2 > 57343 || (inIx + 1 != inLimit && Character.isSurrogatePair(c2, charSequence.charAt(inIx + 1)))) {
            ...
            throw new ArrayIndexOutOfBoundsException("Failed writing " + charSequence.charAt(inLimit - 1) + " at index " + byteBuffer.limit());
        }
