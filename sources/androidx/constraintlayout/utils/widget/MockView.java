...
public class MockView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            ...
            canvas3.drawLine(0.0f, 0.0f, (float) w, (float) h, this.mPaintDiagonals);
            canvas2 = canvas3;
            canvas2.drawLine(0.0f, (float) h, (float) w, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, 0.0f, (float) w, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine((float) w, 0.0f, (float) w, (float) h, this.mPaintDiagonals);
            canvas2.drawLine((float) w, (float) h, 0.0f, (float) h, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, (float) h, 0.0f, 0.0f, this.mPaintDiagonals);
        } else {
            canvas2 = canvas;
        }
        if (this.mText != null && this.mDrawLabel) {
            ...
            canvas2.drawText(this.mText, tx, ty, this.mPaintText);
        }
    }
}
