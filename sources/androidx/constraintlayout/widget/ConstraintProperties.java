...
public class ConstraintProperties {
    ...
    public ConstraintProperties removeFromVerticalChain() {
        ...
        if (!(topId == -1 && bottomId == -1)) {
            ...
            if (topId != -1 && bottomId != -1) {
                ...
                if (this.mParams.bottomToBottom != -1) {
                    topProp.connect(4, this.mParams.bottomToBottom, 4, 0);
                } else if (this.mParams.topToTop != -1) {
    ...
    public ConstraintProperties removeFromHorizontalChain() {
        ...
        if (leftId == -1 && rightId == -1) {
            int startId = this.mParams.startToEnd;
            ...
            if (!(startId == -1 && endId == -1)) {
                ...
                if (startId != -1 && endId != -1) {
                    ...
                    if (this.mParams.rightToRight != -1) {
                        startProp.connect(7, this.mParams.rightToRight, 7, 0);
                    } else if (this.mParams.leftToLeft != -1) {
