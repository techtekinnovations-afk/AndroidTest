...
public class MotionScene {
    ...
    public Transition bestTransitionFor(int currentState, float dx, float dy, MotionEvent lastTouchDown) {
        ...
        List<Transition> candidates2 = getTransitionsWithState(currentState);
        float max2 = 0.0f;
        Transition best = null;
        RectF cache = new RectF();
        for (Transition transition : candidates2) {
            if (!transition.mDisable) {
                if (transition.mTouchResponse != null) {
                    ...
                    if ((region2 == null || lastTouchDown == null || region2.contains(lastTouchDown.getX(), lastTouchDown.getY())) && ((region = transition.mTouchResponse.getLimitBoundsTo(this.mMotionLayout, cache)) == null || lastTouchDown == null || region.contains(lastTouchDown.getX(), lastTouchDown.getY()))) {
                        float val2 = transition.mTouchResponse.dot(f, f2);
                        if (!transition.mTouchResponse.mIsRotateMode || lastTouchDown == null) {
                            ...
                            candidates = candidates2;
                            max = max2;
                            val2 = ((float) (Math.atan2((double) (f2 + startY), (double) (f + startX)) - Math.atan2((double) startX, (double) startY))) * 10.0f;
                        }
    ...
    public int[] getMatchingStateLabels(String... types) {
        ...
        int count = 0;
        for (int i = 0; i < ids.length; i++) {
            ConstraintSet set = this.mConstraintSetMap.valueAt(i);
            int id = this.mConstraintSetMap.keyAt(i);
            if (set.matchesLabels(types)) {
                String[] stateLabels = set.getStateLabels();
                ids[count] = id;
                count++;
            }
        }
    ...
    private void load(android.content.Context r12, int r13) {
        /*
            ...
            android.content.res.XmlResourceParser r3 = r2.getXml(r13)
            r4 = 0
            int r5 = r3.getEventType()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
        L_0x0011:
            r6 = 1
            ...
            }     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
        L_0x0017:
            goto L_0x015c
        L_0x0019:
            java.lang.String r7 = r3.getName()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            int r8 = r7.hashCode()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r9 = -1
            switch(r8) {
                case -1349929691: goto L_0x0080;
                case -1239391468: goto L_0x0075;
                case -687739768: goto L_0x006b;
                case 61998586: goto L_0x0060;
                case 269306229: goto L_0x0057;
                case 312750793: goto L_0x004d;
                case 327855227: goto L_0x0043;
                case 793277014: goto L_0x003b;
                case 1382829617: goto L_0x0031;
        ...
        L_0x0027:
            ...
            boolean r6 = r7.equals(r6)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
        ...
        L_0x0031:
            ...
            goto L_0x008b
        L_0x003b:
            boolean r6 = r7.equals(r1)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            if (r6 == 0) goto L_0x0025
            r6 = 0
            goto L_0x008b
        L_0x0043:
        ...
        L_0x0057:
            ...
            boolean r8 = r7.equals(r8)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
        ...
        L_0x008e:
            goto L_0x015c
        L_0x0090:
            androidx.constraintlayout.motion.widget.ViewTransition r6 = new androidx.constraintlayout.motion.widget.ViewTransition     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r6.<init>(r12, r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.ViewTransitionController r8 = r11.mViewTransitionController     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r8.add(r6)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            goto L_0x015c
        L_0x009c:
            androidx.constraintlayout.motion.widget.KeyFrames r6 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r6.<init>(r12, r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            if (r4 == 0) goto L_0x015c
            java.util.ArrayList r8 = r4.mKeyFramesList     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r8.add(r6)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            goto L_0x015c
        L_0x00ac:
            r11.parseInclude((android.content.Context) r12, (org.xmlpull.v1.XmlPullParser) r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            goto L_0x015c
        L_0x00b1:
            r11.parseConstraintSet(r12, r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            goto L_0x015c
        L_0x00b6:
            androidx.constraintlayout.widget.StateSet r6 = new androidx.constraintlayout.widget.StateSet     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r6.<init>(r12, r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r11.mStateSet = r6     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            goto L_0x015c
        L_0x00bf:
            if (r4 == 0) goto L_0x015c
            androidx.constraintlayout.motion.widget.MotionLayout r6 = r11.mMotionLayout     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            boolean r6 = r6.isInEditMode()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            if (r6 != 0) goto L_0x015c
            r4.addOnClick((android.content.Context) r12, (org.xmlpull.v1.XmlPullParser) r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            goto L_0x015c
        L_0x00ce:
            if (r4 != 0) goto L_0x0102
            android.content.res.Resources r6 = r12.getResources()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            java.lang.String r6 = r6.getResourceEntryName(r13)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            int r8 = r3.getLineNumber()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r9.<init>()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            java.lang.String r10 = " OnSwipe ("
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            java.lang.StringBuilder r9 = r9.append(r6)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            java.lang.String r10 = ".xml:"
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            java.lang.StringBuilder r9 = r9.append(r8)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            java.lang.String r10 = ")"
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            java.lang.String r9 = r9.toString()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            android.util.Log.v(r1, r9)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
        L_0x0102:
            if (r4 == 0) goto L_0x015c
            androidx.constraintlayout.motion.widget.TouchResponse r6 = new androidx.constraintlayout.motion.widget.TouchResponse     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.MotionLayout r8 = r11.mMotionLayout     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r6.<init>(r12, r8, r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.TouchResponse unused = r4.mTouchResponse = r6     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            goto L_0x015c
        L_0x010f:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r6 = r11.mTransitionList     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r8 = new androidx.constraintlayout.motion.widget.MotionScene$Transition     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r8.<init>(r11, r12, r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r4 = r8
            r6.add(r8)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r6 = r11.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            if (r6 != 0) goto L_0x013d
            boolean r6 = r4.mIsAbstract     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            if (r6 != 0) goto L_0x013d
            r11.mCurrentTransition = r4     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r6 = r11.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            if (r6 == 0) goto L_0x013d
            androidx.constraintlayout.motion.widget.MotionScene$Transition r6 = r11.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.TouchResponse r6 = r6.mTouchResponse     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            if (r6 == 0) goto L_0x013d
            androidx.constraintlayout.motion.widget.MotionScene$Transition r6 = r11.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            androidx.constraintlayout.motion.widget.TouchResponse r6 = r6.mTouchResponse     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            boolean r8 = r11.mRtl     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r6.setRTL(r8)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
        L_0x013d:
            boolean r6 = r4.mIsAbstract     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            if (r6 == 0) goto L_0x015c
            int r6 = r4.mConstraintSetEnd     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            if (r6 != r9) goto L_0x014c
            r11.mDefaultTransition = r4     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            goto L_0x0151
        L_0x014c:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r6 = r11.mAbstractTransitionList     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r6.add(r4)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
        L_0x0151:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r6 = r11.mTransitionList     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r6.remove(r4)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            goto L_0x015c
        L_0x0157:
            r11.parseMotionSceneTags(r12, r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            goto L_0x015c
        L_0x015b:
        L_0x015c:
            int r6 = r3.next()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0164 }
            r5 = r6
            goto L_0x0011
        L_0x0163:
            goto L_0x018f
    ...
    public int parseInclude(Context context, int resourceId) {
        ...
        try {
            ...
            Log.e(TypedValues.MotionScene.NAME, "Error parsing resource: " + resourceId, e);
            return -1;
        } catch (IOException e2) {
            Log.e(TypedValues.MotionScene.NAME, "Error parsing resource: " + resourceId, e2);
            return -1;
        }
    }
    ...
    /* JADX WARNING: Can't fix incorrect switch cases order */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private int parseConstraintSet(android.content.Context r19, org.xmlpull.v1.XmlPullParser r20) {
        /*
            r18 = this;
            r1 = r18
            r2 = r19
        ...
        L_0x001a:
            ...
            switch(r0) {
                ...
                case -1153153640: goto L_0x0043;
                case 3355: goto L_0x0039;
                case 973381616: goto L_0x002f;
                default: goto L_0x002e;
            }
        L_0x002e:
            goto L_0x0057
        L_0x002f:
            java.lang.String r0 = "stateLabels"
        ...
        L_0x005b:
            goto L_0x00e3
        L_0x005d:
            int r0 = java.lang.Integer.parseInt(r13)     // Catch:{ NumberFormatException -> 0x0065 }
            r4.mRotate = r0     // Catch:{ NumberFormatException -> 0x0065 }
            goto L_0x00e3
        L_0x0065:
            r0 = move-exception
            ...
            r10 = 4
            switch(r16) {
                case -768416914: goto L_0x009b;
                case 3317767: goto L_0x0090;
                case 3387192: goto L_0x0085;
                case 108511772: goto L_0x007a;
                case 1954540437: goto L_0x006f;
                default: goto L_0x006e;
            }
        L_0x006e:
            goto L_0x00a6
        L_0x006f:
            java.lang.String r5 = "x_right"
    ...
    public ConstraintSet getConstraintSet(Context context, String id) {
        for (int i = 0; i < this.mConstraintSetMap.size(); i++) {
            ...
            if (id.equals(context.getResources().getResourceName(key))) {
