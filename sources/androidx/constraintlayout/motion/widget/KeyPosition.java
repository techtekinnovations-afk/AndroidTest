...
public class KeyPosition extends KeyPositionBase {
    ...
    /* access modifiers changed from: package-private */
    public void positionAxisAttributes(RectF start, RectF end, float x, float y, String[] attribute, float[] value) {
        float startCenterX = start.centerX();
        float startCenterY = start.centerY();
    ...
    private static class Loader {
        ...
        static {
            sAttrMap.append(R.styleable.KeyPosition_motionTarget, 1);
            ...
            for (int i = 0; i < n; i++) {
                ...
                switch (sAttrMap.get(attr)) {
                    ...
                    case 12:
                        ...
                        break;
                    default:
                        Log.e(TypedValues.PositionType.NAME, "unused attribute 0x" + Integer.toHexString(attr) + "   " + sAttrMap.get(attr));
                        break;
                }
            }
