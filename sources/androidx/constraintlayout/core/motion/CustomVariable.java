    ...
    public void getValuesToInterpolate(float[] ret) {
        switch (this.mType) {
            ...
            case TypedValues.Custom.TYPE_FLOAT /*901*/:
                ...
                return;
            case TypedValues.Custom.TYPE_COLOR /*902*/:
                ret[0] = (float) Math.pow((double) (((float) ((this.mIntegerValue >> 16) & 255)) / 255.0f), 2.2d);
                ret[1] = (float) Math.pow((double) (((float) ((this.mIntegerValue >> 8) & 255)) / 255.0f), 2.2d);
                ret[2] = (float) Math.pow((double) (((float) (this.mIntegerValue & 255)) / 255.0f), 2.2d);
                ret[3] = ((float) ((this.mIntegerValue >> 24) & 255)) / 255.0f;
                return;
            case TypedValues.Custom.TYPE_STRING /*903*/:
                throw new RuntimeException("Cannot interpolate String");
            case TypedValues.Custom.TYPE_BOOLEAN /*904*/:
    ...
    public void setInterpolatedValue(MotionWidget view, float[] value) {
        ...
        switch (this.mType) {
            ...
            case TypedValues.Custom.TYPE_COLOR /*902*/:
                int r = clamp((int) (((float) Math.pow((double) value[0], 0.45454545454545453d)) * 255.0f));
                int g = clamp((int) (((float) Math.pow((double) value[1], 0.45454545454545453d)) * 255.0f));
                view.setCustomAttribute(this.mName, this.mType, (clamp((int) (value[3] * 255.0f)) << 24) | (r << 16) | (g << 8) | clamp((int) (((float) Math.pow((double) value[2], 0.45454545454545453d)) * 255.0f)));
                return;
            case TypedValues.Custom.TYPE_STRING /*903*/:
            case TypedValues.Custom.TYPE_REFERENCE /*906*/:
