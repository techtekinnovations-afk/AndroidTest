        ...
        for (String key : hashMap.keySet()) {
            if (key.startsWith("CUSTOM")) {
                ...
                if (!(cValue == null || cValue.getType() != 901 || (osc2 = hashMap.get(key)) == null)) {
                    osc2.setPoint(this.mFramePosition, this.mWaveShape, this.mCustomWaveShape, -1, this.mWavePeriod, this.mWaveOffset, this.mWavePhase / 360.0f, cValue.getValueToInterpolate(), cValue);
                }
            } else {
                ...
                if (!Float.isNaN(value) && (osc = hashMap.get(key)) != null) {
                    ...
                    String str = this.mCustomWaveShape;
                    float f = this.mWavePeriod;
                    osc.setPoint(i, i2, str, -1, f, this.mWaveOffset, this.mWavePhase / 360.0f, value);
                }
            }
        }
    }
