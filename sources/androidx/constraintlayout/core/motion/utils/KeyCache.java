...
public class KeyCache {
    ...
    public void setFloatValue(Object view, String type, int element, float value) {
        if (!this.mMap.containsKey(view)) {
            ...
            this.mMap.put(view, array);
            return;
        }
        HashMap<String, float[]> array2 = this.mMap.get(view);
        if (array2 == null) {
            array2 = new HashMap<>();
        }
    ...
    public float getFloatValue(Object view, String type, int element) {
        ...
        float[] vArray;
        if (this.mMap.containsKey(view) && (array = this.mMap.get(view)) != null && array.containsKey(type) && (vArray = array.get(type)) != null && vArray.length > element) {
