...
public class CLContainer extends CLElement {
    ...
    public void putString(String name, String value) {
        ...
        stringElement.setEnd((long) (value.length() - 1));
    ...
    public CLArray getArrayOrCreate(String name) {
        ...
        CLArray array2 = new CLArray(new char[0]);
        put(name, array2);
        return array2;
    }
    ...
    public CLContainer clone() {
        ...
        ArrayList<CLElement> clonedArray = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement elementClone = it.next().clone();
    ...
    public int hashCode() {
        return Objects.hash(new Object[]{this.mElements, Integer.valueOf(super.hashCode())});
    }
}
