...
public class Flow extends VirtualLayout {
    ...
    public int getWidgetWidth(ConstraintWidget widget, int max) {
        ...
        if (widget.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (widget2.mMatchConstraintDefaultWidth == 3) {
                return (int) ((((float) widget2.getHeight()) * widget2.mDimensionRatio) + 0.5f);
            }
        }
        return widget2.getWidth();
    }
    ...
    public int getWidgetHeight(ConstraintWidget widget, int max) {
        ...
        if (widget.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (widget2.mMatchConstraintDefaultHeight == 3) {
                return (int) ((((float) widget2.getWidth()) * widget2.mDimensionRatio) + 0.5f);
            }
        }
        return widget2.getHeight();
    }
    ...
    public void measure(int r25, int r26, int r27, int r28) {
        /*
            r24 = this;
            r0 = r24
            r6 = r25
        ...
        L_0x0040:
            ...
            int r1 = r0.mHorizontalStyle
            if (r1 != r2) goto L_0x004b
            r0.mHorizontalStyle = r10
        L_0x004b:
            int r1 = r0.mVerticalStyle
        ...
        L_0x0069:
            ...
            androidx.constraintlayout.core.widgets.ConstraintWidget[] r3 = r0.mWidgets
            r3 = r3[r2]
            r20 = r1
        ...
        L_0x0119:
            ...
            int r12 = java.lang.Math.min(r10, r9)
            goto L_0x0125
        L_0x0122:
            if (r8 != 0) goto L_0x0125
            r12 = r10
        L_0x0125:
            r0.setMeasure(r11, r12)
            r0.setWidth(r11)
            r0.setHeight(r12)
            int r1 = r0.mWidgetsCount
            ...
            if (this.mNbMatchConstraintsWidgets != 0) {
                ...
                while (i < count && this.mStartIndex + i < Flow.this.mDisplayedWidgetsCount) {
                    ...
                    if (this.mOrientation == 0) {
                        ...
                        Flow.this.measure(widget, widget.getHorizontalDimensionBehaviour(), widget.getWidth(), ConstraintWidget.DimensionBehaviour.FIXED, widgetSize2);
    ...
    private void measureChainWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        if (i != 0) {
            ...
            int i2 = max;
            WidgetsList list2 = new WidgetsList(orientation, this.mLeft, this.mTop, this.mRight, this.mBottom, i2);
            ...
            if (orientation == 0) {
                ...
                while (i3 < i) {
                    ...
                    int w = getWidgetWidth(widget, i2);
                    if (widget.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                        nbMatchConstraintsWidgets3 = nbMatchConstraintsWidgets4 + 1;
                    } else {
                        nbMatchConstraintsWidgets3 = nbMatchConstraintsWidgets4;
                    }
                    boolean doWrap3 = (width == i2 || (this.mHorizontalGap + width) + w > i2) && list3.mBiggest != null;
                    if (doWrap3 || i3 <= 0 || this.mMaxElementsWrap <= 0 || i3 % this.mMaxElementsWrap != 0) {
                        doWrap2 = doWrap3;
                    } else {
                        doWrap2 = true;
                    }
                    if (doWrap2) {
                        WidgetsList list4 = new WidgetsList(orientation, this.mLeft, this.mTop, this.mRight, this.mBottom, i2);
                ...
                while (i4 < i) {
                    ...
                    int h = getWidgetHeight(widget2, i2);
                    ...
                    boolean doWrap4 = (height == i2 || (this.mVerticalGap + height) + h > i2) && list5.mBiggest != null;
                    if (doWrap4 || i4 <= 0 || this.mMaxElementsWrap <= 0 || i4 % this.mMaxElementsWrap != 0) {
                        doWrap = doWrap4;
                    } else {
                        doWrap = true;
                    }
                    if (doWrap) {
                        WidgetsList list6 = new WidgetsList(orientation, this.mLeft, this.mTop, this.mRight, this.mBottom, i2);
            ...
            if (nbMatchConstraintsWidgets4 <= 0 || !needInternalMeasure) {
                int i5 = nbMatchConstraintsWidgets4;
            } else {
                int i6 = 0;
                while (i6 < listCount) {
                    boolean needInternalMeasure2 = needInternalMeasure;
                    WidgetsList current = this.mChainList.get(i6);
                    if (orientation == 0) {
            ...
            for (int i8 = 0; i8 < listCount; i8++) {
                WidgetsList current2 = this.mChainList.get(i8);
                if (orientation == 0) {
                    if (i8 < listCount - 1) {
                        paddingBottom2 = 0;
                        bottom2 = this.mChainList.get(i8 + 1).mBiggest.mTop;
                    } else {
                        ConstraintAnchor bottom3 = this.mBottom;
                    ...
                    ConstraintAnchor top3 = currentBottom;
                    ...
                    if (i8 < listCount - 1) {
                        paddingRight2 = 0;
                        right2 = this.mChainList.get(i8 + 1).mBiggest.mLeft;
                    } else {
                        ConstraintAnchor right3 = this.mRight;
                        paddingRight2 = getPaddingRight();
                        right2 = right3;
                    }
                    ConstraintAnchor currentRight = current2.mBiggest.mRight;
                    current2.setup(orientation, left2, top2, right2, bottom2, paddingLeft2, paddingTop2, paddingRight2, paddingBottom2, max);
                    ConstraintAnchor left3 = currentRight;
        ...
        if (i != 0) {
            ...
            if (orientation == 0) {
                ...
                while (i3 < i) {
                    ...
                    boolean doWrap3 = (width == i2 || (this.mHorizontalGap + width) + w > i2) && list3.mBiggest != null;
                    if (doWrap3 || i3 <= 0 || this.mMaxElementsWrap <= 0 || col <= this.mMaxElementsWrap) {
                        doWrap2 = doWrap3;
                    } else {
                        doWrap2 = true;
                    }
                ...
                while (i4 < i) {
                    ...
                    boolean doWrap4 = (height == i2 || (this.mVerticalGap + height) + h > i2) && list5.mBiggest != null;
                    if (doWrap4 || i4 <= 0 || this.mMaxElementsWrap <= 0 || row <= this.mMaxElementsWrap) {
                        doWrap = doWrap4;
                    } else {
                        doWrap = true;
                    }
    ...
    private void measureNoWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        if (i != 0) {
            if (this.mChainList.size() == 0) {
                ...
                list2.clear();
                int i2 = orientation;
                list2.setup(i2, this.mLeft, this.mTop, this.mRight, this.mBottom, getPaddingLeft(), getPaddingTop(), getPaddingRight(), getPaddingBottom(), max);
                list = list2;
            }
        ...
        if (i2 == 0) {
            ...
            if (cols <= 0) {
                ...
                for (int i4 = 0; i4 < i; i4++) {
                    ...
                    ConstraintWidget widget = constraintWidgetArr[i4];
                    if (widget != null) {
                        w += getWidgetWidth(widget, i3);
                        if (w > i3) {
                            break;
                        }
                        cols++;
            ...
            if (rows <= 0) {
                ...
                for (int i5 = 0; i5 < i; i5++) {
                    ...
                    ConstraintWidget widget2 = constraintWidgetArr[i5];
                    if (widget2 != null) {
                        h += getWidgetHeight(widget2, i3);
                        if (h > i3) {
                            break;
                        }
                        rows++;
        ...
        while (!done) {
            ...
            for (int i6 = 0; i6 < cols; i6++) {
                for (int j = 0; j < rows; j++) {
                    ...
                    if (index < constraintWidgetArr.length) {
                        ConstraintWidget widget3 = constraintWidgetArr[index];
                        if (widget3 != null) {
                            int w2 = getWidgetWidth(widget3, i3);
                            if (this.mAlignedBiggestElementsInCols[i6] == null || this.mAlignedBiggestElementsInCols[i6].getWidth() < w2) {
                                this.mAlignedBiggestElementsInCols[i6] = widget3;
                            }
                            int h2 = getWidgetHeight(widget3, i3);
                            if (this.mAlignedBiggestElementsInRows[j] == null || this.mAlignedBiggestElementsInRows[j].getHeight() < h2) {
                                this.mAlignedBiggestElementsInRows[j] = widget3;
                            }
                        }
                    }
                }
