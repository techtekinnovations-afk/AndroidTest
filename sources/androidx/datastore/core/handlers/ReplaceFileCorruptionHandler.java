...
public final class ReplaceFileCorruptionHandler<T> implements CorruptionHandler<T> {
    ...
    public ReplaceFileCorruptionHandler(Function1<? super CorruptionException, ? extends T> produceNewData2) {
        Intrinsics.checkNotNullParameter(produceNewData2, "produceNewData");
        this.produceNewData = produceNewData2;
    }

    public Object handleCorruption(CorruptionException ex, Continuation<? super T> $completion) throws IOException {
        return this.produceNewData.invoke(ex);
    }
}
