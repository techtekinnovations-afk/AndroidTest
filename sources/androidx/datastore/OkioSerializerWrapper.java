...
public final class OkioSerializerWrapper<T> implements OkioSerializer<T> {
    ...
    public OkioSerializerWrapper(Serializer<T> delegate2) {
    ...
    public Object readFrom(BufferedSource source, Continuation<? super T> $completion) {
        return this.delegate.readFrom(source.inputStream(), $completion);
    }

    public Object writeTo(T t, BufferedSink sink, Continuation<? super Unit> $completion) {
        Object writeTo = this.delegate.writeTo(t, sink.outputStream(), $completion);
