        ...
        private int readVarint32() throws IOException {
            ...
            if (this.limit != this.pos) {
                ...
                if (i3 >= 0) {
                    ...
                    int i4 = i2 + 1;
                    int i5 = (this.buffer[i2] << 7) ^ x;
                    int x2 = i5;
                    if (i5 < 0) {
                        y = x2 ^ -128;
                    } else {
                        int i6 = i4 + 1;
                        int i7 = (this.buffer[i4] << Ascii.SO) ^ x2;
                        int x3 = i7;
                        if (i7 >= 0) {
                            y = x3 ^ 16256;
                            i4 = i6;
                            ...
                            i4 = i6 + 1;
                            int i8 = (this.buffer[i6] << Ascii.NAK) ^ x3;
                            int x4 = i8;
                            if (i8 < 0) {
                                y = -2080896 ^ x4;
                            } else {
                                int i9 = i4 + 1;
                                byte y2 = this.buffer[i4];
                                int x5 = (x4 ^ (y2 << Ascii.FS)) ^ 266354560;
                                if (y2 < 0) {
                                    int i10 = i9 + 1;
                                    if (this.buffer[i9] < 0) {
                                        i4 = i10 + 1;
        ...
        public long readVarint64() throws IOException {
            ...
            if (this.limit != i) {
                ...
                if (i3 >= 0) {
                    ...
                    int i4 = i2 + 1;
                    int i5 = (buffer2[i2] << 7) ^ y;
                    int y2 = i5;
                    if (i5 < 0) {
                        x = (long) (y2 ^ -128);
                    } else {
                        int i6 = i4 + 1;
                        int i7 = (buffer2[i4] << Ascii.SO) ^ y2;
                        int y3 = i7;
                        if (i7 >= 0) {
                            x = (long) (y3 ^ 16256);
                            i4 = i6;
