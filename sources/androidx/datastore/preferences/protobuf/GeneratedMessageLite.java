...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
        ...
        public BuilderType mergeFrom(byte[] input, int offset, int length, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            ...
            try {
                try {
                    ...
                    IndexOutOfBoundsException indexOutOfBoundsException = e4;
                ...
                byte[] bArr2 = input;
                int i2 = offset;
                IndexOutOfBoundsException indexOutOfBoundsException2 = e7;
                throw InvalidProtocolBufferException.truncatedMessage();
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        private boolean parseExtension(CodedInputStream input, ExtensionRegistryLite extensionRegistry, GeneratedExtension<?, ?> extension, int tag, int fieldNumber) throws IOException {
            ...
            int i = tag;
            FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable = ensureExtensionsAreMutable();
            if (packed) {
                int limit = codedInputStream.pushLimit(codedInputStream.readRawVarint32());
                if (generatedExtension.descriptor.getLiteType() == WireFormat.FieldType.ENUM) {
                    while (codedInputStream.getBytesUntilLimit() > 0) {
                        Object value2 = generatedExtension.descriptor.getEnumType().findValueByNumber(codedInputStream.readEnum());
                        if (value2 == null) {
                            return z2;
                        }
                ...
                switch (generatedExtension.descriptor.getLiteJavaType()) {
                    case MESSAGE:
                        ...
                        if (subBuilder == null) {
                            subBuilder = generatedExtension.getMessageDefaultInstance().newBuilderForType();
                        }
                        if (generatedExtension.descriptor.getLiteType() == WireFormat.FieldType.GROUP) {
                            codedInputStream.readGroup(generatedExtension.getNumber(), subBuilder, extensionRegistryLite);
                        } else {
                        ...
                        break;
                    case ENUM:
                        int rawValue = codedInputStream.readEnum();
        ...
        private void eagerlyMergeMessageSetExtension(CodedInputStream input, GeneratedExtension<?, ?> extension, ExtensionRegistryLite extensionRegistry, int typeId) throws IOException {
            CodedInputStream input2 = input;
            GeneratedExtension<?, ?> extension2 = extension;
            ExtensionRegistryLite extensionRegistry2 = extensionRegistry;
            boolean parseExtension = parseExtension(input2, extensionRegistry2, extension2, WireFormat.makeTag(typeId, 2), typeId);
        }
    ...
    public static <ContainingType extends MessageLite, Type> GeneratedExtension<ContainingType, Type> newSingularGeneratedExtension(ContainingType containingTypeDefaultInstance, Type defaultValue, MessageLite messageDefaultInstance, Internal.EnumLiteMap<?> enumTypeMap, int number, WireFormat.FieldType type, Class singularType) {
        Internal.EnumLiteMap<?> enumTypeMap2 = enumTypeMap;
        MessageLite messageDefaultInstance2 = messageDefaultInstance;
        return new GeneratedExtension<>(containingTypeDefaultInstance, defaultValue, messageDefaultInstance2, new ExtensionDescriptor(enumTypeMap2, number, type, false, false), singularType);
    }
    ...
    public static <ContainingType extends MessageLite, Type> GeneratedExtension<ContainingType, Type> newRepeatedGeneratedExtension(ContainingType containingTypeDefaultInstance, MessageLite messageDefaultInstance, Internal.EnumLiteMap<?> enumTypeMap, int number, WireFormat.FieldType type, boolean isPacked, Class singularType) {
        Internal.EnumLiteMap<?> enumTypeMap2 = enumTypeMap;
        int number2 = number;
        return new GeneratedExtension<>(containingTypeDefaultInstance, Collections.emptyList(), messageDefaultInstance, new ExtensionDescriptor(enumTypeMap2, number2, type, true, isPacked), singularType);
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static <T extends androidx.datastore.preferences.protobuf.GeneratedMessageLite<T, ?>> T parsePartialFrom(T r6, byte[] r7, int r8, int r9, androidx.datastore.preferences.protobuf.ExtensionRegistryLite r10) throws androidx.datastore.preferences.protobuf.InvalidProtocolBufferException {
        /*
            if (r9 != 0) goto L_0x0003
            return r6
        L_0x0003:
            androidx.datastore.preferences.protobuf.GeneratedMessageLite r1 = r6.newMutableInstance()
            androidx.datastore.preferences.protobuf.Protobuf r0 = androidx.datastore.preferences.protobuf.Protobuf.getInstance()     // Catch:{ InvalidProtocolBufferException -> 0x0063, UninitializedMessageException -> 0x0056, IOException -> 0x0039, IndexOutOfBoundsException -> 0x002c }
            androidx.datastore.preferences.protobuf.Schema r0 = r0.schemaFor(r1)     // Catch:{ InvalidProtocolBufferException -> 0x0063, UninitializedMessageException -> 0x0056, IOException -> 0x0039, IndexOutOfBoundsException -> 0x002c }
            int r4 = r8 + r9
            androidx.datastore.preferences.protobuf.ArrayDecoders$Registers r5 = new androidx.datastore.preferences.protobuf.ArrayDecoders$Registers     // Catch:{ InvalidProtocolBufferException -> 0x0063, UninitializedMessageException -> 0x0056, IOException -> 0x0039, IndexOutOfBoundsException -> 0x002c }
            r5.<init>(r10)     // Catch:{ InvalidProtocolBufferException -> 0x0063, UninitializedMessageException -> 0x0056, IOException -> 0x0039, IndexOutOfBoundsException -> 0x002c }
            r2 = r7
            r3 = r8
            r0.mergeFrom(r1, r2, r3, r4, r5)     // Catch:{ InvalidProtocolBufferException -> 0x0029, UninitializedMessageException -> 0x0026, IOException -> 0x0023, IndexOutOfBoundsException -> 0x0020 }
            r0.makeImmutable(r1)     // Catch:{ InvalidProtocolBufferException -> 0x0029, UninitializedMessageException -> 0x0026, IOException -> 0x0023, IndexOutOfBoundsException -> 0x0020 }
            return r1
        L_0x0020:
            r0 = move-exception
            r7 = r0
        ...
        L_0x0030:
            ...
            androidx.datastore.preferences.protobuf.InvalidProtocolBufferException r8 = r8.setUnfinishedMessage(r1)
            throw r8
        L_0x0039:
            r0 = move-exception
            r2 = r7
        ...
        L_0x003d:
            ...
            boolean r8 = r8 instanceof androidx.datastore.preferences.protobuf.InvalidProtocolBufferException
            if (r8 == 0) goto L_0x004c
            java.lang.Throwable r8 = r7.getCause()
            androidx.datastore.preferences.protobuf.InvalidProtocolBufferException r8 = (androidx.datastore.preferences.protobuf.InvalidProtocolBufferException) r8
            throw r8
        L_0x004c:
            androidx.datastore.preferences.protobuf.InvalidProtocolBufferException r8 = new androidx.datastore.preferences.protobuf.InvalidProtocolBufferException
            r8.<init>((java.io.IOException) r7)
            androidx.datastore.preferences.protobuf.InvalidProtocolBufferException r8 = r8.setUnfinishedMessage(r1)
            throw r8
        L_0x0056:
            r0 = move-exception
            ...
            r7 = r0
        L_0x005a:
            androidx.datastore.preferences.protobuf.InvalidProtocolBufferException r8 = r7.asInvalidProtocolBufferException()
            androidx.datastore.preferences.protobuf.InvalidProtocolBufferException r8 = r8.setUnfinishedMessage(r1)
            throw r8
        L_0x0063:
            r0 = move-exception
        ...
        L_0x0067:
            ...
            r7 = r8
        L_0x0073:
            androidx.datastore.preferences.protobuf.InvalidProtocolBufferException r8 = r7.setUnfinishedMessage(r1)
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.GeneratedMessageLite.parsePartialFrom(androidx.datastore.preferences.protobuf.GeneratedMessageLite, byte[], int, int, androidx.datastore.preferences.protobuf.ExtensionRegistryLite):androidx.datastore.preferences.protobuf.GeneratedMessageLite");
    }
