...
public final class PreferencesFileSerializer implements Serializer<Preferences> {
    ...
    public Object readFrom(InputStream input, Continuation<? super Preferences> $completion) throws IOException, CorruptionException {
    ...
    public Object writeTo(Preferences t, OutputStream output, Continuation<? super Unit> $completion) throws IOException, CorruptionException {
