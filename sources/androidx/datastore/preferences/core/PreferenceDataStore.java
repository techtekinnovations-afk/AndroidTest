...
public final class PreferenceDataStore implements DataStore<Preferences> {
    ...
    public PreferenceDataStore(DataStore<Preferences> delegate2) {
        Intrinsics.checkNotNullParameter(delegate2, "delegate");
        this.delegate = delegate2;
    }

    public Object updateData(Function2<? super Preferences, ? super Continuation<? super Preferences>, ? extends Object> transform, Continuation<? super Preferences> $completion) {
        return this.delegate.updateData(new PreferenceDataStore$updateData$2(transform, (Continuation<? super PreferenceDataStore$updateData$2>) null), $completion);
    }
}
