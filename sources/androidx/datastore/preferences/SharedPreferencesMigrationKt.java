...
public final class SharedPreferencesMigrationKt {
    ...
    public static final SharedPreferencesMigration<Preferences> SharedPreferencesMigration(Function0<? extends SharedPreferences> produceSharedPreferences, Set<String> keysToMigrate) {
        ...
        return new SharedPreferencesMigration<>((Function0) produceSharedPreferences, (Set) null, (Function2) getShouldRunMigration(keysToMigrate), (Function3) getMigrationFunction(), 2, (DefaultConstructorMarker) null);
    }
    ...
    public static final SharedPreferencesMigration<Preferences> SharedPreferencesMigration(Context context, String sharedPreferencesName, Set<String> keysToMigrate) {
        ...
        if (keysToMigrate == MIGRATE_ALL_KEYS) {
            ...
            String sharedPreferencesName2 = sharedPreferencesName;
            SharedPreferencesMigration<Preferences> sharedPreferencesMigration = new SharedPreferencesMigration<>(context2, sharedPreferencesName2, (Set) null, getShouldRunMigration(keysToMigrate), getMigrationFunction(), 4, (DefaultConstructorMarker) null);
            Set<String> set = keysToMigrate;
            String str = sharedPreferencesName2;
    ...
    private static final Function2<Preferences, Continuation<? super Boolean>, Object> getShouldRunMigration(Set<String> keysToMigrate) {
        return new SharedPreferencesMigrationKt$getShouldRunMigration$1(keysToMigrate, (Continuation<? super SharedPreferencesMigrationKt$getShouldRunMigration$1>) null);
    }
