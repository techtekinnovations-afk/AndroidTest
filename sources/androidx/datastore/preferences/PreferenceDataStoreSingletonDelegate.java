...
public final class PreferenceDataStoreSingletonDelegate implements ReadOnlyProperty<Context, DataStore<Preferences>> {
    ...
    public PreferenceDataStoreSingletonDelegate(String name2, ReplaceFileCorruptionHandler<Preferences> corruptionHandler2, Function1<? super Context, ? extends List<? extends DataMigration<Preferences>>> produceMigrations2, CoroutineScope scope2) {
