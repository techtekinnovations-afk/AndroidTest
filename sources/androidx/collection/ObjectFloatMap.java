...
public abstract class ObjectFloatMap<K> {
    ...
    public final void forEach(Function2<? super K, ? super Float, Unit> block) {
        int i;
        Function2<? super K, ? super Float, Unit> function2 = block;
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv < bitCount$iv) {
                        if ((255 & slot$iv) < 128) {
                            ...
                            i = i2;
                            function2.invoke(k2[index], Float.valueOf(v[index]));
                        } else {
                            i = i2;
                        }
                        slot$iv >>= i;
            ...
            if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    if ((slot$iv$iv2 & 255) < 128) {
                        ...
                        i = $i$f$all4;
                        $i$f$all2 = $i$f$all3;
                        if (!function2.invoke(k$iv[index$iv], Float.valueOf(v$iv[index$iv])).booleanValue()) {
                            return false;
                        }
                    } else {
                        $i$f$all2 = $i$f$all3;
    ...
    public final int count(Function2<? super K, ? super Float, Boolean> predicate) {
        ...
        ObjectFloatMap this_$iv2;
        int i;
        Function2<? super K, ? super Float, Boolean> function2 = predicate;
        Intrinsics.checkNotNullParameter(function2, "predicate");
        int $i$f$count = 0;
        int count = 0;
        ObjectFloatMap this_$iv3 = this;
        ...
        if (0 <= lastIndex$iv$iv) {
            ...
            ObjectFloatMap objectFloatMap = this_$iv3;
        }
        return count;
    }
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        if (obj == null) {
            ...
            return objectFloatMap.joinToString(charSequence, charSequence6, charSequence3, i3, charSequence5);
        }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated) {
        ...
        if (0 <= lastIndex$iv$iv) {
            ...
            sb = sb2;
            ObjectFloatMap objectFloatMap = this_$iv;
            int i8 = limit;
        }
        int i9 = index;
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap $this, CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2 transform, int i, Object obj) {
                    ...
                    if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                        ...
                        while (j$iv$iv < bitCount$iv$iv) {
                            if ((slot$iv$iv & 255) < 128) {
                                ...
                                $this$joinToString_u24lambda_u2410.append((CharSequence) function2.invoke(key2, Float.valueOf(value)));
                                index3++;
                            } else {
                                separator4 = separator2;
                                i2 = i5;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2<? super K, ? super Float, ? extends CharSequence> transform) {
        ...
        CharSequence charSequence3 = postfix;
        CharSequence charSequence4 = truncated;
        Function2<? super K, ? super Float, ? extends CharSequence> function2 = transform;
        Intrinsics.checkNotNullParameter(charSequence, "separator");
        Intrinsics.checkNotNullParameter(charSequence2, "prefix");
        Intrinsics.checkNotNullParameter(charSequence3, "postfix");
        Intrinsics.checkNotNullParameter(charSequence4, "truncated");
    ...
    public boolean equals(java.lang.Object r26) {
        /*
            ...
            return r1
        L_0x0008:
            boolean r3 = r0 instanceof androidx.collection.ObjectFloatMap
            r4 = 0
    ...
    public final int findKeyIndex(K r23) {
        ...
        L_0x009d:
            ...
            goto L_0x0021
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.ObjectFloatMap.findKeyIndex(java.lang.Object):int");
    }

    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, Function2<? super K, ? super Float, ? extends CharSequence> transform) {
        StringBuilder sb;
        int j$iv$iv$iv;
        int i;
        CharSequence charSequence = separator;
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv$iv$iv2 < bitCount$iv$iv$iv) {
                        if ((slot$iv$iv$iv & 255) < 128) {
                            ...
                            $this$joinToString_u24lambda_u2410$iv.append((CharSequence) function2.invoke(key$iv, Float.valueOf(value$iv)));
                            index$iv++;
                        } else {
                            i = i4;
                            j$iv$iv$iv = j$iv$iv$iv2;
