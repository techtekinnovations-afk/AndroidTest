...
public final class MutableFloatObjectMap<V> extends FloatObjectMap<V> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x009d, code lost:
        if (((((~r8) << 6) & r8) & -9187201950435737472L) == 0) goto L_0x00ab;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x00a0, code lost:
        if (((((~r8) << 6) & r8) & -9187201950435737472L) == 0) goto L_0x00ba;
     */
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv < bitCount$iv) {
                        if ((255 & slot$iv) < 128) {
                            ...
                            if (function2.invoke(Float.valueOf(this.keys[index]), this.values[index]).booleanValue()) {
                                removeValueAt(index);
                            }
                        } else {
                            $i$f$removeIf2 = $i$f$removeIf3;
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i < previousCapacity) {
            if (((previousMetadata2[i >> 3] >> ((i & 7) << 3)) & 255) < 128) {
                ...
                int index = mutableFloatObjectMap.findFirstAvailableSlot(hash >>> 7);
