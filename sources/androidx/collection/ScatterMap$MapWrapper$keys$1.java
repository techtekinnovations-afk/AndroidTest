...
public final class ScatterMap$MapWrapper$keys$1 implements Set<K>, KMappedMarker {
    ...
    ScatterMap$MapWrapper$keys$1(ScatterMap<K, V> $receiver) {
    ...
    public Iterator<K> iterator() {
        return SequencesKt.iterator(new ScatterMap$MapWrapper$keys$1$iterator$1(this.this$0, (Continuation<? super ScatterMap$MapWrapper$keys$1$iterator$1>) null));
    }
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        for (Object element$iv : $this$all$iv) {
            if (!scatterMap.containsKey(element$iv)) {
                return false;
            }
        }
        return true;
