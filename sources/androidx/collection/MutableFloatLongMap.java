...
public final class MutableFloatLongMap extends FloatLongMap {
        ...
        if (0 <= lastIndex$iv$iv) {
            while (true) {
                ...
                if (i$iv$iv != lastIndex$iv$iv) {
                    i$iv$iv++;
                    FloatLongMap floatLongMap = from;
                    this_$iv = this_$iv2;
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv < bitCount$iv) {
                        if ((255 & slot$iv) < 128) {
                            ...
                            if (function2.invoke(Float.valueOf(this.keys[index]), Long.valueOf(this.values[index])).booleanValue()) {
                                removeValueAt(index);
                            }
                        } else {
                            $i$f$removeIf2 = $i$f$removeIf3;
    ...
    public final void minusAssign(FloatSet keys) {
        ...
        if (0 <= lastIndex$iv$iv) {
            ...
            FloatSet floatSet2 = this_$iv3;
        }
    }

    public final void minusAssign(FloatList keys) {
        Intrinsics.checkNotNullParameter(keys, "keys");
        FloatList this_$iv = keys;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x00e4, code lost:
        if (((r0.metadata[r4 >> 3] >> ((r4 & 7) << 3)) & 255) != 128) goto L_0x00e8;
     */
    ...
    private final int findInsertIndex(float r24) {
        ...
        L_0x012b:
            ...
            goto L_0x001d
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.MutableFloatLongMap.findInsertIndex(float):int");
    }
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i < previousCapacity) {
            if (((previousMetadata2[i >> 3] >> ((i & 7) << 3)) & 255) < 128) {
                ...
                int index = mutableFloatLongMap.findFirstAvailableSlot(hash >>> 7);
