...
public final class ObjectFloatMapKt {
    ...
    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K key1, float value1) {
        MutableObjectFloatMap map = new MutableObjectFloatMap(0, 1, (DefaultConstructorMarker) null);
        map.set(key1, value1);
        return map;
    }

    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K key1, float value1, K key2, float value2) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, (DefaultConstructorMarker) null);
        MutableObjectFloatMap map = mutableObjectFloatMap;
        map.set(key1, value1);
        map.set(key2, value2);
        return mutableObjectFloatMap;
    }

    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K key1, float value1, K key2, float value2, K key3, float value3) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, (DefaultConstructorMarker) null);
        MutableObjectFloatMap map = mutableObjectFloatMap;
        map.set(key1, value1);
        map.set(key2, value2);
    ...
    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K key1, float value1, K key2, float value2, K key3, float value3, K key4, float value4) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, (DefaultConstructorMarker) null);
        MutableObjectFloatMap map = mutableObjectFloatMap;
        map.set(key1, value1);
        map.set(key2, value2);
    ...
    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K key1, float value1, K key2, float value2, K key3, float value3, K key4, float value4, K key5, float value5) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, (DefaultConstructorMarker) null);
        MutableObjectFloatMap map = mutableObjectFloatMap;
        map.set(key1, value1);
        map.set(key2, value2);
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf() {
        return new MutableObjectFloatMap<>(0, 1, (DefaultConstructorMarker) null);
    }

    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K key1, float value1) {
        MutableObjectFloatMap map = new MutableObjectFloatMap(0, 1, (DefaultConstructorMarker) null);
        map.set(key1, value1);
        return map;
    }

    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K key1, float value1, K key2, float value2) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, (DefaultConstructorMarker) null);
        MutableObjectFloatMap map = mutableObjectFloatMap;
        map.set(key1, value1);
        map.set(key2, value2);
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K key1, float value1, K key2, float value2, K key3, float value3) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, (DefaultConstructorMarker) null);
        MutableObjectFloatMap map = mutableObjectFloatMap;
        map.set(key1, value1);
        map.set(key2, value2);
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K key1, float value1, K key2, float value2, K key3, float value3, K key4, float value4) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, (DefaultConstructorMarker) null);
        MutableObjectFloatMap map = mutableObjectFloatMap;
        map.set(key1, value1);
        map.set(key2, value2);
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K key1, float value1, K key2, float value2, K key3, float value3, K key4, float value4, K key5, float value5) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, (DefaultConstructorMarker) null);
        MutableObjectFloatMap map = mutableObjectFloatMap;
        map.set(key1, value1);
        map.set(key2, value2);
