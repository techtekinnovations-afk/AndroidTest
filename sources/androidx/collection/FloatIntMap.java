...
public abstract class FloatIntMap {
    ...
    public final void forEach(Function2<? super Float, ? super Integer, Unit> block) {
        int i;
        Function2<? super Float, ? super Integer, Unit> function2 = block;
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv < bitCount$iv) {
                        if ((255 & slot$iv) < 128) {
                            ...
                            i = i2;
                            function2.invoke(Float.valueOf(k2[index]), Integer.valueOf(v[index]));
                        } else {
                            i = i2;
                        }
                        slot$iv >>= i;
    ...
    public final boolean all(Function2<? super Float, ? super Integer, Boolean> predicate) {
        ...
        int $i$f$all2;
        int i;
        Function2<? super Float, ? super Integer, Boolean> function2 = predicate;
            ...
            if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    if ((slot$iv$iv2 & 255) < 128) {
                        ...
                        i = $i$f$all4;
                        $i$f$all2 = $i$f$all3;
                        if (!function2.invoke(Float.valueOf(k$iv[index$iv]), Integer.valueOf(v$iv[index$iv])).booleanValue()) {
                            return false;
                        }
                    } else {
                        $i$f$all2 = $i$f$all3;
    ...
    public final int count(Function2<? super Float, ? super Integer, Boolean> predicate) {
        ...
        if (0 <= lastIndex$iv$iv) {
            ...
            FloatIntMap floatIntMap = this_$iv3;
        }
        return count;
    }
    ...
    public static /* synthetic */ String joinToString$default(FloatIntMap floatIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        if (obj == null) {
            ...
            return floatIntMap.joinToString(charSequence, charSequence6, charSequence3, i3, charSequence5);
        }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated) {
        ...
        if (0 <= lastIndex$iv$iv) {
            ...
            sb = sb2;
            FloatIntMap floatIntMap = this_$iv;
            int i8 = limit;
        }
        int i9 = index;
                    ...
                    if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                        ...
                        while (j$iv$iv < bitCount$iv$iv) {
                            if ((slot$iv$iv & 255) < 128) {
                                ...
                                $this$joinToString_u24lambda_u2410.append((CharSequence) function2.invoke(Float.valueOf(key), Integer.valueOf(value)));
                                index3++;
                            } else {
                                separator4 = separator2;
                                i2 = i5;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2<? super Float, ? super Integer, ? extends CharSequence> transform) {
        ...
        CharSequence charSequence3 = postfix;
        CharSequence charSequence4 = truncated;
        Function2<? super Float, ? super Integer, ? extends CharSequence> function2 = transform;
        Intrinsics.checkNotNullParameter(charSequence, "separator");
        Intrinsics.checkNotNullParameter(charSequence2, "prefix");
        Intrinsics.checkNotNullParameter(charSequence3, "postfix");
        Intrinsics.checkNotNullParameter(charSequence4, "truncated");
            ...
            while (true) {
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int j$iv$iv = 0; j$iv$iv < bitCount$iv$iv2; j$iv$iv++) {
                        if ((255 & slot$iv$iv) < 128) {
                            int index$iv = (i$iv$iv << 3) + j$iv$iv;
                            hash += Float.hashCode(k$iv[index$iv]) ^ Integer.hashCode(v$iv[index$iv]);
                        }
                        slot$iv$iv >>= 8;
                    }
    ...
    public boolean equals(Object other) {
        ...
        int i2;
        boolean z;
        FloatIntMap floatIntMap = other;
        boolean z2 = true;
        if (floatIntMap == this) {
            return true;
        }
        int i3 = false;
        if (!(floatIntMap instanceof FloatIntMap) || floatIntMap.getSize() != getSize()) {
            return false;
        }
        int $i$f$forEach = 0;
        float[] k$iv = this.keys;
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv$iv$iv < bitCount$iv$iv$iv) {
                        if ((slot$iv$iv$iv & 255) < 128) {
                            ...
                            $this$joinToString_u24lambda_u2410$iv.append((CharSequence) function2.invoke(Float.valueOf(key$iv), Integer.valueOf(value$iv)));
                            index$iv++;
                        } else {
                            truncated$iv2 = truncated$iv;
                            i = i4;
