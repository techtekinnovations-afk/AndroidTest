...
public abstract class IntObjectMap<V> {
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0092, code lost:
        if (((((~r7) << 6) & r7) & -9187201950435737472L) == 0) goto L_0x00a3;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0094, code lost:
        r7 = -1;
     */
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv < bitCount$iv) {
                        if ((255 & slot$iv) < 128) {
                            ...
                            i = i2;
                            function2.invoke(Integer.valueOf(k2[index]), v[index]);
                        } else {
                            i = i2;
                        }
                        slot$iv >>= i;
    ...
    public static /* synthetic */ String joinToString$default(IntObjectMap intObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        if (obj == null) {
            ...
            return intObjectMap.joinToString(charSequence, charSequence6, charSequence3, i3, charSequence5);
        }
    ...
    public boolean equals(Object other) {
        ...
        int i2;
        boolean z;
        IntObjectMap intObjectMap = other;
        boolean z2 = true;
        if (intObjectMap == this) {
            return true;
        }
        int i3 = false;
        if (!(intObjectMap instanceof IntObjectMap) || intObjectMap.getSize() != getSize()) {
            return false;
        }
        int $i$f$forEach = 0;
        int[] k$iv = this.keys;
