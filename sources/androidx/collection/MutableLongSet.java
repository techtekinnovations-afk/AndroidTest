...
public final class MutableLongSet extends LongSet {
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv$iv2 < bitCount$iv$iv) {
                        if ((255 & slot$iv$iv) < 128) {
                            ...
                            j$iv$iv = j$iv$iv2;
                            this_$iv2 = this_$iv3;
                            plusAssign(k$iv[(i$iv$iv << 3) + j$iv$iv2]);
                        } else {
                            this_$iv2 = this_$iv3;
                            i = i2;
                            j$iv$iv = j$iv$iv2;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0093, code lost:
        if (((((~r8) << 6) & r8) & -9187201950435737472L) == 0) goto L_0x009e;
     */
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv$iv2 < bitCount$iv$iv) {
                        if ((255 & slot$iv$iv) < 128) {
                            ...
                            j$iv$iv = j$iv$iv2;
                            this_$iv2 = this_$iv3;
                            minusAssign(k$iv[(i$iv$iv << 3) + j$iv$iv2]);
                        } else {
                            this_$iv2 = this_$iv3;
                            i = i2;
                            j$iv$iv = j$iv$iv2;
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i < previousCapacity) {
            if (((previousMetadata2[i >> 3] >> ((i & 7) << 3)) & 255) < 128) {
                ...
                int index = mutableLongSet.findFirstAvailableSlot(hash >>> 7);
