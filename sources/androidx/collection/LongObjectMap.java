...
public abstract class LongObjectMap<V> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x008e, code lost:
        if (((((~r7) << 6) & r7) & -9187201950435737472L) == 0) goto L_0x00a0;
     */
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x008e, code lost:
        if (((((~r7) << 6) & r7) & -9187201950435737472L) == 0) goto L_0x009f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0090, code lost:
        r7 = -1;
     */
    ...
    public final void forEach(Function2<? super Long, ? super V, Unit> block) {
        int i;
        Function2<? super Long, ? super V, Unit> function2 = block;
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv < bitCount$iv) {
                        if ((255 & slot$iv) < 128) {
                            ...
                            i = i2;
                            function2.invoke(Long.valueOf(k2[index]), v[index]);
                        } else {
                            i = i2;
                        }
                        slot$iv >>= i;
    ...
    public final boolean all(Function2<? super Long, ? super V, Boolean> predicate) {
        ...
        int $i$f$all2;
        int i;
        Function2<? super Long, ? super V, Boolean> function2 = predicate;
            ...
            if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    if ((slot$iv$iv2 & 255) < 128) {
                        ...
                        i = $i$f$all4;
                        $i$f$all2 = $i$f$all3;
                        if (!function2.invoke(Long.valueOf(k$iv[index$iv]), v$iv[index$iv]).booleanValue()) {
                            return false;
                        }
                    } else {
                        $i$f$all2 = $i$f$all3;
    ...
    public final int count(Function2<? super Long, ? super V, Boolean> predicate) {
        ...
        if (0 <= lastIndex$iv$iv) {
            ...
            LongObjectMap longObjectMap = this_$iv3;
        }
        return count;
    }
    ...
    public static /* synthetic */ String joinToString$default(LongObjectMap longObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        if (obj == null) {
            ...
            return longObjectMap.joinToString(charSequence, charSequence6, charSequence3, i3, charSequence5);
        }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated) {
        ...
        sb = sb2;
        LongObjectMap longObjectMap = this_$iv;
        int i5 = index;
                    ...
                    if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                        ...
                        while (j$iv$iv < bitCount$iv$iv) {
                            if ((slot$iv$iv & 255) < 128) {
                                ...
                                $this$joinToString_u24lambda_u2410.append((CharSequence) function2.invoke(Long.valueOf(key), value));
                                index3++;
                            } else {
                                separator4 = separator2;
                                i2 = i5;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2<? super Long, ? super V, ? extends CharSequence> transform) {
        ...
        CharSequence charSequence3 = postfix;
        CharSequence charSequence4 = truncated;
        Function2<? super Long, ? super V, ? extends CharSequence> function2 = transform;
        Intrinsics.checkNotNullParameter(charSequence, "separator");
        Intrinsics.checkNotNullParameter(charSequence2, "prefix");
        Intrinsics.checkNotNullParameter(charSequence3, "postfix");
        Intrinsics.checkNotNullParameter(charSequence4, "truncated");
    ...
    public boolean equals(Object other) {
        ...
        int i2;
        LongObjectMap this_$iv2;
        LongObjectMap longObjectMap = other;
        boolean z2 = true;
        if (longObjectMap == this) {
            return true;
        }
        int i3 = false;
        if (!(longObjectMap instanceof LongObjectMap) || longObjectMap.getSize() != getSize()) {
            return false;
        }
        LongObjectMap this_$iv3 = this;
        int $i$f$forEach = 0;
        ...
        LongObjectMap longObjectMap2 = this_$iv3;
        return true;
    }
    ...
    public String toString() {
        ...
        int i;
        int $i$f$forEach2;
        LongObjectMap longObjectMap = this;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x008e, code lost:
        if (((((~r7) << 6) & r7) & -9187201950435737472L) == 0) goto L_0x0093;
     */
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv$iv$iv2 < bitCount$iv$iv$iv) {
                        if ((slot$iv$iv$iv & 255) < 128) {
                            ...
                            $this$joinToString_u24lambda_u2410$iv.append((CharSequence) function2.invoke(Long.valueOf(key$iv), value$iv));
                            index$iv++;
                        } else {
                            i = i4;
                            j$iv$iv$iv = j$iv$iv$iv2;
