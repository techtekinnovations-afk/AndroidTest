...
public final class IntIntMapKt {
    ...
    public static final IntIntMap intIntMapOf(int key1, int value1) {
        MutableIntIntMap map = new MutableIntIntMap(0, 1, (DefaultConstructorMarker) null);
        map.set(key1, value1);
        return map;
    }

    public static final IntIntMap intIntMapOf(int key1, int value1, int key2, int value2) {
        MutableIntIntMap mutableIntIntMap = new MutableIntIntMap(0, 1, (DefaultConstructorMarker) null);
        MutableIntIntMap map = mutableIntIntMap;
        map.set(key1, value1);
        map.set(key2, value2);
    ...
    public static final MutableIntIntMap mutableIntIntMapOf() {
        return new MutableIntIntMap(0, 1, (DefaultConstructorMarker) null);
    }
