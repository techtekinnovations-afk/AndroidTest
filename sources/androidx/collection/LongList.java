...
public abstract class LongList {
    ...
    public final boolean any(Function1<? super Long, Boolean> predicate) {
        ...
        long[] content$iv = this.content;
        int i = this._size;
        for (int i$iv = 0; i$iv < i; i$iv++) {
            if (predicate.invoke(Long.valueOf(content$iv[i$iv])).booleanValue()) {
                return true;
            }
        }
        return false;
    ...
    public final <R> R fold(R initial, Function2<? super R, ? super Long, ? extends R> operation) {
        ...
        int i = this._size;
        for (int i$iv = 0; i$iv < i; i$iv++) {
            acc = operation.invoke(acc, Long.valueOf(content$iv[i$iv]));
        }
        return acc;
    }
    ...
    public final <R> R foldIndexed(R initial, Function3<? super Integer, ? super R, ? super Long, ? extends R> operation) {
        ...
        int i = this._size;
        for (int i$iv = 0; i$iv < i; i$iv++) {
            acc = operation.invoke(Integer.valueOf(i$iv), acc, Long.valueOf(content$iv[i$iv]));
        }
        return acc;
    }
    ...
    public final <R> R foldRight(R initial, Function2<? super Long, ? super R, ? extends R> operation) {
        ...
        while (true) {
            ...
            acc = operation.invoke(Long.valueOf(content$iv[i$iv]), acc);
        }
    }
    ...
    public final <R> R foldRightIndexed(R initial, Function3<? super Integer, ? super Long, ? super R, ? extends R> operation) {
        ...
        while (true) {
            ...
            acc = operation.invoke(Integer.valueOf(i$iv), Long.valueOf(content$iv[i$iv]), acc);
        }
    }
    ...
    public final void forEach(Function1<? super Long, Unit> block) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            block.invoke(Long.valueOf(content2[i2]));
        }
    }
    ...
    public final void forEachIndexed(Function2<? super Integer, ? super Long, Unit> block) {
        ...
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            block.invoke(Integer.valueOf(i2), Long.valueOf(content2[i2]));
        }
    }
    ...
    public final void forEachReversed(Function1<? super Long, Unit> block) {
        ...
        while (true) {
            i--;
            if (-1 < i) {
                block.invoke(Long.valueOf(content2[i]));
            } else {
                return;
            }
        }
    ...
    public final void forEachReversedIndexed(Function2<? super Integer, ? super Long, Unit> block) {
        ...
        while (true) {
            i--;
            if (-1 < i) {
                block.invoke(Integer.valueOf(i), Long.valueOf(content2[i]));
            } else {
                return;
            }
        }
    ...
    public static /* synthetic */ String joinToString$default(LongList longList, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        if (obj == null) {
            ...
            return longList.joinToString(charSequence, charSequence6, charSequence3, i3, charSequence5);
        }
    ...
    public static /* synthetic */ String joinToString$default(LongList $this, CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function1 transform, int i, Object obj) {
        ...
        if (obj == null) {
            ...
            while (true) {
                ...
                $this$joinToString_u24lambda_u2432.append((CharSequence) function1.invoke(Long.valueOf(element)));
                i$iv++;
    ...
    public int hashCode() {
        ...
        int i = this._size;
        for (int i$iv = 0; i$iv < i; i$iv++) {
            hashCode += Long.hashCode(content$iv[i$iv]) * 31;
        }
        return hashCode;
    }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, Function1<? super Long, ? extends CharSequence> transform) {
        ...
        long[] content$iv$iv = this.content;
        int i$iv$iv = 0;
        int i = this._size;
        while (true) {
            if (i$iv$iv >= i) {
            ...
            long element$iv = content$iv$iv[i$iv$iv];
            ...
            $this$joinToString_u24lambda_u2432$iv.append((CharSequence) function1.invoke(Long.valueOf(element$iv)));
            i$iv$iv++;
            charSequence = separator;
    ...
    public final java.lang.String joinToString(java.lang.CharSequence r22, kotlin.jvm.functions.Function1<? super java.lang.Long, ? extends java.lang.CharSequence> r23) {
        ...
        L_0x0069:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.LongList.joinToString(java.lang.CharSequence, kotlin.jvm.functions.Function1):java.lang.String");
    }
    ...
    public final java.lang.String joinToString(kotlin.jvm.functions.Function1<? super java.lang.Long, ? extends java.lang.CharSequence> r22) {
        ...
        L_0x0067:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.LongList.joinToString(kotlin.jvm.functions.Function1):java.lang.String");
    }
}
