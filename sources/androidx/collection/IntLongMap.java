...
public abstract class IntLongMap {
    ...
    public final void forEach(Function2<? super Integer, ? super Long, Unit> block) {
        int i;
        Function2<? super Integer, ? super Long, Unit> function2 = block;
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv < bitCount$iv) {
                        if ((255 & slot$iv) < 128) {
                            ...
                            i = i2;
                            function2.invoke(Integer.valueOf(k2[index]), Long.valueOf(v[index]));
                        } else {
                            i = i2;
                        }
                        slot$iv >>= i;
            ...
            if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    if ((slot$iv$iv2 & 255) < 128) {
                        ...
                        i = $i$f$all4;
                        $i$f$all2 = $i$f$all3;
                        if (!function2.invoke(Integer.valueOf(k$iv[index$iv]), Long.valueOf(v$iv[index$iv])).booleanValue()) {
                            return false;
                        }
                    } else {
                        $i$f$all2 = $i$f$all3;
    ...
    public final int count(Function2<? super Integer, ? super Long, Boolean> predicate) {
        ...
        if (0 <= lastIndex$iv$iv) {
            ...
            IntLongMap intLongMap = this_$iv3;
        }
        return count;
    }
    ...
    public static /* synthetic */ String joinToString$default(IntLongMap intLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        ...
        if (obj == null) {
            ...
            return intLongMap.joinToString(charSequence, charSequence6, charSequence3, i3, charSequence5);
        }
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated) {
        ...
        if (0 <= lastIndex$iv$iv) {
            ...
            sb = sb2;
            IntLongMap intLongMap = this_$iv;
            int[] iArr = k$iv3;
            int i9 = limit;
        }
        int i10 = index;
                    ...
                    if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                        ...
                        while (j$iv$iv < bitCount$iv$iv) {
                            if ((slot$iv$iv & 255) < 128) {
                                ...
                                $this$joinToString_u24lambda_u2410.append((CharSequence) function2.invoke(Integer.valueOf(key), Long.valueOf(value)));
                                index3++;
                            } else {
                                separator4 = separator2;
                                i2 = i5;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2<? super Integer, ? super Long, ? extends CharSequence> transform) {
        ...
        CharSequence charSequence3 = postfix;
        CharSequence charSequence4 = truncated;
        Function2<? super Integer, ? super Long, ? extends CharSequence> function2 = transform;
        Intrinsics.checkNotNullParameter(charSequence, "separator");
        Intrinsics.checkNotNullParameter(charSequence2, "prefix");
        Intrinsics.checkNotNullParameter(charSequence3, "postfix");
        Intrinsics.checkNotNullParameter(charSequence4, "truncated");
            ...
            while (true) {
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int j$iv$iv = 0; j$iv$iv < bitCount$iv$iv2; j$iv$iv++) {
                        if ((255 & slot$iv$iv) < 128) {
                            int index$iv = (i$iv$iv << 3) + j$iv$iv;
                            hash += Integer.hashCode(k$iv[index$iv]) ^ Long.hashCode(v$iv[index$iv]);
                        }
                        slot$iv$iv >>= 8;
                    }
    ...
    public boolean equals(java.lang.Object r28) {
        /*
            ...
            return r1
        L_0x0008:
            boolean r3 = r0 instanceof androidx.collection.IntLongMap
            r4 = 0
            if (r3 != 0) goto L_0x000e
            return r4
        L_0x000e:
            r3 = r0
            androidx.collection.IntLongMap r3 = (androidx.collection.IntLongMap) r3
            int r3 = r3.getSize()
            int r5 = r2.getSize()
        ...
        L_0x0064:
            ...
            r24 = r2
            r2 = r0
            androidx.collection.IntLongMap r2 = (androidx.collection.IntLongMap) r2
            long r25 = r2.get(r15)
                ...
                if ((((~$this$maskEmptyOrDeleted$iv$iv$iv$iv) << 7) & $this$maskEmptyOrDeleted$iv$iv$iv$iv & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (j$iv$iv$iv < bitCount$iv$iv$iv) {
                        if ((slot$iv$iv$iv & 255) < 128) {
                            ...
                            $this$joinToString_u24lambda_u2410$iv.append((CharSequence) function2.invoke(Integer.valueOf(key$iv), Long.valueOf(value$iv)));
                            index$iv++;
                        } else {
                            truncated$iv2 = truncated$iv;
                            i = i4;
