...
public final class MutableFloatSet extends FloatSet {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x00a0, code lost:
        if (((((~r8) << 6) & r8) & -9187201950435737472L) == 0) goto L_0x00af;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x009d, code lost:
        if (((((~r8) << 6) & r8) & -9187201950435737472L) == 0) goto L_0x00a8;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0099, code lost:
        if (((((~r7) << 6) & r7) & -9187201950435737472L) == 0) goto L_0x012a;
     */
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        long[] previousMetadata2 = mutableFloatSet.metadata;
        float[] previousElements = mutableFloatSet.elements;
        int previousCapacity = mutableFloatSet._capacity;
        initializeStorage(newCapacity);
        float[] newElements = mutableFloatSet.elements;
        int i = 0;
        while (i < previousCapacity) {
            if (((previousMetadata2[i >> 3] >> ((i & 7) << 3)) & 255) < 128) {
                ...
                int index = mutableFloatSet.findFirstAvailableSlot(hash >>> 7);
