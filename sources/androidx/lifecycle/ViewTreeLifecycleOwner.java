...
public final class ViewTreeLifecycleOwner {
    ...
    public static final LifecycleOwner get(View $this$findViewTreeLifecycleOwner) {
        ...
        return (LifecycleOwner) SequencesKt.firstOrNull(SequencesKt.mapNotNull(SequencesKt.generateSequence($this$findViewTreeLifecycleOwner, ViewTreeLifecycleOwner$findViewTreeLifecycleOwner$1.INSTANCE), ViewTreeLifecycleOwner$findViewTreeLifecycleOwner$2.INSTANCE));
    }
}
