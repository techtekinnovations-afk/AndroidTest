...
public final class Transformations$switchMap$2 implements Observer<X> {
    ...
    Transformations$switchMap$2(Function<X, LiveData<Y>> $switchMapFunction2, MediatorLiveData<Y> $result2) {
    ...
    public void onChanged(X value) {
        LiveData newLiveData = this.$switchMapFunction.apply(value);
        if (this.liveData != newLiveData) {
            ...
            if (this.liveData != null) {
                ...
                mediatorLiveData2.addSource(liveData3, new Transformations$sam$androidx_lifecycle_Observer$0(new Transformations$switchMap$2$onChanged$1(this.$result)));
            }
        }
    }
}
