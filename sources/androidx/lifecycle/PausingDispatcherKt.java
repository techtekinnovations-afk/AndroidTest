...
public final class PausingDispatcherKt {
    ...
    public static final <T> Object whenCreated(LifecycleOwner $this$whenCreated, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return whenCreated($this$whenCreated.getLifecycle(), block, $completion);
    }

    @Deprecated(message = "whenCreated has been deprecated because it runs the block on a pausing dispatcher that suspends, rather than cancels work when the lifecycle state goes below the given state. Use withCreated for non-suspending work that needs to run only once when the Lifecycle changes.")
    public static final <T> Object whenCreated(Lifecycle $this$whenCreated, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
    ...
    public static final <T> Object whenStarted(LifecycleOwner $this$whenStarted, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return whenStarted($this$whenStarted.getLifecycle(), block, $completion);
    }

    @Deprecated(message = "whenStarted has been deprecated because it runs the block on a pausing dispatcher that suspends, rather than cancels work when the lifecycle state goes below the given state. Use withStarted for non-suspending work that needs to run only once when the Lifecycle changes.")
    public static final <T> Object whenStarted(Lifecycle $this$whenStarted, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
    ...
    public static final <T> Object whenResumed(LifecycleOwner $this$whenResumed, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return whenResumed($this$whenResumed.getLifecycle(), block, $completion);
    }

    @Deprecated(message = "whenResumed has been deprecated because it runs the block on a pausing dispatcher that suspends, rather than cancels work when the lifecycle state goes below the given state. Use withResumed for non-suspending work that needs to run only once when the Lifecycle changes.")
    public static final <T> Object whenResumed(Lifecycle $this$whenResumed, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
    ...
    public static final <T> Object whenStateAtLeast(Lifecycle $this$whenStateAtLeast, Lifecycle.State minState, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new PausingDispatcherKt$whenStateAtLeast$2($this$whenStateAtLeast, minState, block, (Continuation<? super PausingDispatcherKt$whenStateAtLeast$2>) null), $completion);
    }
}
