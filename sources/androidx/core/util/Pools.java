...
public final class Pools {
    ...
    public static class SimplePool<T> implements Pool<T> {
        ...
        public T acquire() {
            ...
            int lastPooledIndex = this.poolSize - 1;
            Object instance = this.pool[lastPooledIndex];
            Intrinsics.checkNotNull(instance, "null cannot be cast to non-null type T of androidx.core.util.Pools.SimplePool");
        ...
        public boolean release(T instance) {
            ...
            } else if (this.poolSize >= this.pool.length) {
                return false;
            } else {
