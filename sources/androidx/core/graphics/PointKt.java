...
public final class PointKt {
    ...
    public static final Point times(Point $this$times, float scalar) {
        return new Point(Math.round(((float) $this$times.x) * scalar), Math.round(((float) $this$times.y) * scalar));
    }
    ...
    public static final Point div(Point $this$div, float scalar) {
        return new Point(Math.round(((float) $this$div.x) / scalar), Math.round(((float) $this$div.y) / scalar));
    }
