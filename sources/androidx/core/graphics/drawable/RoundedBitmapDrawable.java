    ...
    public void updateDstRect() {
        ...
        if (this.mApplyGravity) {
            if (this.mIsCircular) {
                ...
                roundedBitmapDrawable.gravityCompatApply(this.mGravity, minDimen, minDimen, getBounds(), this.mDstRect);
                int minDrawDimen = Math.min(roundedBitmapDrawable.mDstRect.width(), roundedBitmapDrawable.mDstRect.height());
                roundedBitmapDrawable.mDstRect.inset(Math.max(0, (roundedBitmapDrawable.mDstRect.width() - minDrawDimen) / 2), Math.max(0, (roundedBitmapDrawable.mDstRect.height() - minDrawDimen) / 2));
                roundedBitmapDrawable.mCornerRadius = ((float) minDrawDimen) * 0.5f;
            } else {
                roundedBitmapDrawable = this;
