...
public final class ColorUtils {
    ...
    public static void RGBToXYZ(int r, int g, int b, double[] outXyz) {
        ...
        if (dArr.length == 3) {
            ...
            double sg2 = ((double) g) / d;
            if (sg2 < 0.04045d) {
                sg = sg2 / 12.92d;
                d2 = 0.04045d;
            } else {
                d2 = 0.04045d;
                sg = Math.pow((sg2 + 0.055d) / 1.055d, 2.4d);
            }
            double sb = ((double) b) / d;
            double sb2 = sb < d2 ? sb / 12.92d : Math.pow((0.055d + sb) / 1.055d, 2.4d);
            dArr[0] = ((0.4124d * sr) + (0.3576d * sg) + (0.1805d * sb2)) * XYZ_WHITE_REFERENCE_Y;
            dArr[1] = ((0.2126d * sr) + (0.7152d * sg) + (0.0722d * sb2)) * XYZ_WHITE_REFERENCE_Y;
            dArr[2] = ((0.0193d * sr) + (0.1192d * sg) + (0.9505d * sb2)) * XYZ_WHITE_REFERENCE_Y;
            return;
        }
        int i = r;
        int i2 = g;
