...
public final class RegionKt {
    ...
    public static final Region not(Region $this$not) {
        ...
        Region $this$unaryMinus_u24lambda_u244$iv = new Region($this$unaryMinus$iv.getBounds());
        $this$unaryMinus_u24lambda_u244$iv.op($this$unaryMinus$iv, Region.Op.DIFFERENCE);
