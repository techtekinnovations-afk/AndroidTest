...
public class ViewCompat {
    ...
    public static boolean dispatchNestedScroll(View view, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int[] offsetInWindow, int type) {
        if (view instanceof NestedScrollingChild2) {
            int dxConsumed2 = dxConsumed;
            int dyConsumed2 = dyConsumed;
            int dxUnconsumed2 = dxUnconsumed;
            int dyUnconsumed2 = dyUnconsumed;
            int[] offsetInWindow2 = offsetInWindow;
            boolean dispatchNestedScroll = ((NestedScrollingChild2) view).dispatchNestedScroll(dxConsumed2, dyConsumed2, dxUnconsumed2, dyUnconsumed2, offsetInWindow2, type);
            int i = dxConsumed2;
            int dxConsumed3 = dyConsumed2;
            int dyConsumed3 = dxUnconsumed2;
            int dxUnconsumed3 = dyUnconsumed2;
            int[] iArr = offsetInWindow2;
            return dispatchNestedScroll;
        }
        int dxConsumed4 = dxConsumed;
        int dyConsumed4 = dyConsumed;
        int dxUnconsumed4 = dxUnconsumed;
        int dyUnconsumed3 = dyUnconsumed;
        int[] offsetInWindow3 = offsetInWindow;
        if (type == 0) {
            return dispatchNestedScroll(view, dxConsumed4, dyConsumed4, dxUnconsumed4, dyUnconsumed3, offsetInWindow3);
        }
        return false;
    }
    ...
    public static boolean dispatchNestedPreScroll(View view, int dx, int dy, int[] consumed, int[] offsetInWindow, int type) {
        ...
        int[] offsetInWindow2 = offsetInWindow;
        if (type == 0) {
            return dispatchNestedPreScroll(view, dx2, dy2, consumed2, offsetInWindow2);
        }
        return false;
    }
