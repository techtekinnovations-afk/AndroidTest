...
public final class DisplayCutoutCompat {
    ...
    private static DisplayCutout constructDisplayCutout(Insets safeInsets, Rect boundLeft, Rect boundTop, Rect boundRight, Rect boundBottom, Insets waterfallInsets) {
        ...
        Rect boundTop2 = boundTop;
        Rect boundRight2 = boundRight;
        Rect boundBottom2 = boundBottom;
        if (Build.VERSION.SDK_INT >= 29) {
            return Api29Impl.createDisplayCutout(safeInsets.toPlatformInsets(), boundLeft2, boundTop2, boundRight2, boundBottom2);
        }
        ...
        if (boundLeft2 != null) {
            boundingRects.add(boundLeft2);
        }
        if (boundTop2 != null) {
            boundingRects.add(boundTop2);
        }
        if (boundRight2 != null) {
            boundingRects.add(boundRight2);
        }
        if (boundBottom2 != null) {
            boundingRects.add(boundBottom2);
        }
