...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_PAGE_RIGHT = new AccessibilityActionCompat(accessibilityAction, 16908361, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
            ...
            if (Build.VERSION.SDK_INT >= 34) {
                accessibilityAction8 = Api34Impl.getActionScrollInDirection();
            }
            ACTION_SCROLL_IN_DIRECTION = new AccessibilityActionCompat(accessibilityAction8, 16908382, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
        }
        ...
        public boolean perform(View view, Bundle arguments) {
            ...
            if (this.mViewCommandArgumentClass != null) {
                try {
                    viewCommandArgument = (AccessibilityViewCommand.CommandArguments) this.mViewCommandArgumentClass.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
                    viewCommandArgument.setBundle(arguments);
                } catch (Exception e) {
                    Log.e(TAG, "Failed to execute command with argument class ViewCommandArgument: " + (this.mViewCommandArgumentClass == null ? "null" : this.mViewCommandArgumentClass.getName()), e);
                }
            }
    ...
    public List<AccessibilityActionCompat> getActionList() {
        ...
        for (int i = 0; i < actionCount; i++) {
            result.add(new AccessibilityActionCompat(actionList.get(i)));
        }
        return result;
    }
