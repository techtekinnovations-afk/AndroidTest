...
public final class ViewKt {
    ...
    public static final OneShotPreDrawListener doOnPreDraw(View $this$doOnPreDraw, Function1<? super View, Unit> action) {
        return OneShotPreDrawListener.add($this$doOnPreDraw, new ViewKt$doOnPreDraw$1(action, $this$doOnPreDraw));
    }
    ...
    public static final Bitmap drawToBitmap(View $this$drawToBitmap, Bitmap.Config config) {
        if ($this$drawToBitmap.isLaidOut()) {
            ...
            Canvas $this$drawToBitmap_u24lambda_u242 = new Canvas($this$applyCanvas$iv);
            $this$drawToBitmap_u24lambda_u242.translate(-((float) $this$drawToBitmap.getScrollX()), -((float) $this$drawToBitmap.getScrollY()));
            $this$drawToBitmap.draw($this$drawToBitmap_u24lambda_u242);
