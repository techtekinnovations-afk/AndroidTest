...
public final class ViewConfigurationCompat {
    ...
    public static int getScaledMinimumFlingVelocity(Context context, ViewConfiguration config, int inputDeviceId, int axis, int source) {
        ...
        return getCompatFlingVelocityThreshold(res, preApi34MinimumFlingVelocityResId, new ViewConfigurationCompat$$ExternalSyntheticLambda1(config), Integer.MAX_VALUE);
    }
    ...
    public static int getScaledMaximumFlingVelocity(Context context, ViewConfiguration config, int inputDeviceId, int axis, int source) {
        ...
        Objects.requireNonNull(config);
        return getCompatFlingVelocityThreshold(res, preApi34MaximumFlingVelocityResId, new ViewConfigurationCompat$$ExternalSyntheticLambda0(config), Integer.MIN_VALUE);
    }
