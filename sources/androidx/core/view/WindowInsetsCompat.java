        ...
        public Insets getInsetsForType(int type, boolean ignoreVisibility) {
            ...
            switch (type) {
                ...
                case 8:
                    ...
                    if (this.mRootViewVisibleInsets == null || this.mRootViewVisibleInsets.equals(Insets.NONE) || this.mRootViewVisibleInsets.bottom <= rootStable2.bottom) {
                        return Insets.NONE;
                    }
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        private static WindowInsets createWindowInsetsInstance() {
            ...
            if (sConsumedField != null) {
                try {
                    WindowInsets consumed = (WindowInsets) sConsumedField.get((Object) null);
                    if (consumed != null) {
            ...
            if (sConstructor != null) {
                try {
                    return sConstructor.newInstance(new Object[]{new Rect()});
