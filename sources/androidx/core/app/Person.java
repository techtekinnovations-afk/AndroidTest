...
public class Person {
    ...
    public boolean equals(Object otherObject) {
        ...
        if (!Objects.equals(Objects.toString(getName()), Objects.toString(otherPerson.getName())) || !Objects.equals(getUri(), otherPerson.getUri()) || !Objects.equals(Boolean.valueOf(isBot()), Boolean.valueOf(otherPerson.isBot())) || !Objects.equals(Boolean.valueOf(isImportant()), Boolean.valueOf(otherPerson.isImportant()))) {
            return false;
        }
        return true;
    }
