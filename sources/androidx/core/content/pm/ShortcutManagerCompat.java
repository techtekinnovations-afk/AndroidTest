...
public class ShortcutManagerCompat {
    ...
    public static boolean pushDynamicShortcut(android.content.Context r7, androidx.core.content.pm.ShortcutInfoCompat r8) {
        ...
        L_0x00b1:
            androidx.core.content.pm.ShortcutInfoCompat[] r5 = new androidx.core.content.pm.ShortcutInfoCompat[r2]     // Catch:{ Exception -> 0x0106, all -> 0x00e1 }
    ...
    private static int getIconDimensionInternal(Context context, boolean isHorizontal) {
        ...
        int iconDimensionDp = Math.max(1, am == null || am.isLowRamDevice() ? 48 : DEFAULT_MAX_ICON_DIMENSION_DP);
