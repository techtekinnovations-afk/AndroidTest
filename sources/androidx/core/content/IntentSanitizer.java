...
public class IntentSanitizer {
    ...
    public Intent sanitize(Intent in, Consumer<String> penalty) {
        ...
        sanitizeClipData(in, intent, this.mAllowedClipData, this.mAllowClipDataText, this.mAllowedClipDataUri, consumer);
        ...
        if (this.mAllowSelector) {
            ...
            consumer.accept("Selector is not allowed: " + in.getSelector());
        }
    ...
    public static final class Builder {
        ...
        public Builder allowAction(String action) {
            ...
            allowAction((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda1(action));
            return this;
        }
        ...
        public Builder allowDataWithAuthority(String authority) {
            ...
            allowData(new IntentSanitizer$Builder$$ExternalSyntheticLambda3(authority));
            return this;
        }
        ...
        public Builder allowType(String type) {
            ...
            return allowType((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda1(type));
        }
        ...
        public Builder allowCategory(String category) {
            ...
            return allowCategory((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda1(category));
        }
        ...
        public Builder allowPackage(String packageName) {
            ...
            return allowPackage((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda1(packageName));
        }
        ...
        public Builder allowComponent(ComponentName component) {
            ...
            return allowComponent((Predicate<ComponentName>) new IntentSanitizer$Builder$$ExternalSyntheticLambda5(component));
        }
        ...
        public Builder allowComponentWithPackage(String packageName) {
            Preconditions.checkNotNull(packageName);
            return allowComponent((Predicate<ComponentName>) new IntentSanitizer$Builder$$ExternalSyntheticLambda2(packageName));
        }
        ...
        public Builder allowClipDataUriWithAuthority(String authority) {
            Preconditions.checkNotNull(authority);
            return allowClipDataUri(new IntentSanitizer$Builder$$ExternalSyntheticLambda7(authority));
        }
        ...
        public Builder allowExtra(String key, Class<?> clazz) {
            return allowExtra(key, clazz, new IntentSanitizer$Builder$$ExternalSyntheticLambda18());
        }
        ...
        public <T> Builder allowExtra(String key, Class<T> clazz, Predicate<T> valueFilter) {
            ...
            return allowExtra(key, (Predicate<Object>) new IntentSanitizer$Builder$$ExternalSyntheticLambda4(clazz, valueFilter));
        }
        ...
        public Builder allowExtra(String key, Predicate<Object> filter) {
            ...
            if (allowedExtra == null) {
                allowedExtra = new IntentSanitizer$Builder$$ExternalSyntheticLambda8();
            }
        ...
        public Builder allowExtraStreamUriWithAuthority(String uriAuthority) {
            ...
            allowExtra("android.intent.extra.STREAM", Uri.class, new IntentSanitizer$Builder$$ExternalSyntheticLambda9(uriAuthority));
            return this;
        }
        ...
        public Builder allowExtraOutput(String uriAuthority) {
            allowExtra("output", Uri.class, new IntentSanitizer$Builder$$ExternalSyntheticLambda0(uriAuthority));
            return this;
        }
    ...
    static void sanitizeClipData(Intent in, Intent out, Predicate<ClipData> mAllowedClipData2, boolean mAllowClipDataText2, Predicate<Uri> mAllowedClipDataUri2, Consumer<String> penalty) {
        ClipData clipData = in.getClipData();
        if (clipData != null) {
            ClipData newClipData = null;
            if (mAllowedClipData2 == null || !mAllowedClipData2.test(clipData)) {
