...
public final class LocalePreferences {
    ...
    public static String getHourCycle(boolean resolved) {
        return getHourCycle(Api24Impl.getDefaultLocale(), resolved);
    }
    ...
    public static String getCalendarType(boolean resolved) {
        return getCalendarType(Api24Impl.getDefaultLocale(), resolved);
    }
    ...
    public static String getTemperatureUnit(boolean resolved) {
        return getTemperatureUnit(Api24Impl.getDefaultLocale(), resolved);
    }
    ...
    public static String getFirstDayOfWeek(boolean resolved) {
        return getFirstDayOfWeek(Api24Impl.getDefaultLocale(), resolved);
    }
    ...
    private static String getStringOfFirstDayOfWeek(int fw) {
        return (fw < 1 || fw > 7) ? "" : new String[]{FirstDayOfWeek.SUNDAY, FirstDayOfWeek.MONDAY, FirstDayOfWeek.TUESDAY, FirstDayOfWeek.WEDNESDAY, FirstDayOfWeek.THURSDAY, FirstDayOfWeek.FRIDAY, FirstDayOfWeek.SATURDAY}[fw - 1];
    }
    ...
    private static class Api33Impl {
        static String getResolvedTemperatureUnit(Locale locale) {
            String unit = NumberFormatter.with().usage("weather").unit(MeasureUnit.CELSIUS).locale(locale).format(1).getOutputUnit().getIdentifier();
