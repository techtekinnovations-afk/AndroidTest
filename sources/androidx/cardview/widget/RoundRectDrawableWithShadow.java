...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        if (drawHorizontalEdges) {
            canvas2 = canvas;
            canvas2.drawRect(0.0f, edgeShadowTop, this.mCardBounds.width() - (inset * 2.0f), -this.mCornerRadius, this.mEdgeShadowPaint);
        } else {
            canvas2 = canvas;
        }
        ...
        if (drawHorizontalEdges) {
            canvas2.drawRect(0.0f, edgeShadowTop, this.mCardBounds.width() - (inset * 2.0f), this.mShadowSize + (-this.mCornerRadius), this.mEdgeShadowPaint);
        }
        ...
        if (drawVerticalEdges) {
            canvas2.drawRect(0.0f, edgeShadowTop, this.mCardBounds.height() - (inset * 2.0f), -this.mCornerRadius, this.mEdgeShadowPaint);
        }
