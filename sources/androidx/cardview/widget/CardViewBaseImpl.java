    ...
    public void initStatic() {
        RoundRectDrawableWithShadow.sRoundRectHelper = new RoundRectDrawableWithShadow.RoundRectHelper() {
            public void drawRoundRect(Canvas canvas, RectF bounds, float cornerRadius, Paint paint) {
                ...
                float innerWidth = (rectF.width() - twoRadius) - 1.0f;
                float innerHeight = (rectF.height() - twoRadius) - 1.0f;
                if (cornerRadius >= 1.0f) {
                    ...
                    canvas2.drawRect((rectF.left + roundedCornerRadius) - 1.0f, rectF.top, (rectF.right - roundedCornerRadius) + 1.0f, rectF.top + roundedCornerRadius, paint2);
                    canvas.drawRect((rectF.left + roundedCornerRadius) - 1.0f, rectF.bottom - roundedCornerRadius, (rectF.right - roundedCornerRadius) + 1.0f, rectF.bottom, paint2);
                }
