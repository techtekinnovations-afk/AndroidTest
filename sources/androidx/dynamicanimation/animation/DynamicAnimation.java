...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    public boolean doAnimationFrame(long frameTime) {
        ...
        boolean finished = updateValueAndVelocity(durationScale == 0.0f ? 2147483647L : (long) (((float) deltaT) / durationScale));
    ...
    public FrameCallbackScheduler getScheduler() {
        if (this.mAnimationHandler != null) {
            return this.mAnimationHandler.getScheduler();
        }
        return AnimationHandler.getInstance().getScheduler();
    }

    public void setScheduler(FrameCallbackScheduler scheduler) {
        if (this.mAnimationHandler != null && this.mAnimationHandler.getScheduler() == scheduler) {
            return;
        }
        if (!this.mRunning) {
            this.mAnimationHandler = new AnimationHandler(scheduler);
            return;
        }
