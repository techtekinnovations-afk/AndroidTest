    ...
    public void submitList(List<T> newList, Runnable commitCallback) {
        ...
        if (newList != this.mList) {
            ...
            if (newList == null) {
                ...
                final List<T> newList2 = newList;
                final Runnable commitCallback2 = commitCallback;
                    ...
                    public void run() {
                        final DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                            ...
                            public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                                ...
                                T newItem = newList2.get(newItemPosition);
                        ...
                        AsyncListDiffer.this.mMainThreadExecutor.execute(new Runnable() {
                            public void run() {
                                if (AsyncListDiffer.this.mMaxScheduledGeneration == runGeneration) {
                                    AsyncListDiffer.this.latchList(newList2, result, commitCallback2);
                                }
                            }
                        });
                    }
