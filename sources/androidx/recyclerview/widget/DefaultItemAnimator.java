...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void animateMoveImpl(RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(getMoveDuration()).setListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
                DefaultItemAnimator.this.dispatchMoveStarting(holder2);
            }
            ...
            public void onAnimationEnd(Animator animator) {
                animation.setListener((Animator.AnimatorListener) null);
                DefaultItemAnimator.this.dispatchMoveFinished(holder2);
                DefaultItemAnimator.this.mMoveAnimations.remove(holder2);
                DefaultItemAnimator.this.dispatchFinishedWhenDone();
            }
        }).start();
    }
    ...
    public boolean animateChange(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder, int fromX, int fromY, int toX, int toY) {
        ...
        RecyclerView.ViewHolder oldHolder2 = oldHolder;
        int fromX2 = fromX;
        int fromY2 = fromY;
        int toX2 = toX;
        int toY2 = toY;
        float prevTranslationX = oldHolder2.itemView.getTranslationX();
        float prevTranslationY = oldHolder2.itemView.getTranslationY();
        float prevAlpha = oldHolder2.itemView.getAlpha();
        resetAnimation(oldHolder2);
        int deltaX = (int) (((float) (toX2 - fromX2)) - prevTranslationX);
        int deltaY = (int) (((float) (toY2 - fromY2)) - prevTranslationY);
        oldHolder2.itemView.setTranslationX(prevTranslationX);
        oldHolder2.itemView.setTranslationY(prevTranslationY);
        oldHolder2.itemView.setAlpha(prevAlpha);
        if (newHolder != null) {
        ...
        int toX3 = toX2;
        int toX4 = fromX2;
        RecyclerView.ViewHolder oldHolder3 = oldHolder2;
        int toY3 = toY2;
        ChangeInfo changeInfo = new ChangeInfo(oldHolder3, newHolder, toX4, fromY2, toX3, toY3);
        RecyclerView.ViewHolder viewHolder = oldHolder3;
        int i = toX4;
        int fromX3 = toX3;
