...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        staggeredGridLayoutManager.updateAllRemainingSpans(layoutState2.mLayoutDirection, targetLine);
        if (staggeredGridLayoutManager.mShouldReverseLayout) {
            i = staggeredGridLayoutManager.mPrimaryOrientation.getEndAfterPadding();
        } else {
            i = staggeredGridLayoutManager.mPrimaryOrientation.getStartAfterPadding();
        }
        int defaultNewViewLine = i;
        boolean added = false;
        while (true) {
            if (layoutState.hasMore(state)) {
                if (!staggeredGridLayoutManager.mLayoutState.mInfinite && staggeredGridLayoutManager.mRemainingSpans.isEmpty()) {
                    i2 = r8;
                    break;
                }
                ...
                int spanIndex = staggeredGridLayoutManager.mLazySpanLookup.getSpan(position);
                boolean assignSpan = spanIndex == -1 ? z : r8;
                if (assignSpan) {
                    currentSpan = lp.mFullSpan ? staggeredGridLayoutManager.mSpans[r8] : staggeredGridLayoutManager.getNextSpan(layoutState2);
                    staggeredGridLayoutManager.mLazySpanLookup.setSpan(position, currentSpan);
                } else {
                    currentSpan = staggeredGridLayoutManager.mSpans[spanIndex];
                }
                lp.mSpan = currentSpan;
                if (layoutState2.mLayoutDirection == z) {
                    staggeredGridLayoutManager.addView(view);
                } else {
                    staggeredGridLayoutManager.addView(view, r8);
                }
                staggeredGridLayoutManager.measureChildWithDecorationsAndMargin(view, lp, r8);
                if (layoutState2.mLayoutDirection == z) {
                    if (lp.mFullSpan) {
                        start = staggeredGridLayoutManager.getMaxEnd(defaultNewViewLine);
                    } else {
                        start = currentSpan.getEndLine(defaultNewViewLine);
                    }
                    end = staggeredGridLayoutManager.mPrimaryOrientation.getDecoratedMeasurement(view) + start;
                    if (assignSpan && lp.mFullSpan) {
                        LazySpanLookup.FullSpanItem fullSpanItem = staggeredGridLayoutManager.createFullSpanItemFromEnd(start);
                        fullSpanItem.mGapDir = -1;
                        fullSpanItem.mPosition = position;
                        staggeredGridLayoutManager.mLazySpanLookup.addFullSpanItem(fullSpanItem);
                    }
                } else {
                    if (lp.mFullSpan) {
                        i4 = staggeredGridLayoutManager.getMinStart(defaultNewViewLine);
                    } else {
                        i4 = currentSpan.getStartLine(defaultNewViewLine);
                    }
                    end = i4;
                    start = end - staggeredGridLayoutManager.mPrimaryOrientation.getDecoratedMeasurement(view);
                    if (assignSpan && lp.mFullSpan) {
                        LazySpanLookup.FullSpanItem fullSpanItem2 = staggeredGridLayoutManager.createFullSpanItemFromStart(end);
                        fullSpanItem2.mGapDir = z;
                        fullSpanItem2.mPosition = position;
                        staggeredGridLayoutManager.mLazySpanLookup.addFullSpanItem(fullSpanItem2);
                    }
                }
                int start2 = start;
                int end2 = end;
                if (lp.mFullSpan != 0 && layoutState2.mItemDirection == -1) {
                    if (assignSpan) {
                        staggeredGridLayoutManager.mLaidOutInvalidFullSpan = z;
                    } else {
                        if (layoutState2.mLayoutDirection == z) {
                            hasInvalidGap = staggeredGridLayoutManager.areAllEndsEqual() ^ z;
                        } else {
                            hasInvalidGap = staggeredGridLayoutManager.areAllStartsEqual() ^ z;
                        }
                        if (hasInvalidGap) {
                            LazySpanLookup.FullSpanItem fullSpanItem3 = staggeredGridLayoutManager.mLazySpanLookup.getFullSpanItem(position);
                ...
                staggeredGridLayoutManager.attachViewToSpans(view, lp, layoutState2);
                if (!staggeredGridLayoutManager.isLayoutRTL() || staggeredGridLayoutManager.mOrientation != z) {
                    if (lp.mFullSpan != 0) {
                        i3 = staggeredGridLayoutManager.mSecondaryOrientation.getStartAfterPadding();
                    } else {
                        i3 = (currentSpan.mIndex * staggeredGridLayoutManager.mSizePerSpan) + staggeredGridLayoutManager.mSecondaryOrientation.getStartAfterPadding();
                    }
                    otherStart = i3;
                    otherEnd = staggeredGridLayoutManager.mSecondaryOrientation.getDecoratedMeasurement(view) + otherStart;
                } else {
                    if (lp.mFullSpan) {
                        otherEnd = staggeredGridLayoutManager.mSecondaryOrientation.getEndAfterPadding();
                    } else {
                        otherEnd = staggeredGridLayoutManager.mSecondaryOrientation.getEndAfterPadding() - (((staggeredGridLayoutManager.mSpanCount - (z ? 1 : 0)) - currentSpan.mIndex) * staggeredGridLayoutManager.mSizePerSpan);
                    }
                    otherStart = otherEnd - staggeredGridLayoutManager.mSecondaryOrientation.getDecoratedMeasurement(view);
                }
                int otherStart4 = otherStart;
                if (staggeredGridLayoutManager.mOrientation == 1) {
                    ...
                    int start3 = start2;
                    otherStart2 = otherStart4;
                    staggeredGridLayoutManager.layoutDecoratedWithMargins(view, otherStart2, start3, otherEnd2, end3);
                    ...
                    int otherEnd3 = i6;
                    currentSpan2 = currentSpan;
                    int otherStart5 = otherStart4;
                    int start4 = start2;
                    int i7 = end4;
                    int otherEnd4 = otherEnd3;
                    int end5 = i7;
                    staggeredGridLayoutManager = this;
                    staggeredGridLayoutManager.layoutDecoratedWithMargins(view, start4, otherStart5, end5, otherEnd4);
                    int i8 = otherStart5;
                    int otherStart6 = start4;
                    otherStart2 = i8;
                    int i9 = otherEnd4;
                    int otherEnd5 = end5;
                    int end6 = i9;
                ...
                if (lp.mFullSpan) {
                    staggeredGridLayoutManager.updateAllRemainingSpans(staggeredGridLayoutManager.mLayoutState.mLayoutDirection, targetLine);
                } else {
                    staggeredGridLayoutManager.updateRemainingSpans(currentSpan2, staggeredGridLayoutManager.mLayoutState.mLayoutDirection, targetLine);
                }
                staggeredGridLayoutManager.recycle(recycler2, staggeredGridLayoutManager.mLayoutState);
                if (!staggeredGridLayoutManager.mLayoutState.mStopInFocusable || !view.hasFocusable()) {
                    int i10 = otherStart2;
                    otherStart3 = 0;
                    ...
                    int i12 = otherStart2;
                    otherStart3 = 0;
                    staggeredGridLayoutManager.mRemainingSpans.set(currentSpan2.mIndex, false);
                }
                added = true;
                r8 = otherStart3;
                z = true;
        ...
        if (staggeredGridLayoutManager.mLayoutState.mLayoutDirection == -1) {
            diff = staggeredGridLayoutManager.mPrimaryOrientation.getStartAfterPadding() - staggeredGridLayoutManager.getMinStart(staggeredGridLayoutManager.mPrimaryOrientation.getStartAfterPadding());
        } else {
            diff = staggeredGridLayoutManager.getMaxEnd(staggeredGridLayoutManager.mPrimaryOrientation.getEndAfterPadding()) - staggeredGridLayoutManager.mPrimaryOrientation.getEndAfterPadding();
        }
