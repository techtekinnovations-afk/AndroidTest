...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RecyclerView, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.RecyclerView, attrs, a, i, 0);
        TypedArray a2 = a;
        ...
        this.mClipToPadding = a2.getBoolean(R.styleable.RecyclerView_android_clipToPadding, true);
        ...
        a2.recycle();
        int i2 = defStyleAttr;
        createLayoutManager(context, layoutManagerName, attrs, i2, 0);
        String str = layoutManagerName;
        int i3 = i2;
        TypedArray a3 = context.obtainStyledAttributes(attrs, NESTED_SCROLLING_ATTRS, i3, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, NESTED_SCROLLING_ATTRS, attrs, a3, i3, 0);
        boolean nestedScrollingEnabled = a3.getBoolean(0, true);
        a3.recycle();
    ...
    public void scrollBy(int x, int y) {
        if (this.mLayout == null) {
            ...
            if (canScrollHorizontal || canScrollVertical) {
                scrollByInternal(canScrollHorizontal ? x : 0, canScrollVertical ? y : 0, (MotionEvent) null, 0);
            }
        }
    }

    public void nestedScrollBy(int x, int y) {
        nestedScrollByInternal(x, y, (MotionEvent) null, 1);
    }
    ...
    private void nestedScrollByInternal(int x, int y, MotionEvent motionEvent, int type) {
        if (this.mLayout == null) {
            ...
            int type2 = type;
            if (dispatchNestedPreScroll(canScrollHorizontal ? x : 0, canScrollVertical ? y : 0, this.mReusableIntPair, this.mScrollOffset, type2) != 0) {
    ...
    public boolean scrollByInternal(int x, int y, MotionEvent ev, int type) {
        ...
        if (this.mAdapter != null) {
            ...
            int consumedX2 = this.mReusableIntPair[0];
            int consumedY2 = this.mReusableIntPair[1];
            int i3 = consumedX2;
            consumedX = i - consumedX2;
            unconsumedX = i3;
            int i4 = consumedY2;
            consumedY = i2 - consumedY2;
            unconsumedY = i4;
        } else {
            consumedX = 0;
            unconsumedX = 0;
        ...
        this.mReusableIntPair[0] = 0;
        this.mReusableIntPair[1] = 0;
        dispatchNestedScroll(unconsumedX, unconsumedY, consumedX, consumedY, this.mScrollOffset, type, this.mReusableIntPair);
        int unconsumedX2 = consumedX - this.mReusableIntPair[0];
        int unconsumedY2 = consumedY - this.mReusableIntPair[1];
        ...
        if (getOverScrollMode() != 2) {
            if (motionEvent != null && !MotionEventCompat.isFromSource(motionEvent, 8194)) {
                pullGlows(motionEvent.getX(), (float) unconsumedX2, motionEvent.getY(), (float) unconsumedY2);
            }
            considerReleasingGlowsOnScroll(x, y);
        }
        if (!(unconsumedX == 0 && unconsumedY == 0)) {
            dispatchOnScrolled(unconsumedX, unconsumedY);
        }
        if (!awakenScrollBars()) {
            invalidate();
        }
        if (!consumedNestedScroll && unconsumedX == 0 && unconsumedY == 0) {
            return false;
        }
        return true;
    }
                ...
                case 2:
                    ...
                    if (index >= 0) {
                        ...
                        if (this.mScrollState != i) {
                            ...
                            this.mLastTouchY = y3 - this.mScrollOffset[c];
                            if (scrollByInternal(canScrollHorizontally ? dx2 : 0, canScrollVertically ? dy2 : 0, motionEvent, 0)) {
                                getParent().requestDisallowInterceptTouchEvent(true);
                            }
    ...
    private void saveFocusInfo() {
        ...
        if (this.mDataSetHasChangedAfterLayout) {
            ...
            i = focusedVh.getAbsoluteAdapterPosition();
        }
    ...
    private void dispatchLayoutStep3() {
        ...
        recyclerView.mState.mPreviousLayoutItemCount = recyclerView.mState.mItemCount;
        recyclerView.mDataSetHasChangedAfterLayout = false;
        recyclerView.mDispatchItemsChangedEvent = false;
        recyclerView.mState.mRunSimpleAnimations = false;
        recyclerView.mState.mRunPredictiveAnimations = false;
        recyclerView.mLayout.mRequestedSimpleAnimations = false;
        if (recyclerView.mRecycler.mChangedScrap != null) {
            recyclerView.mRecycler.mChangedScrap.clear();
        }
        if (recyclerView.mLayout.mPrefetchMaxObservedInInitialPrefetch) {
            recyclerView.mLayout.mPrefetchMaxCountObserved = 0;
            recyclerView.mLayout.mPrefetchMaxObservedInInitialPrefetch = false;
        ...
        if (didChildRangeChange(recyclerView.mMinMaxLayoutPositions[0], recyclerView.mMinMaxLayoutPositions[1])) {
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                int unconsumedX2 = x - this.mLastFlingX;
                int unconsumedY2 = y - this.mLastFlingY;
                this.mLastFlingX = x;
                this.mLastFlingY = y;
                RecyclerView.this.mReusableIntPair[0] = 0;
                RecyclerView.this.mReusableIntPair[1] = 0;
                if (RecyclerView.this.dispatchNestedPreScroll(unconsumedX2, unconsumedY2, RecyclerView.this.mReusableIntPair, (int[]) null, 1)) {
                    unconsumedX2 -= RecyclerView.this.mReusableIntPair[0];
                    unconsumedY2 -= RecyclerView.this.mReusableIntPair[1];
                }
                if (RecyclerView.this.getOverScrollMode() != 2) {
                    RecyclerView.this.considerReleasingGlowsOnScroll(unconsumedX2, unconsumedY2);
                }
                if (RecyclerView.this.mAdapter != null) {
                    RecyclerView.this.mReusableIntPair[0] = 0;
                    RecyclerView.this.mReusableIntPair[1] = 0;
                    RecyclerView.this.scrollStep(unconsumedX2, unconsumedY2, RecyclerView.this.mReusableIntPair);
                    int consumedX2 = RecyclerView.this.mReusableIntPair[0];
                    int consumedY2 = RecyclerView.this.mReusableIntPair[1];
                    int unconsumedX3 = unconsumedX2 - consumedX2;
                    int unconsumedY3 = unconsumedY2 - consumedY2;
                    ...
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        ...
                        if (adapterSize == 0) {
                            ...
                            smoothScroller.onAnimation(consumedX2, consumedY2);
                        } else {
                            smoothScroller.onAnimation(consumedX2, consumedY2);
                        }
                    }
                ...
                RecyclerView.this.mReusableIntPair[0] = 0;
                RecyclerView.this.mReusableIntPair[1] = 0;
                RecyclerView.this.dispatchNestedScroll(consumedX, consumedY, unconsumedX, unconsumedY, (int[]) null, 1, RecyclerView.this.mReusableIntPair);
                int consumedY3 = consumedY;
                int unconsumedX4 = unconsumedX - RecyclerView.this.mReusableIntPair[0];
                int unconsumedY4 = unconsumedY - RecyclerView.this.mReusableIntPair[1];
                if (!(consumedX == 0 && consumedY3 == 0)) {
                    RecyclerView.this.dispatchOnScrolled(consumedX, consumedY3);
                }
                if (!RecyclerView.this.awakenScrollBars()) {
                    RecyclerView.this.invalidate();
                }
                boolean doneScrolling = scroller.isFinished() || (((scroller.getCurrX() == scroller.getFinalX()) || unconsumedX4 != 0) && ((scroller.getCurrY() == scroller.getFinalY()) || unconsumedY4 != 0));
                ...
                if ((smoothScroller2 != null && smoothScroller2.isPendingInitialRun()) || !doneScrolling) {
                    ...
                    if (RecyclerView.this.mGapWorker != null) {
                        RecyclerView.this.mGapWorker.postFromTraversal(RecyclerView.this, consumedX, consumedY3);
                    }
                } else {
                    if (RecyclerView.this.getOverScrollMode() != 2) {
                        int vel = (int) scroller.getCurrVelocity();
                        RecyclerView.this.absorbGlows(unconsumedX4 < 0 ? -vel : unconsumedX4 > 0 ? vel : 0, unconsumedY4 < 0 ? -vel : unconsumedY4 > 0 ? vel : 0);
                    }
        ...
        public void smoothScrollBy(int dx, int dy, int duration, Interpolator interpolator) {
            ...
            if (duration == Integer.MIN_VALUE) {
                duration2 = computeScrollDuration(dx, dy);
            } else {
                duration2 = duration;
            }
            ...
            this.mLastFlingX = 0;
            RecyclerView.this.setScrollState(2);
            this.mOverScroller.startScroll(0, 0, dx, dy, duration2);
            postOnAnimation();
        }
        ...
        private int computeScrollDuration(int dx, int dy) {
            ...
            return Math.min((int) (((((float) (horizontal ? absDx : absDy)) / ((float) (horizontal ? recyclerView.getWidth() : recyclerView.getHeight()))) + 1.0f) * 300.0f), RecyclerView.MAX_SCROLL_DURATION);
        }
    ...
    public final class Recycler {
        ...
        private boolean tryBindViewHolderByDeadline(ViewHolder holder, int offsetPosition, int position, long deadlineNs) {
            ...
            } else if (!this.mRecyclerPool.willBindInTime(viewType, startBindNs, deadlineNs)) {
                return false;
            }
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (holder2 == null) {
                ...
                if (RecyclerView.this.mAdapter.hasStableIds() && (holder2 = getScrapOrCachedViewForId(RecyclerView.this.mAdapter.getItemId(offsetPosition), type, z2)) != null) {
                    holder2.mPosition = offsetPosition;
                    fromScrapOrHiddenOrCache2 = true;
                }
                if (!(holder2 != null || this.mViewCacheExtension == null || (view = this.mViewCacheExtension.getViewForPositionAndType(this, i, type)) == null)) {
            ...
            if (!fromScrapOrHiddenOrCache || RecyclerView.this.mState.isPreLayout()) {
                z = false;
            } else if (holder.hasAnyOfTheFlags(8192)) {
                z = false;
            ...
            if (RecyclerView.this.mState.isPreLayout() && holder.isBound()) {
                ...
                bound = tryBindViewHolderByDeadline(holder, RecyclerView.this.mAdapterHelper.findPositionOffset(i), i, deadlineNs);
            }
            ViewGroup.LayoutParams lp = holder.itemView.getLayoutParams();
            if (lp == null) {
                rvLayoutParams = (LayoutParams) RecyclerView.this.generateDefaultLayoutParams();
    ...
    public static abstract class LayoutManager {
        ...
        private int[] getChildRectangleOnScreenScrollAmount(View child, Rect rect) {
            ...
            int childRight = rect2.width() + childLeft;
            ...
            int offScreenBottom = Math.max(0, (rect2.height() + childTop) - parentBottom);
            ...
            switch (action) {
                case 4096:
                    if (this.mRecyclerView.canScrollVertically(1)) {
                        vScroll2 = (getHeight() - getPaddingTop()) - getPaddingBottom();
                    }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        if (verticalThumbDrawable == null || verticalTrackDrawable == null || horizontalThumbDrawable == null || horizontalTrackDrawable == null) {
            Drawable drawable = verticalTrackDrawable;
            StateListDrawable stateListDrawable = horizontalThumbDrawable;
            Drawable drawable2 = horizontalTrackDrawable;
