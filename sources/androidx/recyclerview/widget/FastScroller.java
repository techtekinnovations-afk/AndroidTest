...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    private final Runnable mHideRunnable = new Runnable() {
        public void run() {
            FastScroller.this.hide(LogSeverity.ERROR_VALUE);
        }
    };
    ...
    public boolean isPointInsideVerticalThumb(float x, float y) {
        if (!isLayoutRTL() ? x >= ((float) (this.mRecyclerViewWidth - this.mVerticalThumbWidth)) : x <= ((float) this.mVerticalThumbWidth)) {
