...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult result) {
        ...
        while (itemSpanSize < this.mSpanCount && layoutState2.hasMore(state2) && remainingSpan > 0) {
            int pos = layoutState2.mCurrentPosition;
            int spanSize = getSpanSize(recycler2, state2, pos);
            if (spanSize <= this.mSpanCount) {
                remainingSpan -= spanSize;
                if (remainingSpan < 0 || (view2 = layoutState2.next(recycler2)) == null) {
                    break;
                }
                this.mSet[itemSpanSize] = view2;
                itemSpanSize++;
            } else {
        ...
        assignSpans(recycler2, state2, itemSpanSize, layingOutInPrimaryDirection);
        int i3 = 0;
        while (i3 < itemSpanSize) {
            ...
            calculateItemDecorationsForChild(view3, this.mDecorInsets);
            measureChild(view3, otherDirSpecMode2, z);
            int size = this.mOrientationHelper.getDecoratedMeasurement(view3);
            if (size > maxSize2) {
                maxSize2 = size;
            }
            int maxSize3 = maxSize2;
            float otherSize = (((float) this.mOrientationHelper.getDecoratedMeasurementInOther(view3)) * 1.0f) / ((float) ((LayoutParams) view3.getLayoutParams()).mSpanSize);
        ...
        if (flexibleInOtherDir) {
            ...
            int maxSize4 = 0;
            for (int i4 = 0; i4 < itemSpanSize; i4++) {
        ...
        int i8 = i5;
        float f = maxSizeInOther2;
        int i9 = otherDirSpecMode2;
        ...
        while (i10 < itemSpanSize) {
            View view6 = this.mSet[i10];
            LayoutParams params = (LayoutParams) view6.getLayoutParams();
            int left2 = left;
            if (this.mOrientation != 1) {
                top = getPaddingTop() + this.mCachedBorders[params.mSpanIndex];
                view = view6;
                bottom = top + this.mOrientationHelper.getDecoratedMeasurementInOther(view6);
                bottom2 = right2;
                right = left2;
            } else if (isLayoutRTL()) {
                int right3 = getPaddingLeft() + this.mCachedBorders[this.mSpanCount - params.mSpanIndex];
                int i11 = right3;
                right = right3 - this.mOrientationHelper.getDecoratedMeasurementInOther(view6);
                view = view6;
                bottom = bottom3;
                bottom2 = i11;
            } else {
                int left3 = getPaddingLeft() + this.mCachedBorders[params.mSpanIndex];
                int decoratedMeasurementInOther = left3 + this.mOrientationHelper.getDecoratedMeasurementInOther(view6);
                right = left3;
                view = view6;
                bottom = bottom3;
                bottom2 = decoratedMeasurementInOther;
            }
            layoutDecoratedWithMargins(view, right, top, bottom2, bottom);
    ...
    public View onFocusSearchFailed(View focused, int focusDirection, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        while (true) {
            if (i2 == limit) {
                int i3 = focusableWeakCandidateSpanIndex2;
                int i4 = focusableWeakCandidateOverlap2;
                int i5 = focusableSpanGroupIndex2;
                int i6 = i2;
                int i7 = start;
                break;
            }
            ...
            if (candidate == prevFocusedChild2) {
                ...
                int i8 = focusableWeakCandidateSpanIndex2;
                int i9 = focusableWeakCandidateOverlap2;
                int i10 = focusableSpanGroupIndex2;
                break;
            }
            if (!candidate.hasFocusable() || spanGroupIndex == focusableSpanGroupIndex2) {
                ...
                int i11 = focusableWeakCandidateSpanIndex2;
                int i12 = focusableWeakCandidateOverlap2;
                int i13 = focusableSpanGroupIndex2;
                break;
            } else {
                prevFocusedChild = prevFocusedChild2;
                focusableWeakCandidateSpanIndex = focusableWeakCandidateSpanIndex2;
