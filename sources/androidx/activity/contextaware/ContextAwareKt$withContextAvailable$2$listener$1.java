...
public final class ContextAwareKt$withContextAvailable$2$listener$1 implements OnContextAvailableListener {
    ...
    public ContextAwareKt$withContextAvailable$2$listener$1(CancellableContinuation<R> $co2, Function1<Context, R> $onContextAvailable2) {
        this.$co = $co2;
    ...
    public void onContextAvailable(Context context) {
        ...
        try {
            ...
            obj = Result.m6constructorimpl(function1.invoke(context));
        } catch (Throwable th) {
