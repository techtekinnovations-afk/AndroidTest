...
public final /* synthetic */ class ComponentActivity$$ExternalSyntheticLambda5 implements LifecycleEventObserver {
    ...
    public /* synthetic */ ComponentActivity$$ExternalSyntheticLambda5(ComponentActivity componentActivity) {
        this.f$0 = componentActivity;
    }

    public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        ComponentActivity._init_$lambda$5(this.f$0, lifecycleOwner, event);
    }
}
