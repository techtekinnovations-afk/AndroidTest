...
public final class ActivityResultLauncherKt {
    ...
    public static final void launch(ActivityResultLauncher<Void> $this$launch, ActivityOptionsCompat options) {
    ...
    public static final void launchUnit(ActivityResultLauncher<Unit> $this$launch, ActivityOptionsCompat options) {
        Intrinsics.checkNotNullParameter($this$launch, "<this>");
