...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
    ...
    public void setCurrentPlayTime(Object transitionController, float progress) {
        ...
        if (controller.isReady()) {
            long time = (long) (((float) controller.getDurationMillis()) * progress);
            if (time == 0) {
                time = 1;
            }
    ...
    public void animateToEnd(Object transitionController) {
        ((TransitionSeekController) transitionController).animateToEnd();
    }

    public void animateToStart(Object transitionController, Runnable completeRunnable) {
        ((TransitionSeekController) transitionController).animateToStart(completeRunnable);
    }
    ...
    public void setListenerForTransitionEnd(Fragment outFragment, Object transition, CancellationSignal signal, Runnable transitionCompleteRunnable) {
        setListenerForTransitionEnd(outFragment, transition, signal, (Runnable) null, transitionCompleteRunnable);
    }

    public void setListenerForTransitionEnd(Fragment outFragment, Object transition, CancellationSignal signal, Runnable cancelRunnable, final Runnable transitionCompleteRunnable) {
        Transition realTransition = (Transition) transition;
        signal.setOnCancelListener(new FragmentTransitionSupport$$ExternalSyntheticLambda0(cancelRunnable, realTransition, transitionCompleteRunnable));
    ...
    static /* synthetic */ void lambda$setListenerForTransitionEnd$0(Runnable cancelRunnable, Transition realTransition, Runnable transitionCompleteRunnable) {
