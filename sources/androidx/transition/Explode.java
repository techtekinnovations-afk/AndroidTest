...
public class Explode extends Visibility {
    ...
    public Animator onDisappear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        return TranslationAnimationCreator.createAnimation(view, transitionValues, viewPosX, viewPosY, startX, startY, endX2, ((float) this.mTempLoc[1]) + endY, sAccelerate, this);
    }
    ...
    private void calculateOut(View sceneRoot, Rect bounds, int[] outVector) {
        ...
        int sceneRootY2 = this.mTempLoc[1];
        Rect epicenter = getEpicenter();
        if (epicenter == null) {
            focalX = (view.getWidth() / 2) + sceneRootX + Math.round(view.getTranslationX());
            focalY = (view.getHeight() / 2) + sceneRootY2 + Math.round(view.getTranslationY());
        } else {
        ...
        outVector[c] = Math.round(maxDistance * (xVector / vectorSize));
