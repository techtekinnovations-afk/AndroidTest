...
class ViewGroupUtils {
    ...
    static int getChildDrawingOrder(ViewGroup viewGroup, int i) {
        ...
        if (!sGetChildDrawingOrderMethodFetched) {
            ...
            try {
                sGetChildDrawingOrderMethod = cls.getDeclaredMethod("getChildDrawingOrder", new Class[]{Integer.TYPE, Integer.TYPE});
        ...
        if (sGetChildDrawingOrderMethod != null) {
            try {
                return ((Integer) sGetChildDrawingOrderMethod.invoke(viewGroup, new Object[]{Integer.valueOf(viewGroup.getChildCount()), Integer.valueOf(i)})).intValue();
