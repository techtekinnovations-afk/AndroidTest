...
public class ArgbEvaluator implements TypeEvaluator {
    ...
    public Object evaluate(float fraction, Object startValue, Object endValue) {
        ...
        int i = startInt;
        float f2 = startA;
        return Integer.valueOf((Math.round(((((((float) ((endInt >> 24) & 255)) / 255.0f) - startA) * fraction) + startA) * 255.0f) << 24) | (Math.round(((float) Math.pow((double) (((endR - startR) * fraction) + startR), 0.45454545454545453d)) * 255.0f) << 16) | (Math.round(((float) Math.pow((double) (((endG - startG) * fraction) + startG), 0.45454545454545453d)) * 255.0f) << 8) | Math.round(((float) Math.pow((double) (((endB - startB) * fraction) + startB), 0.45454545454545453d)) * 255.0f));
    }
}
