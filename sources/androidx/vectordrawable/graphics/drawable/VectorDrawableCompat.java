...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private void inflateInternal(Resources res, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        int innerDepth = xmlPullParser.getDepth() + 1;
        for (int i = 1; eventType != i && (xmlPullParser.getDepth() >= innerDepth || eventType != 3); i = 1) {
            if (eventType == 2) {
            ...
            if (matrixScale != 0.0f) {
                ...
                if (fullPath.mFillColor.willDraw()) {
                    ...
                    if (fill.isGradient()) {
                        ...
                        fillPaint.setAlpha(Math.round(fullPath.mFillAlpha * f));
                    } else {
                ...
                if (fullPath.mStrokeColor.willDraw()) {
                    ...
                    if (strokeColor.isGradient()) {
                        ...
                        strokePaint.setAlpha(Math.round(fullPath.mStrokeAlpha * f));
                    } else {
    ...
    private static class VFullPath extends VPath {
        ...
        private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser, Resources.Theme theme) {
            ...
            if (TypedArrayUtils.hasAttribute(parser, "pathData")) {
                ...
                Resources.Theme theme2 = theme;
                ComplexColorCompat namedComplexColor = TypedArrayUtils.getNamedComplexColor(a2, parser2, theme2, "fillColor", 1, 0);
                TypedArray a3 = a2;
                XmlPullParser parser3 = parser2;
                this.mFillColor = namedComplexColor;
                this.mFillAlpha = TypedArrayUtils.getNamedFloat(a3, parser3, "fillAlpha", 12, this.mFillAlpha);
                this.mStrokeLineCap = getStrokeLineCap(TypedArrayUtils.getNamedInt(a3, parser3, "strokeLineCap", 8, -1), this.mStrokeLineCap);
                this.mStrokeLineJoin = getStrokeLineJoin(TypedArrayUtils.getNamedInt(a3, parser3, "strokeLineJoin", 9, -1), this.mStrokeLineJoin);
                this.mStrokeMiterlimit = TypedArrayUtils.getNamedFloat(a3, parser3, "strokeMiterLimit", 10, this.mStrokeMiterlimit);
                this.mStrokeColor = TypedArrayUtils.getNamedComplexColor(a3, parser3, theme2, "strokeColor", 3, 0);
                this.mStrokeAlpha = TypedArrayUtils.getNamedFloat(a3, parser3, "strokeAlpha", 11, this.mStrokeAlpha);
                this.mStrokeWidth = TypedArrayUtils.getNamedFloat(a3, parser3, "strokeWidth", 4, this.mStrokeWidth);
                this.mTrimPathEnd = TypedArrayUtils.getNamedFloat(a3, parser3, "trimPathEnd", 6, this.mTrimPathEnd);
                this.mTrimPathOffset = TypedArrayUtils.getNamedFloat(a3, parser3, "trimPathOffset", 7, this.mTrimPathOffset);
                this.mTrimPathStart = TypedArrayUtils.getNamedFloat(a3, parser3, "trimPathStart", 5, this.mTrimPathStart);
                this.mFillRule = TypedArrayUtils.getNamedInt(a3, parser3, "fillType", 13, this.mFillRule);
            }
        }
