...
public class EmojiCompat {
    ...
    public CharSequence process(CharSequence charSequence, int start, int end, int maxEmojiCount, int replaceStrategy) {
        ...
        if (charSequence.length() == 0) {
            int i = start;
            int i2 = end;
            int i3 = maxEmojiCount;
            return charSequence;
        } else if (start == end) {
            int i4 = start;
            int i5 = end;
            int i6 = maxEmojiCount;
            return charSequence;
        } else {
    ...
    private static class CompatInternal {
        ...
        /* access modifiers changed from: package-private */
        public int getEmojiStart(CharSequence cs, int offset) {
            return -1;
        }

        /* access modifiers changed from: package-private */
        public int getEmojiEnd(CharSequence cs, int offset) {
            return -1;
        }
    ...
    private static final class CompatInternal19 extends CompatInternal {
        ...
        /* access modifiers changed from: package-private */
        public int getEmojiStart(CharSequence sequence, int offset) {
            return this.mProcessor.getEmojiStart(sequence, offset);
        }

        /* access modifiers changed from: package-private */
        public int getEmojiEnd(CharSequence sequence, int offset) {
