...
public final class MetadataRepo {
    ...
    private final char[] mEmojiCharArray = new char[(this.mMetadataList.listLength() * 2)];
    ...
    /* access modifiers changed from: package-private */
    public void put(TypefaceEmojiRasterizer data) {
    ...
    static class Node {
        ...
        /* access modifiers changed from: package-private */
        public void put(TypefaceEmojiRasterizer data, int start, int end) {
