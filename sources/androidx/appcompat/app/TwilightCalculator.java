...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        double solarTransitJ20002 = solarTransitJ2000;
        if (cosHourAngle >= 1.0d) {
            ...
            this.sunset = Math.round((solarTransitJ20002 + ((double) hourAngle)) * 8.64E7d) + UTC_2000;
            this.sunrise = Math.round((solarTransitJ20002 - ((double) hourAngle)) * 8.64E7d) + UTC_2000;
