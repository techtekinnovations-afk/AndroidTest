    ...
    public static class AlertParams {
        ...
        public void apply(AlertController dialog) {
            ...
            if (this.mPositiveButtonText == null && this.mPositiveButtonIcon == null) {
                ...
                AlertController dialog3 = dialog;
                dialog3.setButton(-1, this.mPositiveButtonText, this.mPositiveButtonListener, (Message) null, this.mPositiveButtonIcon);
                dialog2 = dialog3;
            }
            if (!(this.mNegativeButtonText == null && this.mNegativeButtonIcon == null)) {
                dialog2.setButton(-2, this.mNegativeButtonText, this.mNegativeButtonListener, (Message) null, this.mNegativeButtonIcon);
            }
            if (!(this.mNeutralButtonText == null && this.mNeutralButtonIcon == null)) {
                dialog2.setButton(-3, this.mNeutralButtonText, this.mNeutralButtonListener, (Message) null, this.mNeutralButtonIcon);
            }
            if (!(this.mItems == null && this.mCursor == null && this.mAdapter == null)) {
                createListView(dialog2);
            }
            if (this.mView != null) {
                if (this.mViewSpacingSpecified) {
                    dialog2.setView(this.mView, this.mViewSpacingLeft, this.mViewSpacingTop, this.mViewSpacingRight, this.mViewSpacingBottom);
                } else {
                    dialog2.setView(this.mView);
                }
            } else if (this.mViewLayoutResId != 0) {
                dialog2.setView(this.mViewLayoutResId);
            }
        }
        ...
        private void createListView(AlertController dialog) {
            ...
            final RecycleListView listView = (RecycleListView) this.mInflater.inflate(alertController.mListLayout, (ViewGroup) null);
            if (!this.mIsMultiChoice) {
                if (this.mIsSingleChoice) {
                    layout = alertController.mSingleChoiceItemLayout;
                } else {
                    layout = alertController.mListItemLayout;
                }
                ...
                final RecycleListView listView2 = listView;
                adapter = new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) {
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> adapterView, View v, int position, long id) {
                        AlertParams.this.mOnClickListener.onClick(alertController.mDialog, position);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> adapterView, View v, int position, long id) {
                        ...
                        AlertParams.this.mOnCheckboxClickListener.onClick(alertController.mDialog, position, listView.isItemChecked(position));
                    }
                });
            }
