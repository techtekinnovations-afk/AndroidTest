...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean showOverflowMenu() {
        if (!this.mReserveOverflow || isOverflowMenuShowing() || this.mMenu == null || this.mMenuView == null || this.mPostedOpenRunnable != null) {
            return false;
        } else if (!this.mMenu.getNonActionItems().isEmpty()) {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow != 0 && (hasOverflow || requiredItems + requestedItems > maxActions)) {
            maxActions--;
        }
            ...
            if (item2.requiresActionButton()) {
                ...
                if (item2.requestsActionButton() != 0) {
                    ...
                    if (isAction2) {
                        ...
                        int widthLimit3 = widthLimit2 - measuredWidth2;
                        if (firstActionWidth == 0) {
                            firstActionWidth = measuredWidth2;
                        }
                        View view2 = v2;
                        if (actionMenuPresenter.mStrictWidthLimit) {
                            isAction2 = (widthLimit3 >= 0) & isAction;
                            widthLimit = widthLimit3;
                        } else {
                            isAction2 = (widthLimit3 + firstActionWidth > 0) & isAction;
                            widthLimit = widthLimit3;
                        }
                    } else {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        ...
        public ActionButtonSubmenu(android.content.Context r8, androidx.appcompat.view.menu.SubMenuBuilder r9, android.view.View r10) {
            /*
                ...
                androidx.appcompat.view.menu.MenuView r9 = r7.mMenuView
