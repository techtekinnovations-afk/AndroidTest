...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attributeSet, R.styleable.AppCompatTextHelper, i2, 0);
        ViewCompat.saveAttributeDataForStyleable(this.mView, this.mView.getContext(), R.styleable.AppCompatTextHelper, attributeSet, a.getWrappedTypeArray(), i2, 0);
        ...
        TintTypedArray a3 = TintTypedArray.obtainStyledAttributes(context, attributeSet2, R.styleable.TextAppearance, i3, 0);
        ...
        TintTypedArray a4 = TintTypedArray.obtainStyledAttributes(context, attributeSet2, R.styleable.AppCompatTextView);
        ...
        Drawable drawableStart2 = drawableStart;
        Drawable drawableLeft2 = drawableLeft;
        int i9 = drawableEndId;
        setCompoundDrawables(drawableLeft2, drawableTop, drawableRight, drawableBottom, drawableStart2, drawableEnd);
        Drawable drawable = drawableLeft2;
        if (a4.hasValue(R.styleable.AppCompatTextView_drawableTint)) {
            Drawable drawable2 = drawableTop;
        ...
        Drawable drawable3 = drawableRight;
        ...
        if (a4.hasValue(R.styleable.AppCompatTextView_lineHeight)) {
            ...
            if (peekValue != null) {
                Drawable drawable4 = drawableBottom;
                Drawable drawable5 = drawableStart2;
                if (peekValue.type == 5) {
                    int lineHeightUnit2 = TypedValueCompat.getUnitFromComplexDimension(peekValue.data);
                    lineHeight = TypedValue.complexToFloat(peekValue.data);
                    lineHeightUnit = lineHeightUnit2;
                    i = -1;
                }
            } else {
                Drawable drawable6 = drawableStart2;
            }
            i = -1;
            lineHeight = (float) a4.getDimensionPixelSize(R.styleable.AppCompatTextView_lineHeight, -1);
            lineHeightUnit = -1;
        } else {
            Drawable drawable7 = drawableStart2;
            i = -1;
            lineHeightUnit = -1;
            lineHeight = -1.0f;
        }
        ...
        if (lineHeight == f) {
        } else if (lineHeightUnit == -1) {
            int i10 = firstBaselineToTopHeight;
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        if (a.hasValue(R.styleable.TextAppearance_android_fontFamily) || a.hasValue(R.styleable.TextAppearance_fontFamily)) {
            ...
            if (this.mFontTypeface == null && (fontFamilyName = a.getString(fontFamilyId)) != null) {
                ...
                this.mFontTypeface = Api28Impl.create(create, i, z);
            }
