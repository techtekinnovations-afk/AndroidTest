...
class DropDownListView extends ListView {
    ...
    private void setPressedItem(View child, int position, float x, float y) {
        ...
        Api21Impl.drawableHotspotChanged(child, x - ((float) child.getLeft()), y - ((float) child.getTop()));
        if (!child.isPressed()) {
    ...
    static class Api30Impl {
        ...
        static {
            ...
            try {
                sPositionSelector = cls.getDeclaredMethod("positionSelector", new Class[]{Integer.TYPE, View.class, Boolean.TYPE, Float.TYPE, Float.TYPE});
                sPositionSelector.setAccessible(true);
                sSetSelectedPositionInt = AdapterView.class.getDeclaredMethod("setSelectedPositionInt", new Class[]{Integer.TYPE});
                sSetSelectedPositionInt.setAccessible(true);
                sSetNextSelectedPositionInt = AdapterView.class.getDeclaredMethod("setNextSelectedPositionInt", new Class[]{Integer.TYPE});
