...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context2, R.styleable.SwitchCompat, attrs2, a.getWrappedTypeArray(), defStyleAttr2, 0);
        ...
        this.mTextHelper.loadFromAttributes(attrs2, defStyleAttr2);
        a.recycle();
        ...
        getEmojiTextViewHelper().loadFromAttributes(attrs2, defStyleAttr2);
    ...
    private Layout makeLayout(CharSequence transformedText) {
        return new StaticLayout(transformedText, this.mTextPaint, transformedText != null ? (int) Math.ceil((double) Layout.getDesiredWidth(transformedText, this.mTextPaint)) : 0, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
    }
