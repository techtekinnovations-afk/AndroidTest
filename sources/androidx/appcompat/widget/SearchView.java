...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context2, R.styleable.SearchView, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        LayoutInflater.from(context2).inflate(a.getResourceId(R.styleable.SearchView_layout, R.layout.abc_search_view), this, true);
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (changed2) {
            ...
            this.mSearchSrtTextViewBoundsExpanded.set(this.mSearchSrcTextViewBounds.left, 0, this.mSearchSrcTextViewBounds.right, bottom2 - top2);
    ...
    private android.content.Intent createIntentFromSuggestion(android.database.Cursor r10, int r11, java.lang.String r12) {
        /*
            ...
            java.lang.String r0 = androidx.appcompat.widget.SuggestionsAdapter.getColumnString(r10, r0)     // Catch:{ RuntimeException -> 0x0072 }
            if (r0 != 0) goto L_0x0016
            android.app.SearchableInfo r2 = r9.mSearchable     // Catch:{ RuntimeException -> 0x0011 }
            java.lang.String r2 = r2.getSuggestIntentAction()     // Catch:{ RuntimeException -> 0x0011 }
            r0 = r2
            goto L_0x0016
        L_0x0011:
            r0 = move-exception
        ...
        L_0x001e:
            ...
            android.app.SearchableInfo r2 = r9.mSearchable     // Catch:{ RuntimeException -> 0x0011 }
            java.lang.String r2 = r2.getSuggestIntentData()     // Catch:{ RuntimeException -> 0x0011 }
            r0 = r2
        L_0x002d:
            if (r0 == 0) goto L_0x0053
            java.lang.String r2 = "suggest_intent_data_id"
            java.lang.String r2 = androidx.appcompat.widget.SuggestionsAdapter.getColumnString(r10, r2)     // Catch:{ RuntimeException -> 0x0011 }
            if (r2 == 0) goto L_0x0053
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ RuntimeException -> 0x0011 }
            r4.<init>()     // Catch:{ RuntimeException -> 0x0011 }
            java.lang.StringBuilder r4 = r4.append(r0)     // Catch:{ RuntimeException -> 0x0011 }
            java.lang.String r5 = "/"
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ RuntimeException -> 0x0011 }
            java.lang.String r5 = android.net.Uri.encode(r2)     // Catch:{ RuntimeException -> 0x0011 }
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ RuntimeException -> 0x0011 }
            java.lang.String r4 = r4.toString()     // Catch:{ RuntimeException -> 0x0011 }
            r0 = r4
        L_0x0053:
            ...
            goto L_0x005c
        L_0x0057:
            android.net.Uri r2 = android.net.Uri.parse(r0)     // Catch:{ RuntimeException -> 0x0072 }
            r4 = r2
        L_0x005c:
            java.lang.String r2 = "suggest_intent_query"
            java.lang.String r6 = androidx.appcompat.widget.SuggestionsAdapter.getColumnString(r10, r2)     // Catch:{ RuntimeException -> 0x0072 }
            java.lang.String r2 = "suggest_intent_extra_data"
            java.lang.String r5 = androidx.appcompat.widget.SuggestionsAdapter.getColumnString(r10, r2)     // Catch:{ RuntimeException -> 0x0072 }
            r2 = r9
            r7 = r11
            r8 = r12
            android.content.Intent r11 = r2.createIntent(r3, r4, r5, r6, r7, r8)     // Catch:{ RuntimeException -> 0x0070 }
            return r11
        L_0x0070:
            r0 = move-exception
            goto L_0x0075
        ...
        L_0x0075:
            r11 = r0
            int r12 = r10.getPosition()     // Catch:{ RuntimeException -> 0x007b }
            goto L_0x007f
        L_0x007b:
            r0 = move-exception
            r12 = r0
    ...
    private static class PreQAutoCompleteTextViewReflector {
        ...
        PreQAutoCompleteTextViewReflector() {
            ...
            try {
                this.mEnsureImeVisible = cls.getMethod("ensureImeVisible", new Class[]{Boolean.TYPE});
        ...
        public void ensureImeVisible(AutoCompleteTextView view) {
            ...
            if (this.mEnsureImeVisible != null) {
                try {
                    this.mEnsureImeVisible.invoke(view, new Object[]{true});
                } catch (Exception e) {
                }
            }
        }
