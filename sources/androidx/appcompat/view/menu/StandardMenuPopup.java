...
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, MenuPresenter, View.OnKeyListener {
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenu) {
        if (subMenu.hasVisibleItems()) {
            SubMenuBuilder subMenu2 = subMenu;
            MenuPopupHelper subPopup = new MenuPopupHelper(this.mContext, subMenu2, this.mShownAnchorView, this.mOverflowOnly, this.mPopupStyleAttr, this.mPopupStyleRes);
            subPopup.setPresenterCallback(this.mPresenterCallback);
            subPopup.setForceShowIcon(MenuPopup.shouldPreserveIconSpacing(subMenu2));
            ...
            if (subPopup.tryShow(horizontalOffset, verticalOffset)) {
                ...
                this.mPresenterCallback.onOpenSubMenu(subMenu2);
                return true;
            }
        }
        return false;
