...
public class MenuBuilder implements SupportMenu {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:4:0x0019, code lost:
        if (androidx.core.view.ViewConfigurationCompat.shouldShowMenuShortcutsWhenKeyboardPresent(android.view.ViewConfiguration.get(r3.mContext), r3.mContext) != false) goto L_0x001d;
     */
    ...
    public void findItemsWithShortcutForKey(List<MenuItemImpl> items, int keyCode, KeyEvent event) {
        ...
        int modifierState = keyEvent.getModifiers();
