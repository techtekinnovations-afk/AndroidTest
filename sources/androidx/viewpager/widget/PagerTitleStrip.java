...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void updateTextPositions(int i, float f, boolean z) {
        ...
        int min = Math.min(paddingLeft, (i9 - this.mScaledTextSpacing) - i14);
        this.mPrevText.layout(min, i4, min + i14, this.mPrevText.getMeasuredHeight() + i4);
        int max3 = Math.max((width - paddingRight) - i15, i10 + this.mScaledTextSpacing);
        this.mNextText.layout(max3, i3, max3 + i15, this.mNextText.getMeasuredHeight() + i3);
