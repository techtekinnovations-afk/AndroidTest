...
class FragmentStore {
    ...
    /* access modifiers changed from: package-private */
    public FragmentState getSavedState(String who) {
        return this.mSavedState.get(who);
    }

    /* access modifiers changed from: package-private */
    public FragmentState setSavedState(String who, FragmentState fragmentState) {
        if (fragmentState != null) {
            return this.mSavedState.put(who, fragmentState);
        }
        return this.mSavedState.remove(who);
    }

    /* access modifiers changed from: package-private */
    public void restoreSaveState(ArrayList<FragmentState> savedState) {
        this.mSavedState.clear();
        Iterator<FragmentState> it = savedState.iterator();
        while (it.hasNext()) {
            FragmentState fs = it.next();
            this.mSavedState.put(fs.mWho, fs);
        }
    }
    ...
    public ArrayList<String> saveActiveFragments() {
        ArrayList<String> active = new ArrayList<>(this.mActive.size());
        for (FragmentStateManager fragmentStateManager : this.mActive.values()) {
            if (fragmentStateManager != null) {
