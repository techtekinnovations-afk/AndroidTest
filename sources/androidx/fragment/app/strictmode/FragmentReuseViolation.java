...
public final class FragmentReuseViolation extends Violation {
    ...
    public FragmentReuseViolation(Fragment fragment, String previousFragmentId2) {
        super(fragment, "Attempting to reuse fragment " + fragment + " with previous ID " + previousFragmentId2);
        Intrinsics.checkNotNullParameter(fragment, "fragment");
        Intrinsics.checkNotNullParameter(previousFragmentId2, "previousFragmentId");
        this.previousFragmentId = previousFragmentId2;
    }
}
