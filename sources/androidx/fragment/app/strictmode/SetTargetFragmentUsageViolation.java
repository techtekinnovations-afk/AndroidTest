...
public final class SetTargetFragmentUsageViolation extends TargetFragmentUsageViolation {
    ...
    public SetTargetFragmentUsageViolation(Fragment fragment, Fragment targetFragment2, int requestCode2) {
        super(fragment, "Attempting to set target fragment " + targetFragment2 + " with request code " + requestCode2 + " for fragment " + fragment);
