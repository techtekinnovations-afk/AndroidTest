...
public final class FragmentTagUsageViolation extends Violation {
    ...
    public FragmentTagUsageViolation(Fragment fragment, ViewGroup parentContainer2) {
        super(fragment, "Attempting to use <fragment> tag to add fragment " + fragment + " to container " + parentContainer2);
