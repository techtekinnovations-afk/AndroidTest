...
public final class WrongFragmentContainerViolation extends Violation {
    ...
    public WrongFragmentContainerViolation(Fragment fragment, ViewGroup container2) {
        super(fragment, "Attempting to add fragment " + fragment + " to container " + container2 + " which is not a FragmentContainerView");
