...
public final class FragmentStrictMode {
    ...
    private final boolean shouldHandlePolicyViolation(Policy policy, Class<? extends Fragment> fragmentClass, Class<? extends Violation> violationClass) {
        Set violationsToBypass = policy.getMAllowedViolations$fragment_release().get(fragmentClass.getName());
        if (violationsToBypass == null) {
            return true;
        }
        if (Intrinsics.areEqual((Object) violationClass.getSuperclass(), (Object) Violation.class) || !CollectionsKt.contains(violationsToBypass, violationClass.getSuperclass())) {
    ...
    private final void handlePolicyViolation(Policy policy, Violation violation) {
        ...
        if (policy.getFlags$fragment_release().contains(Flag.PENALTY_DEATH)) {
            runOnHostThread(fragment, new FragmentStrictMode$$ExternalSyntheticLambda1(fragmentName, violation));
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: handlePolicyViolation$lambda-0  reason: not valid java name */
    public static final void m2028handlePolicyViolation$lambda0(Policy $policy, Violation $violation) {
    ...
    public static final void m2029handlePolicyViolation$lambda1(String $fragmentName, Violation $violation) {
        Intrinsics.checkNotNullParameter($violation, "$violation");
    ...
    public static final class Policy {
        ...
        public Policy(Set<? extends Flag> flags2, OnViolationListener listener2, Map<String, ? extends Set<Class<? extends Violation>>> allowedViolations) {
            Intrinsics.checkNotNullParameter(flags2, "flags");
            Intrinsics.checkNotNullParameter(allowedViolations, "allowedViolations");
            this.flags = flags2;
            this.listener = listener2;
            Map newAllowedViolationsMap = new LinkedHashMap();
            for (Map.Entry next : allowedViolations.entrySet()) {
                newAllowedViolationsMap.put((String) next.getKey(), (Set) next.getValue());
            }
        ...
        public static final class Builder {
            ...
            public final Builder penaltyListener(OnViolationListener listener2) {
