...
public final class SetUserVisibleHintViolation extends Violation {
    ...
    public SetUserVisibleHintViolation(Fragment fragment, boolean isVisibleToUser2) {
        super(fragment, "Attempting to set user visible hint to " + isVisibleToUser2 + " for fragment " + fragment);
