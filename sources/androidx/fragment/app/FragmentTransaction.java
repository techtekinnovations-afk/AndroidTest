...
public abstract class FragmentTransaction {
    ...
    FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction ft) {
        this(fragmentFactory, classLoader);
        Iterator<Op> it = ft.mOps.iterator();
        while (it.hasNext()) {
            this.mOps.add(new Op(it.next()));
        }
        this.mEnterAnim = ft.mEnterAnim;
        this.mExitAnim = ft.mExitAnim;
        this.mPopEnterAnim = ft.mPopEnterAnim;
        this.mPopExitAnim = ft.mPopExitAnim;
        this.mTransition = ft.mTransition;
        this.mAddToBackStack = ft.mAddToBackStack;
        this.mAllowAddToBackStack = ft.mAllowAddToBackStack;
        this.mName = ft.mName;
        this.mBreadCrumbShortTitleRes = ft.mBreadCrumbShortTitleRes;
        this.mBreadCrumbShortTitleText = ft.mBreadCrumbShortTitleText;
        this.mBreadCrumbTitleRes = ft.mBreadCrumbTitleRes;
        this.mBreadCrumbTitleText = ft.mBreadCrumbTitleText;
        if (ft.mSharedElementSourceNames != null) {
            this.mSharedElementSourceNames = new ArrayList<>();
            this.mSharedElementSourceNames.addAll(ft.mSharedElementSourceNames);
        }
        if (ft.mSharedElementTargetNames != null) {
            this.mSharedElementTargetNames = new ArrayList<>();
            this.mSharedElementTargetNames.addAll(ft.mSharedElementTargetNames);
        }
        this.mReorderingAllowed = ft.mReorderingAllowed;
    }
    ...
    private Fragment createFragment(Class<? extends Fragment> fragmentClass, Bundle args) {
        if (this.mFragmentFactory == null) {
            ...
            Fragment fragment = this.mFragmentFactory.instantiate(this.mClassLoader, fragmentClass.getName());
            if (args != null) {
