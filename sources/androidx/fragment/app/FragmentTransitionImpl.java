...
public abstract class FragmentTransitionImpl {
    ...
    public void setNameOverridesReordered(View sceneRoot, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, ArrayList<String> inNames, Map<String, String> nameOverrides) {
        ...
        final ArrayList<View> sharedElementsOut2 = sharedElementsOut;
        final ArrayList<View> sharedElementsIn2 = sharedElementsIn;
        final ArrayList<String> inNames2 = inNames;
        OneShotPreDrawListener.add(sceneRoot, new Runnable() {
            public void run() {
                for (int i = 0; i < numSharedElements; i++) {
                    ViewCompat.setTransitionName((View) sharedElementsIn2.get(i), (String) inNames2.get(i));
                    ViewCompat.setTransitionName((View) sharedElementsOut2.get(i), (String) outNames.get(i));
                }
            }
        });
    }
