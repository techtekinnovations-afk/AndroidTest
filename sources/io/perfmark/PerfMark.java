        ...
        if (err != null) {
            try {
                if (Boolean.getBoolean("io.perfmark.PerfMark.debug")) {
                    ...
                    Class[] clsArr = {levelClass, String.class, Throwable.class};
                    logClass.getMethod("log", clsArr).invoke(logger, new Object[]{levelClass.getField("FINE").get((Object) null), "Error during PerfMark.<clinit>", err});
                }
            } catch (Throwable th) {
            }
        }
