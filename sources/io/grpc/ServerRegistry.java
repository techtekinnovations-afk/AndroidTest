...
public final class ServerRegistry {
    ...
    public static synchronized ServerRegistry getDefaultRegistry() {
        ...
        synchronized (ServerRegistry.class) {
            if (instance == null) {
                List<ServerProvider> providerList = ServiceProviders.loadAll(ServerProvider.class, getHardCodedClasses(), ServerProvider.class.getClassLoader(), new ServerPriorityAccessor());
