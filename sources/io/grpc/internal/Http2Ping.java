...
public class Http2Ping {
    ...
    public void addCallback(io.grpc.internal.ClientTransport.PingCallback r3, java.util.concurrent.Executor r4) {
        /*
            r2 = this;
            monitor-enter(r2)
            boolean r0 = r2.completed     // Catch:{ all -> 0x0023 }
            if (r0 != 0) goto L_0x000c
            java.util.Map<io.grpc.internal.ClientTransport$PingCallback, java.util.concurrent.Executor> r0 = r2.callbacks     // Catch:{ all -> 0x0023 }
            r0.put(r3, r4)     // Catch:{ all -> 0x0023 }
            monitor-exit(r2)     // Catch:{ all -> 0x0023 }
            return
        L_0x000c:
            java.lang.Throwable r0 = r2.failureCause     // Catch:{ all -> 0x0023 }
            if (r0 == 0) goto L_0x0017
            java.lang.Throwable r0 = r2.failureCause     // Catch:{ all -> 0x0023 }
            java.lang.Runnable r0 = asRunnable((io.grpc.internal.ClientTransport.PingCallback) r3, (java.lang.Throwable) r0)     // Catch:{ all -> 0x0023 }
            goto L_0x001d
        L_0x0017:
            long r0 = r2.roundTripTimeNanos     // Catch:{ all -> 0x0023 }
            java.lang.Runnable r0 = asRunnable((io.grpc.internal.ClientTransport.PingCallback) r3, (long) r0)     // Catch:{ all -> 0x0023 }
        L_0x001d:
            monitor-exit(r2)     // Catch:{ all -> 0x0023 }
            doExecute(r4, r0)
            return
    ...
    public boolean complete() {
        ...
        L_0x0023:
            ...
            io.grpc.internal.ClientTransport$PingCallback r7 = (io.grpc.internal.ClientTransport.PingCallback) r7
            java.lang.Runnable r7 = asRunnable((io.grpc.internal.ClientTransport.PingCallback) r7, (long) r1)
            doExecute(r6, r7)
            goto L_0x0023
        L_0x0043:
            return r0
    ...
    public void failed(java.lang.Throwable r6) {
        ...
        L_0x001a:
            ...
            io.grpc.internal.ClientTransport$PingCallback r3 = (io.grpc.internal.ClientTransport.PingCallback) r3
