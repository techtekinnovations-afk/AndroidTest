...
final class InternalSubchannel implements InternalInstrumented<InternalChannelz.ChannelStats>, TransportProvider {
    ...
    InternalSubchannel(List<EquivalentAddressGroup> addressGroups2, String authority2, String userAgent2, BackoffPolicy.Provider backoffPolicyProvider2, ClientTransportFactory transportFactory2, ScheduledExecutorService scheduledExecutor2, Supplier<Stopwatch> stopwatchSupplier, SynchronizationContext syncContext2, Callback callback2, InternalChannelz channelz2, CallTracer callsTracer2, ChannelTracer channelTracer2, InternalLogId logId2, ChannelLogger channelLogger2, List<ClientTransportFilter> transportFilters2) {
        ...
        this.transportFilters = transportFilters2;
    }
        ...
        this.syncContext.execute(new Runnable() {
            public void run() {
                ...
                if (savedTransport != null) {
                    ...
                    SynchronizationContext.ScheduledHandle unused7 = InternalSubchannel.this.shutdownDueToUpdateTask = InternalSubchannel.this.syncContext.schedule(new Runnable() {
                        public void run() {
    ...
    private class TransportListener implements ManagedClientTransport.Listener {
        ...
        TransportListener(ConnectionClientTransport transport2) {
        ...
        public io.grpc.Attributes filterTransport(io.grpc.Attributes r5) {
            /*
                r4 = this;
            ...
            L_0x000a:
                ...
                io.grpc.ClientTransportFilter r1 = (io.grpc.ClientTransportFilter) r1
            ...
            L_0x0024:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.internal.InternalSubchannel.TransportListener.filterTransport(io.grpc.Attributes):io.grpc.Attributes");
        }
