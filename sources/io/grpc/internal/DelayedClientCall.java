...
public class DelayedClientCall<ReqT, RespT> extends ClientCall<ReqT, RespT> {
    ...
    private ScheduledFuture<?> scheduleDeadlineIfNeeded(ScheduledExecutorService scheduler, @Nullable Deadline deadline) {
        ...
        if (contextDeadline != null && contextDeadline.timeRemaining(TimeUnit.NANOSECONDS) < remainingNanos) {
            ...
            if (logger.isLoggable(Level.FINE)) {
                StringBuilder builder = new StringBuilder(String.format(Locale.US, "Call timeout set to '%d' ns, due to context deadline.", new Object[]{Long.valueOf(remainingNanos)}));
                if (deadline == null) {
                    builder.append(" Explicit call timeout was not set.");
                } else {
                    builder.append(String.format(Locale.US, " Explicit call timeout was '%d' ns.", new Object[]{Long.valueOf(deadline.timeRemaining(TimeUnit.NANOSECONDS))}));
                }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x001b, code lost:
        delayOrExecute(new io.grpc.internal.DelayedClientCall.AnonymousClass3(r4));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0024, code lost:
        if (r1 == null) goto L_0x0030;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0026, code lost:
        r4.callExecutor.execute(new io.grpc.internal.DelayedClientCall.CloseListenerRunnable(r4, r1, r5));
     */
    ...
    public void cancel(final io.grpc.Status r5, boolean r6) {
        /*
            r4 = this;
            r0 = 1
            r1 = 0
        ...
        L_0x0017:
            ...
            io.grpc.internal.DelayedClientCall$3 r2 = new io.grpc.internal.DelayedClientCall$3
            r2.<init>(r5)
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0021, code lost:
        r2 = r1;
        r5.callExecutor.execute(new io.grpc.internal.DelayedClientCall.AnonymousClass1DrainListenerRunnable(r5));
     */
    ...
    private void setRealCall(ClientCall<ReqT, RespT> realCall2) {
        Preconditions.checkState(this.realCall == null, "realCall already set to %s", (Object) this.realCall);
