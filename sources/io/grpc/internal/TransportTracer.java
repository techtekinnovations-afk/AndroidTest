...
public final class TransportTracer {
    ...
    public InternalChannelz.TransportStats getStats() {
        ...
        long localFlowControlWindow = this.flowControlWindowReader == null ? -1 : this.flowControlWindowReader.read().localBytes;
        if (this.flowControlWindowReader != null) {
            remoteFlowControlWindow = this.flowControlWindowReader.read().remoteBytes;
        }
