...
class SerializeReentrantCallsDirectExecutor implements Executor {
    ...
    public void execute(java.lang.Runnable r7) {
        ...
        L_0x001a:
            r1 = move-exception
            java.util.logging.Logger r2 = log     // Catch:{ all -> 0x003a }
            java.util.logging.Level r3 = java.util.logging.Level.SEVERE     // Catch:{ all -> 0x003a }
            ...
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x003a }
            java.lang.StringBuilder r4 = r4.append(r7)     // Catch:{ all -> 0x003a }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x003a }
            r2.log(r3, r4, r1)     // Catch:{ all -> 0x003a }
            java.util.ArrayDeque<java.lang.Runnable> r1 = r6.taskQueue
            if (r1 == 0) goto L_0x0017
            goto L_0x0014
        L_0x003a:
