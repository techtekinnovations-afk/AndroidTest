                ...
                if (headerIndex == -1) {
                    ...
                    while (true) {
                        ...
                        if (j >= this.dynamicTable.length) {
                            break;
                        } else if (this.dynamicTable[j].name.equals(name)) {
