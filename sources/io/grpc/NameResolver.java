...
public abstract class NameResolver {
    ...
    public static final class Args {
        ...
        private Args(Integer defaultPort2, ProxyDetector proxyDetector2, SynchronizationContext syncContext2, ServiceConfigParser serviceConfigParser2, @Nullable ScheduledExecutorService scheduledExecutorService2, @Nullable ChannelLogger channelLogger2, @Nullable Executor executor2, @Nullable String overrideAuthority2) {
            ...
            this.overrideAuthority = overrideAuthority2;
        }
