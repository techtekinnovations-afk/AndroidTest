...
public final class Status {
        ...
        switch (asciiCodeValue.length) {
            case 2:
                if (asciiCodeValue[0] >= 48 && asciiCodeValue[0] <= 57) {
                    codeValue2 = 0 + ((asciiCodeValue[0] - 48) * 10);
                    index = 0 + 1;
                }
            case 1:
    ...
    public String toString() {
        return MoreObjects.toStringHelper((Object) this).add("code", (Object) this.code.name()).add("description", (Object) this.description).add("cause", this.cause != null ? Throwables.getStackTraceAsString(this.cause) : this.cause).toString();
    }
