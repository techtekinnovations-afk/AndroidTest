...
public final class CompositeCallCredentials extends CallCredentials {
    ...
    public void applyRequestMetadata(CallCredentials.RequestInfo requestInfo, Executor appExecutor, CallCredentials.MetadataApplier applier) {
        CallCredentials.RequestInfo requestInfo2 = requestInfo;
        Executor appExecutor2 = appExecutor;
        this.credentials1.applyRequestMetadata(requestInfo2, appExecutor2, new WrappingMetadataApplier(requestInfo2, appExecutor2, applier, Context.current()));
    }
