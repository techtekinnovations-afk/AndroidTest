...
class ComparableOpenEndRange<T extends Comparable<? super T>> implements OpenEndRange<T> {
    ...
    public ComparableOpenEndRange(T start2, T endExclusive2) {
        Intrinsics.checkNotNullParameter(start2, "start");
        Intrinsics.checkNotNullParameter(endExclusive2, "endExclusive");
        this.start = start2;
        this.endExclusive = endExclusive2;
    }
    ...
    public boolean equals(Object other) {
        return (other instanceof ComparableOpenEndRange) && ((isEmpty() && ((ComparableOpenEndRange) other).isEmpty()) || (Intrinsics.areEqual((Object) getStart(), (Object) ((ComparableOpenEndRange) other).getStart()) && Intrinsics.areEqual((Object) getEndExclusive(), (Object) ((ComparableOpenEndRange) other).getEndExclusive())));
    }
