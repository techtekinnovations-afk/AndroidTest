...
class ComparableRange<T extends Comparable<? super T>> implements ClosedRange<T> {
    ...
    public ComparableRange(T start2, T endInclusive2) {
        Intrinsics.checkNotNullParameter(start2, "start");
        Intrinsics.checkNotNullParameter(endInclusive2, "endInclusive");
        this.start = start2;
    ...
    public boolean equals(Object other) {
        return (other instanceof ComparableRange) && ((isEmpty() && ((ComparableRange) other).isEmpty()) || (Intrinsics.areEqual((Object) getStart(), (Object) ((ComparableRange) other).getStart()) && Intrinsics.areEqual((Object) getEndInclusive(), (Object) ((ComparableRange) other).getEndInclusive())));
    }
