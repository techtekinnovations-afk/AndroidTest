...
public final class GeneratorSequence$iterator$1 implements Iterator<T>, KMappedMarker {
    ...
    GeneratorSequence$iterator$1(GeneratorSequence<T> $receiver) {
    ...
    public T next() {
        ...
        if (this.nextState != 0) {
            ...
            Intrinsics.checkNotNull(result, "null cannot be cast to non-null type T of kotlin.sequences.GeneratorSequence");
            this.nextState = -1;
            return result;
        }
