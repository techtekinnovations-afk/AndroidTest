...
final class GeneratorSequence<T> implements Sequence<T> {
    ...
    public GeneratorSequence(Function0<? extends T> getInitialValue2, Function1<? super T, ? extends T> getNextValue2) {
        Intrinsics.checkNotNullParameter(getInitialValue2, "getInitialValue");
        Intrinsics.checkNotNullParameter(getNextValue2, "getNextValue");
