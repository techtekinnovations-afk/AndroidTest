...
public final class SequencesKt___SequencesKt$minus$1 implements Sequence<T> {
    ...
    SequencesKt___SequencesKt$minus$1(Sequence<? extends T> $receiver, T $element2) {
        this.$this_minus = $receiver;
        this.$element = $element2;
    }

    public Iterator<T> iterator() {
        return SequencesKt.filter(this.$this_minus, new SequencesKt___SequencesKt$minus$1$iterator$1(new Ref.BooleanRef(), this.$element)).iterator();
    }
}
