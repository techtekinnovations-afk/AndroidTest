...
final class TypeVariableImpl implements TypeVariable<GenericDeclaration>, TypeImpl {
    ...
    public TypeVariableImpl(KTypeParameter typeParameter2) {
    ...
    public Type[] getBounds() {
        Iterable<KType> $this$map$iv = this.typeParameter.getUpperBounds();
        Collection destination$iv$iv = new ArrayList(CollectionsKt.collectionSizeOrDefault($this$map$iv, 10));
        for (KType it : $this$map$iv) {
            destination$iv$iv.add(TypesJVMKt.computeJavaType(it, true));
        }
        return (Type[]) ((List) destination$iv$iv).toArray(new Type[0]);
    }
    ...
    public boolean equals(Object other) {
        return (other instanceof TypeVariable) && Intrinsics.areEqual((Object) getName(), (Object) ((TypeVariable) other).getName()) && Intrinsics.areEqual((Object) getGenericDeclaration(), (Object) ((TypeVariable) other).getGenericDeclaration());
    }
