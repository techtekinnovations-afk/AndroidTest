...
final class ParameterizedTypeImpl implements ParameterizedType, TypeImpl {
    ...
    public ParameterizedTypeImpl(Class<?> rawType2, Type ownerType2, List<? extends Type> typeArguments2) {
        Intrinsics.checkNotNullParameter(rawType2, "rawType");
        Intrinsics.checkNotNullParameter(typeArguments2, "typeArguments");
        this.rawType = rawType2;
        this.ownerType = ownerType2;
        this.typeArguments = (Type[]) typeArguments2.toArray(new Type[0]);
    }
    ...
    public String getTypeName() {
        ...
        StringBuilder $this$getTypeName_u24lambda_u240 = sb;
        ...
        if (!(this.typeArguments.length == 0)) {
            ArraysKt.joinTo$default((Object[]) this.typeArguments, (Appendable) $this$getTypeName_u24lambda_u240, (CharSequence) null, (CharSequence) "<", (CharSequence) ">", 0, (CharSequence) null, (Function1) ParameterizedTypeImpl$getTypeName$1$1.INSTANCE, 50, (Object) null);
        }
    ...
    public boolean equals(Object other) {
        return (other instanceof ParameterizedType) && Intrinsics.areEqual((Object) this.rawType, (Object) ((ParameterizedType) other).getRawType()) && Intrinsics.areEqual((Object) this.ownerType, (Object) ((ParameterizedType) other).getOwnerType()) && Arrays.equals(getActualTypeArguments(), ((ParameterizedType) other).getActualTypeArguments());
    }
