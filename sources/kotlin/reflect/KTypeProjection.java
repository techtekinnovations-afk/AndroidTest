...
public final class KTypeProjection {
    ...
    public KTypeProjection(KVariance variance2, KType type2) {
        String str;
        this.variance = variance2;
        this.type = type2;
        if (!((this.variance == null) != (this.type == null) ? false : true)) {
    ...
    @JvmStatic
    public static final KTypeProjection invariant(KType type2) {
        return Companion.invariant(type2);
    }

    @JvmStatic
    public static final KTypeProjection contravariant(KType type2) {
        return Companion.contravariant(type2);
    }

    @JvmStatic
    public static final KTypeProjection covariant(KType type2) {
        return Companion.covariant(type2);
    }
}
