...
class ArraysKt__ArraysKt extends ArraysKt__ArraysJVMKt {
                                                    ...
                                                    if (!(v1 instanceof UByteArray) || !(v2 instanceof UByteArray)) {
                                                        if (!(v1 instanceof UShortArray) || !(v2 instanceof UShortArray)) {
                                                            if (!(v1 instanceof UIntArray) || !(v2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m573contentEqualslec5QzE(((ULongArray) v1).m249unboximpl(), ((ULongArray) v2).m249unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m571contentEqualsKJPZfPQ(((UIntArray) v1).m170unboximpl(), ((UIntArray) v2).m170unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m570contentEqualsFGO6Aew(((UShortArray) v1).m354unboximpl(), ((UShortArray) v2).m354unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m572contentEqualskV0jMPg(((UByteArray) v1).m91unboximpl(), ((UByteArray) v2).m91unboximpl())) {
                                                        return false;
                                                    }
    ...
    public static final <T> String contentDeepToString(T[] $this$contentDeepToStringImpl) {
        ...
        StringBuilder $this$contentDeepToStringImpl_u24lambda_u243 = new StringBuilder((RangesKt.coerceAtMost($this$contentDeepToStringImpl.length, 429496729) * 5) + 2);
        contentDeepToStringInternal$ArraysKt__ArraysKt($this$contentDeepToStringImpl, $this$contentDeepToStringImpl_u24lambda_u243, new ArrayList());
        String sb = $this$contentDeepToStringImpl_u24lambda_u243.toString();
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] r5, java.lang.StringBuilder r6, java.util.List<java.lang.Object[]> r7) {
        ...
        L_0x00d0:
            ...
            byte[] r4 = r3.m91unboximpl()
        L_0x00de:
            java.lang.String r3 = kotlin.collections.unsigned.UArraysKt.m578contentToString2csIQuQ(r4)
            r6.append(r3)
            goto L_0x012c
        L_0x00e6:
            ...
            short[] r4 = r3.m354unboximpl()
        L_0x00f3:
            java.lang.String r3 = kotlin.collections.unsigned.UArraysKt.m580contentToStringd6D3K8(r4)
            r6.append(r3)
            goto L_0x012c
        L_0x00fb:
            ...
            int[] r4 = r3.m170unboximpl()
        L_0x0108:
            java.lang.String r3 = kotlin.collections.unsigned.UArraysKt.m579contentToStringXUkPCBk(r4)
            r6.append(r3)
            goto L_0x012c
        L_0x0110:
            ...
            long[] r4 = r3.m249unboximpl()
        L_0x011d:
            java.lang.String r3 = kotlin.collections.unsigned.UArraysKt.m581contentToStringuLth9ew(r4)
            r6.append(r3)
            goto L_0x012c
        L_0x0125:
