...
public final class MovingSubList<E> extends AbstractList<E> implements RandomAccess {
    ...
    public MovingSubList(List<? extends E> list2) {
        Intrinsics.checkNotNullParameter(list2, "list");
        this.list = list2;
    }

    public final void move(int fromIndex2, int toIndex) {
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(fromIndex2, toIndex, this.list.size());
