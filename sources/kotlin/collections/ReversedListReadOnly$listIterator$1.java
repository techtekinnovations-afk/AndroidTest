...
public final class ReversedListReadOnly$listIterator$1 implements ListIterator<T>, KMappedMarker {
    ...
    ReversedListReadOnly$listIterator$1(ReversedListReadOnly<? extends T> $receiver, int $index) {
        this.this$0 = $receiver;
        this.delegateIterator = $receiver.delegate.listIterator(CollectionsKt__ReversedViewsKt.reversePositionIndex$CollectionsKt__ReversedViewsKt($receiver, $index));
    }
