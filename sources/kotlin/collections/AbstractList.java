...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E>, KMappedMarker {
    ...
    public int indexOf(E element) {
        ...
        for (Object item$iv : this) {
            if (Intrinsics.areEqual(item$iv, (Object) element)) {
                return index$iv;
            }
            index$iv++;
        }
    ...
    public int lastIndexOf(E element) {
        ...
        while (iterator$iv.hasPrevious()) {
            if (Intrinsics.areEqual(iterator$iv.previous(), (Object) element)) {
    ...
    private static final class SubList<E> extends AbstractList<E> implements RandomAccess {
        ...
        public SubList(AbstractList<? extends E> list2, int fromIndex2, int toIndex) {
    ...
    public static final class Companion {
        ...
        public final boolean orderedEquals$kotlin_stdlib(Collection<?> c, Collection<?> other) {
            ...
            for (Object elem : c) {
                if (!Intrinsics.areEqual(elem, otherIterator.next())) {
                    return false;
                }
            }
            return true;
