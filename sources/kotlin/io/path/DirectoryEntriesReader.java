...
final class DirectoryEntriesReader extends SimpleFileVisitor<Path> {
    ...
    public DirectoryEntriesReader(boolean followLinks2) {
    ...
    public final List<PathNode> readEntries(PathNode directoryNode2) {
        Intrinsics.checkNotNullParameter(directoryNode2, "directoryNode");
        this.directoryNode = directoryNode2;
        Files.walkFileTree(directoryNode2.getPath(), LinkFollowing.INSTANCE.toVisitOptions(this.followLinks), 1, this);
        this.entries.removeFirst();
        ArrayDeque<PathNode> arrayDeque = this.entries;
        ArrayDeque<PathNode> arrayDeque2 = arrayDeque;
    ...
    public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) {
        ...
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        this.entries.add(new PathNode(file, (Object) null, this.directoryNode));
