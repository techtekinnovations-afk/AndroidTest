...
final class FileVisitorImpl extends SimpleFileVisitor<Path> {
    ...
    public FileVisitorImpl(Function2<? super Path, ? super BasicFileAttributes, ? extends FileVisitResult> onPreVisitDirectory2, Function2<? super Path, ? super BasicFileAttributes, ? extends FileVisitResult> onVisitFile2, Function2<? super Path, ? super IOException, ? extends FileVisitResult> onVisitFileFailed2, Function2<? super Path, ? super IOException, ? extends FileVisitResult> onPostVisitDirectory2) {
        this.onPreVisitDirectory = onPreVisitDirectory2;
        this.onVisitFile = onVisitFile2;
        this.onVisitFileFailed = onVisitFileFailed2;
        this.onPostVisitDirectory = onPostVisitDirectory2;
    }
