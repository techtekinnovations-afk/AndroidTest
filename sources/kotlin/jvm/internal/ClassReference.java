...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        $this$primitiveFqNames_u24lambda_u241.put(TypedValues.Custom.S_BOOLEAN, "kotlin.Boolean");
        ...
        $this$primitiveFqNames_u24lambda_u241.put(TypedValues.Custom.S_FLOAT, "kotlin.Float");
        ...
        Collection<String> $this$associateTo$iv = primitiveFqNames.values();
        Intrinsics.checkNotNullExpressionValue($this$associateTo$iv, "<get-values>(...)");
        ...
        for (Map.Entry next : FUNCTION_CLASSES.entrySet()) {
            $this$classFqNames_u24lambda_u244.put(((Class) next.getKey()).getName(), "kotlin.Function" + ((Number) next.getValue()).intValue());
        }
