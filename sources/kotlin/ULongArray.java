...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static boolean m238equalsimpl(long[] jArr, Object obj) {
        return (obj instanceof ULongArray) && Intrinsics.areEqual((Object) jArr, (Object) ((ULongArray) obj).m249unboximpl());
    }
    ...
    public static final long m240getsVKNKU(long[] arg0, int index) {
        return ULong.m180constructorimpl(arg0[index]);
    }
    ...
    private static final class Iterator implements java.util.Iterator<ULong>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ Object next() {
            return ULong.m174boximpl(m250nextsVKNKU());
        }
        ...
        public long m250nextsVKNKU() {
            if (this.index < this.array.length) {
                long[] jArr = this.array;
                int i = this.index;
                this.index = i + 1;
                return ULong.m180constructorimpl(jArr[i]);
            }
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        return m237containsAllimpl(this.storage, elements);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m237containsAllimpl(long[] arg0, Collection<ULong> elements) {
        Object it;
        Intrinsics.checkNotNullParameter(elements, "elements");
        ...
        for (Object it2 : $this$all$iv) {
            if (!(it2 instanceof ULong) || !ArraysKt.contains(arg0, ((ULong) it2).m232unboximpl())) {
                it = null;
                continue;
            } else {
                it = 1;
