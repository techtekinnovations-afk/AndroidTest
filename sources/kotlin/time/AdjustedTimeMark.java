...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1327getAdjustmentUwyO8pc() {
    ...
    public TimeMark m1328minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1478minusLRDsOJo(this, duration);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m1326elapsedNowUwyO8pc() {
        return Duration.m1373minusLRDsOJo(this.mark.m1475elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1329plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1374plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
