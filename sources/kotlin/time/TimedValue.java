...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1505copyRFiDyg4$default(TimedValue timedValue, T t, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m1507copyRFiDyg4(t, j);
    }
    ...
    public final long m1506component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1507copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.value, (Object) timedValue.value) && Duration.m1343equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        return ((this.value == null ? 0 : this.value.hashCode()) * 31) + Duration.m1366hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1387toStringimpl(this.duration) + ')';
    }
