...
final class SafePublicationLazyImpl<T> implements Lazy<T>, Serializable {
    ...
    public SafePublicationLazyImpl(Function0<? extends T> initializer2) {
    ...
    public T getValue() {
        ...
        if (initializerValue != null) {
            ...
            if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(valueUpdater, this, UNINITIALIZED_VALUE.INSTANCE, newValue)) {
