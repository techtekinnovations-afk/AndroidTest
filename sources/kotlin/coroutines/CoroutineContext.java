...
public interface CoroutineContext {
    ...
    public interface Element extends CoroutineContext {
        ...
        public static final class DefaultImpls {
            ...
            public static <R> R fold(Element $this, R initial, Function2<? super R, ? super Element, ? extends R> operation) {
            ...
            public static CoroutineContext minusKey(Element $this, Key<?> key) {
                Intrinsics.checkNotNullParameter(key, "key");
                return Intrinsics.areEqual((Object) $this.getKey(), (Object) key) ? EmptyCoroutineContext.INSTANCE : $this;
            }
        }
    }
}
