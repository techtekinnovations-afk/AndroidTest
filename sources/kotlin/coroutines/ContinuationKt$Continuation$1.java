...
public final class ContinuationKt$Continuation$1 implements Continuation<T> {
    ...
    public ContinuationKt$Continuation$1(CoroutineContext $context2, Function1<? super Result<? extends T>, Unit> $resumeWith2) {
        this.$context = $context2;
        this.$resumeWith = $resumeWith2;
    }
    ...
    public void resumeWith(Object result) {
        this.$resumeWith.invoke(Result.m5boximpl(result));
    }
}
