...
public final class UStringsKt {
    ...
    public static final String m1311toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
        String num = Integer.toString($this$toString_u2dLxnNnR4 & 255, CharsKt.checkRadix(radix));
        Intrinsics.checkNotNullExpressionValue(num, "toString(...)");
        return num;
    }

    /* renamed from: toString-olVBNx4  reason: not valid java name */
    public static final String m1313toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1312toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
        return UnsignedKt.ulongToString(((long) $this$toString_u2dV7xB4Y4) & 4294967295L, CharsKt.checkRadix(radix));
    }

    /* renamed from: toString-JSWoG40  reason: not valid java name */
    public static final String m1310toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m74unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m337unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m153unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m232unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m153unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m101constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m18boximpl(UByte.m24constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m153unboximpl();
        if (Integer.compare(r0 ^ Integer.MIN_VALUE, UInt.m101constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m281boximpl(UShort.m287constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m101constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (Integer.compare(result ^ Integer.MIN_VALUE, limitBeforeMul ^ Integer.MIN_VALUE) > 0) {
            ...
            int result2 = UInt.m101constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m101constructorimpl(UInt.m101constructorimpl(digit) + result2);
            if (Integer.compare(result ^ Integer.MIN_VALUE, beforeAdding ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
        }
        return UInt.m95boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m180constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (Long.compare(result ^ Long.MIN_VALUE, limitBeforeMul ^ Long.MIN_VALUE) > 0) {
                if (limitBeforeMul != 512409557603043100L) {
                    return null;
                }
                limitBeforeMul = UByte$$ExternalSyntheticBackport3.m(-1, uradix);
                if (Long.compare(result ^ Long.MIN_VALUE, limitBeforeMul ^ Long.MIN_VALUE) > 0) {
                    return null;
                }
            }
            long result2 = ULong.m180constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m180constructorimpl(ULong.m180constructorimpl(((long) UInt.m101constructorimpl(digit)) & 4294967295L) + result2);
            if (Long.compare(result ^ Long.MIN_VALUE, beforeAdding ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
        ...
        return ULong.m174boximpl(result);
    }
}
