...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(String $this$replace, char oldChar, char newChar, boolean ignoreCase) {
        ...
        StringBuilder $this$replace_u24lambda_u241 = sb;
        CharSequence $this$forEach$iv = $this$replace;
        for (int i = 0; i < $this$forEach$iv.length(); i++) {
            char c = $this$forEach$iv.charAt(i);
            $this$replace_u24lambda_u241.append(CharsKt.equals(c, oldChar, ignoreCase) ? newChar : c);
        }
    ...
    public static final String replace(String $this$replace, String oldValue, String newValue, boolean ignoreCase) {
        ...
        if (newLengthHint >= 0) {
            ...
            do {
                ...
                if (occurrenceIndex >= $this$replace_u24lambda_u242.length() || (occurrenceIndex = StringsKt.indexOf((CharSequence) $this$replace_u24lambda_u242, oldValue, occurrenceIndex + searchStep, ignoreCase)) <= 0) {
                    String sb = stringBuilder.append($this$replace_u24lambda_u242, i, $this$replace_u24lambda_u242.length()).toString();
            ...
            String sb2 = stringBuilder.append($this$replace_u24lambda_u242, i, $this$replace_u24lambda_u242.length()).toString();
            Intrinsics.checkNotNullExpressionValue(sb2, "toString(...)");
            return sb2;
        }
    ...
    public static final String replaceFirst(String $this$replaceFirst, String oldValue, String newValue, boolean ignoreCase) {
        ...
        int index = StringsKt.indexOf$default((CharSequence) $this$replaceFirst, oldValue2, 0, ignoreCase, 2, (Object) null);
        if (index < 0) {
            return $this$replaceFirst;
        }
        return StringsKt.replaceRange((CharSequence) $this$replaceFirst, index, oldValue2.length() + index, (CharSequence) newValue).toString();
    }
    ...
    public static final boolean regionMatches(CharSequence $this$regionMatches, int thisOffset, CharSequence other, int otherOffset, int length, boolean ignoreCase) {
        ...
        int thisOffset2 = thisOffset;
        int otherOffset2 = otherOffset;
        int length2 = length;
        boolean ignoreCase2 = ignoreCase;
        boolean regionMatches = StringsKt.regionMatches((String) $this$regionMatches, thisOffset2, (String) other, otherOffset2, length2, ignoreCase2);
        int i = thisOffset2;
        int i2 = otherOffset2;
        int otherOffset3 = length2;
        int length3 = ignoreCase2;
    ...
    public static final boolean regionMatches(String $this$regionMatches, int thisOffset, String other, int otherOffset, int length, boolean ignoreCase) {
        ...
        Intrinsics.checkNotNullParameter(other, "other");
        if (!ignoreCase) {
            boolean regionMatches = $this$regionMatches.regionMatches(thisOffset, other, otherOffset, length);
            String str = other;
            int i = thisOffset;
            int thisOffset2 = ignoreCase;
            int i2 = length;
            int length2 = otherOffset;
            String str2 = str;
            return regionMatches;
        }
        String other2 = other;
        int thisOffset3 = thisOffset;
        boolean ignoreCase2 = ignoreCase;
        int length3 = length;
        return $this$regionMatches.regionMatches(ignoreCase2, thisOffset3, other2, otherOffset, length3);
    }
    ...
    public static final String capitalize(String $this$capitalize, Locale locale) {
        ...
        if ($this$capitalize.length() > 0) {
            ...
            if (Character.isLowerCase(firstChar)) {
                ...
                StringBuilder $this$capitalize_u24lambda_u244 = sb;
                ...
                $this$capitalize_u24lambda_u244.append(substring2);
                String sb2 = sb.toString();
                Intrinsics.checkNotNullExpressionValue(sb2, "toString(...)");
                return sb2;
            }
