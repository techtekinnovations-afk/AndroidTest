...
final class DelimitedRangesSequence implements Sequence<IntRange> {
    ...
    public DelimitedRangesSequence(CharSequence input2, int startIndex2, int limit2, Function2<? super CharSequence, ? super Integer, Pair<Integer, Integer>> getNextMatch2) {
        Intrinsics.checkNotNullParameter(input2, "input");
        Intrinsics.checkNotNullParameter(getNextMatch2, "getNextMatch");
        this.input = input2;
        this.startIndex = startIndex2;
        this.limit = limit2;
        this.getNextMatch = getNextMatch2;
    }
