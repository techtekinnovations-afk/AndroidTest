...
public final class Regex implements Serializable {
    ...
    public Regex(java.lang.String r3, java.util.Set<? extends kotlin.text.RegexOption> r4) {
        /*
            ...
            int r1 = kotlin.text.RegexKt.toInt(r1)
            int r0 = r0.ensureUnicodeCase(r1)
            java.util.regex.Pattern r0 = java.util.regex.Pattern.compile(r3, r0)
            java.lang.String r1 = "compile(...)"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r1)
    ...
    public final Set<RegexOption> getOptions() {
        ...
        EnumSet $this$fromInt_u24lambda_u241$iv = allOf;
        Intrinsics.checkNotNull($this$fromInt_u24lambda_u241$iv);
        CollectionsKt.retainAll($this$fromInt_u24lambda_u241$iv, new Regex$special$$inlined$fromInt$1(value$iv));
    ...
    public final Sequence<MatchResult> findAll(CharSequence input, int startIndex) {
        ...
        if (startIndex >= 0 && startIndex <= input.length()) {
            return SequencesKt.generateSequence(new Regex$findAll$1(this, input, startIndex), Regex$findAll$2.INSTANCE);
        }
    ...
    public final String replace(CharSequence input, Function1<? super MatchResult, ? extends CharSequence> transform) {
        ...
        MatchResult match = find$default(this, input, 0, 2, (Object) null);
        if (match == null) {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new Regex$splitToSequence$1(this, input, limit, (Continuation<? super Regex$splitToSequence$1>) null));
    }
