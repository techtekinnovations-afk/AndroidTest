...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    public static final CharSequence trim(CharSequence $this$trim, Function1<? super Character, Boolean> predicate) {
        ...
        while (startIndex <= endIndex) {
            boolean match = predicate.invoke(Character.valueOf($this$trim.charAt(!startFound ? startIndex : endIndex))).booleanValue();
            if (!startFound) {
                if (!match) {
                    startFound = true;
                } else {
    ...
    public static final String trim(String $this$trim, Function1<? super Character, Boolean> predicate) {
        ...
        while (startIndex$iv <= endIndex$iv) {
            boolean match$iv = predicate.invoke(Character.valueOf($this$trim$iv.charAt(!startFound$iv ? startIndex$iv : endIndex$iv))).booleanValue();
            if (!startFound$iv) {
                if (!match$iv) {
                    startFound$iv = true;
                } else {
    ...
    public static final String trimStart(String $this$trimStart, Function1<? super Character, Boolean> predicate) {
        ...
        while (true) {
            if (index$iv >= length) {
                charSequence = "";
                break;
            } else if (!predicate.invoke(Character.valueOf($this$trimStart$iv.charAt(index$iv))).booleanValue()) {
    ...
    public static final String trim(String $this$trim, char... chars) {
        ...
        while (startIndex$iv$iv <= endIndex$iv$iv) {
            char it = ArraysKt.contains(chars, $this$trim$iv$iv.charAt(!startFound$iv$iv ? startIndex$iv$iv : endIndex$iv$iv));
            if (!startFound$iv$iv) {
                if (it == 0) {
    ...
    public static final CharSequence trimEnd(CharSequence $this$trimEnd, char... chars) {
        ...
        if (length >= 0) {
            do {
                int index$iv = length;
                length--;
                if (ArraysKt.contains(chars, $this$trimEnd$iv.charAt(index$iv)) == 0) {
    ...
    public static final CharSequence trim(CharSequence $this$trim) {
        ...
        boolean startFound$iv = false;
        while (startIndex$iv <= endIndex$iv) {
            boolean match$iv = CharsKt.isWhitespace($this$trim$iv.charAt(!startFound$iv ? startIndex$iv : endIndex$iv));
            if (!startFound$iv) {
                if (!match$iv) {
                    startFound$iv = true;
                } else {
    ...
    public static final CharSequence trimEnd(CharSequence $this$trimEnd) {
        ...
        if (length >= 0) {
            do {
                int index$iv = length;
                length--;
                if (CharsKt.isWhitespace($this$trimEnd$iv.charAt(index$iv)) == 0) {
                    return $this$trimEnd$iv.subSequence(0, index$iv + 1);
                }
            } while (length >= 0);
        }
    ...
    public static final boolean isBlank(CharSequence $this$isBlank) {
        ...
        for (int i = 0; i < $this$all$iv.length(); i++) {
            if (CharsKt.isWhitespace($this$all$iv.charAt(i)) == 0) {
                return false;
            }
        }
        return true;
    ...
    public static final boolean hasSurrogatePairAt(CharSequence $this$hasSurrogatePairAt, int index) {
        ...
        if (!(index >= 0 && index <= $this$hasSurrogatePairAt.length() + -2) || !Character.isHighSurrogate($this$hasSurrogatePairAt.charAt(index)) || !Character.isLowSurrogate($this$hasSurrogatePairAt.charAt(index + 1))) {
            return false;
        }
        return true;
    }
    ...
    public static final String substringAfter(String $this$substringAfter, String delimiter, String missingDelimiterValue) {
        ...
        int index = StringsKt.indexOf$default((CharSequence) $this$substringAfter, delimiter2, 0, false, 6, (Object) null);
        if (index == -1) {
            return missingDelimiterValue;
        }
        String substring = $this$substringAfter.substring(delimiter2.length() + index, $this$substringAfter.length());
        Intrinsics.checkNotNullExpressionValue(substring, "substring(...)");
        return substring;
    }
    ...
    public static final String substringAfterLast(String $this$substringAfterLast, String delimiter, String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        String delimiter2 = delimiter;
        int index = StringsKt.lastIndexOf$default((CharSequence) $this$substringAfterLast, delimiter2, 0, false, 6, (Object) null);
        if (index == -1) {
            return missingDelimiterValue;
        }
        String substring = $this$substringAfterLast.substring(delimiter2.length() + index, $this$substringAfterLast.length());
        Intrinsics.checkNotNullExpressionValue(substring, "substring(...)");
        return substring;
    }
    ...
    public static final String replaceAfter(String $this$replaceAfter, String delimiter, String replacement, String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        String delimiter2 = delimiter;
        int index = StringsKt.indexOf$default((CharSequence) $this$replaceAfter, delimiter2, 0, false, 6, (Object) null);
        if (index == -1) {
            return missingDelimiterValue;
        }
        return StringsKt.replaceRange((CharSequence) $this$replaceAfter, delimiter2.length() + index, $this$replaceAfter.length(), (CharSequence) replacement).toString();
    }
    ...
    public static final String replaceAfterLast(String $this$replaceAfterLast, String delimiter, String replacement, String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        String delimiter2 = delimiter;
        int index = StringsKt.lastIndexOf$default((CharSequence) $this$replaceAfterLast, delimiter2, 0, false, 6, (Object) null);
        if (index == -1) {
            return missingDelimiterValue;
        }
        return StringsKt.replaceRange((CharSequence) $this$replaceAfterLast, delimiter2.length() + index, $this$replaceAfterLast.length(), (CharSequence) replacement).toString();
    }
    ...
    public static final boolean startsWith(CharSequence $this$startsWith, CharSequence prefix, int startIndex, boolean ignoreCase) {
        ...
        int i = startIndex2;
        return StringsKt.startsWith$default((String) $this$startsWith, (String) prefix, startIndex2, false, 4, (Object) null);
    }
            ...
            while (true) {
                ...
                while (true) {
                    if (i >= length) {
                        $this$any$iv = null;
                        break;
                    } else if (CharsKt.equals($this$any$iv2[i], charAtIndex, ignoreCase) != 0) {
                        $this$any$iv = 1;
                        break;
                    } else {
                        i++;
    ...
    private static final int indexOf$StringsKt__StringsKt(CharSequence $this$indexOf, CharSequence other, int startIndex, int endIndex, boolean ignoreCase, boolean last) {
        ...
        int i2 = endIndex;
        if (!last) {
            intProgression = new IntRange(RangesKt.coerceAtLeast(i, 0), RangesKt.coerceAtMost(i2, $this$indexOf.length()));
        } else {
            intProgression = RangesKt.downTo(RangesKt.coerceAtMost(i, StringsKt.getLastIndex($this$indexOf)), RangesKt.coerceAtLeast(i2, 0));
        }
        IntProgression indices = intProgression;
        if (!($this$indexOf instanceof String) || !(charSequence instanceof String)) {
            ...
            int index2 = index;
            while (true) {
                if (StringsKt.regionMatchesImpl(charSequence, 0, $this$indexOf, index2, charSequence.length(), ignoreCase)) {
                    return index2;
                }
                if (index2 == last2) {
                    return -1;
            ...
            int index4 = index3;
            while (!StringsKt.regionMatches((String) charSequence, 0, (String) $this$indexOf, index4, charSequence.length(), ignoreCase)) {
                if (index4 == last3) {
                    return -1;
                }
                index4 += step2;
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence $this$findAnyOf, Collection<String> strings, int startIndex, boolean ignoreCase, boolean last) {
        ...
        if (ignoreCase || strings.size() != 1) {
            ...
            int i = startIndex;
            IntProgression indices = !last ? new IntRange(RangesKt.coerceAtLeast(i, 0), charSequence.length()) : RangesKt.downTo(RangesKt.coerceAtMost(i, StringsKt.getLastIndex(charSequence)), 0);
                ...
                if ((step > 0 && index2 <= last2) || (step < 0 && last2 <= index2)) {
                    ...
                    while (true) {
                        ...
                        while (true) {
                            ...
                            if (StringsKt.regionMatches(it2, 0, (String) charSequence, index3, it2.length(), ignoreCase)) {
                                break;
                            }
                        }
                ...
                if ((step2 > 0 && index4 <= last3) || (step2 < 0 && last3 <= index4)) {
                    ...
                    while (true) {
                        ...
                        if (matchingString2 == null) {
                            ...
                            index5 += step2;
                            CharSequence charSequence3 = $this$findAnyOf;
                        } else {
        ...
        CharSequence charSequence4 = $this$findAnyOf;
        int i2 = startIndex;
        if (!last) {
            index = StringsKt.indexOf$default(charSequence4, string, i2, false, 4, (Object) null);
            int i3 = startIndex;
        } else {
            index = StringsKt.lastIndexOf$default(charSequence4, string, i2, false, 4, (Object) null);
            int i4 = i2;
        }
        if (index < 0) {
            return null;
    ...
    public static final int indexOf(CharSequence $this$indexOf, String string, int startIndex, boolean ignoreCase) {
        ...
        CharSequence charSequence = $this$indexOf;
        int i = startIndex;
        boolean z = ignoreCase;
    ...
    public static final int lastIndexOf(CharSequence $this$lastIndexOf, String string, int startIndex, boolean ignoreCase) {
        ...
        CharSequence charSequence = $this$lastIndexOf;
        int i = startIndex;
        boolean z = ignoreCase;
    ...
    public static final boolean contains(CharSequence $this$contains, CharSequence other, boolean ignoreCase) {
        ...
        CharSequence $this$contains2 = $this$contains;
        boolean ignoreCase2 = ignoreCase;
        boolean z = ignoreCase2;
        if (indexOf$StringsKt__StringsKt$default($this$contains2, other, 0, $this$contains2.length(), ignoreCase2, false, 16, (Object) null) >= 0) {
            return true;
        }
        return false;
    }
    ...
    public static final Sequence<String> splitToSequence(CharSequence $this$splitToSequence, String[] delimiters, boolean ignoreCase, int limit) {
        ...
        CharSequence $this$splitToSequence2 = $this$splitToSequence;
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default($this$splitToSequence2, delimiters, 0, ignoreCase, limit, 2, (Object) null), new StringsKt__StringsKt$splitToSequence$1($this$splitToSequence2));
    }
    ...
    public static final List<String> split(CharSequence $this$split, String[] delimiters, boolean ignoreCase, int limit) {
        ...
        CharSequence $this$split2 = $this$split;
        Iterable<IntRange> $this$map$iv = SequencesKt.asIterable(rangesDelimitedBy$StringsKt__StringsKt$default($this$split2, delimiters, 0, ignoreCase, limit, 2, (Object) null));
        Collection destination$iv$iv = new ArrayList(CollectionsKt.collectionSizeOrDefault($this$map$iv, 10));
        for (IntRange it : $this$map$iv) {
            destination$iv$iv.add(StringsKt.substring($this$split2, it));
        }
    ...
    public static final Sequence<String> splitToSequence(CharSequence $this$splitToSequence, char[] delimiters, boolean ignoreCase, int limit) {
        ...
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        CharSequence $this$splitToSequence2 = $this$splitToSequence;
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default($this$splitToSequence2, delimiters, 0, ignoreCase, limit, 2, (Object) null), new StringsKt__StringsKt$splitToSequence$2($this$splitToSequence2));
    }
        ...
        if (nextIndex != -1) {
            ...
            if (limit != 1) {
                ...
                do {
                    ...
                    if ((isLimited && result.size() == limit - 1) || (nextIndex = StringsKt.indexOf($this$split, delimiter, currentOffset, ignoreCase)) == -1) {
                        result.add($this$split.subSequence(currentOffset, $this$split.length()).toString());
                    }
                    result.add($this$split.subSequence(currentOffset, nextIndex).toString());
                    currentOffset = nextIndex + delimiter.length();
                    break;
                } while ((nextIndex = StringsKt.indexOf($this$split, delimiter, currentOffset, ignoreCase)) == -1);
                result.add($this$split.subSequence(currentOffset, $this$split.length()).toString());
                return result;
            }
        }
    ...
    public static final Boolean toBooleanStrictOrNull(String $this$toBooleanStrictOrNull) {
        ...
        if (Intrinsics.areEqual((Object) $this$toBooleanStrictOrNull, (Object) "false")) {
            return false;
        }
        return null;
    }
