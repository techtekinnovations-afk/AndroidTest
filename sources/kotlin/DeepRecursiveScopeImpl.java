...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public <U, S> Object callRecursive(DeepRecursiveFunction<U, S> $this$callRecursive, U value2, Continuation<? super S> $completion) {
        ...
        if (function2 != currentFunction) {
            $this$callRecursive_u24lambda_u242_u24lambda_u241.function = function2;
            Intrinsics.checkNotNull(cont2, "null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
            $this$callRecursive_u24lambda_u242_u24lambda_u241.cont = $this$callRecursive_u24lambda_u242_u24lambda_u241.crossFunctionCompletion(currentFunction, cont2);
        } else {
            Intrinsics.checkNotNull(cont2, "null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
            $this$callRecursive_u24lambda_u242_u24lambda_u241.cont = cont2;
        }
        $this$callRecursive_u24lambda_u242_u24lambda_u241.value = value2;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        if (coroutine_suspended == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended($completion);
        }
    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (cont2 == null) {
                ...
                return result2;
            } else if (Result.m8equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, result2)) {
                try {
                    Function3<? super DeepRecursiveScope<?, ?>, Object, ? super Continuation<Object>, ? extends Object> function3 = this.function;
                    Object obj = this.value;
                    Object r = !(function3 instanceof BaseContinuationImpl) ? IntrinsicsKt.wrapWithContinuationImpl(function3, this, obj, cont2) : ((Function3) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function3, 3)).invoke(this, obj, cont2);
                    if (r != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        Result.Companion companion = Result.Companion;
                        cont2.resumeWith(Result.m6constructorimpl(r));
                    }
                } catch (Throwable e) {
                    Result.Companion companion2 = Result.Companion;
                    cont2.resumeWith(Result.m6constructorimpl(ResultKt.createFailure(e)));
                }
            } else {
