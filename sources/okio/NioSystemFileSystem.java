...
public class NioSystemFileSystem extends JvmSystemFileSystem {
    ...
    public final FileMetadata metadataOrNull(Path nioPath) {
        Path symlinkTarget;
        Path path = nioPath;
        Intrinsics.checkNotNullParameter(path, "nioPath");
        Long l = null;
        try {
            BasicFileAttributes attributes = Files.readAttributes(path, BasicFileAttributes.class, new LinkOption[]{LinkOption.NOFOLLOW_LINKS});
            ...
            Path path2 = symlinkTarget != null ? Path.Companion.get$default(Path.Companion, symlinkTarget, false, 1, (Object) null) : null;
    ...
    public void atomicMove(Path source, Path target) {
        ...
        try {
            Files.move(source.toNioPath(), target.toNioPath(), new CopyOption[]{StandardCopyOption.ATOMIC_MOVE, StandardCopyOption.REPLACE_EXISTING});
        } catch (NoSuchFileException e) {
