...
public abstract class FileSystem {
    ...
    public static /* synthetic */ Object m1621write$default(FileSystem $this, Path file, boolean mustCreate, Function1 writerAction, int i, Object obj) throws IOException {
        if (obj == null) {
            if ((i & 2) != 0) {
                mustCreate = false;
            }
    ...
    public final <T> T m1622read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        ...
        Throwable thrown$iv = null;
        try {
            result$iv = readerAction.invoke((BufferedSource) $this$use$iv);
            if ($this$use$iv != null) {
                try {
                    $this$use$iv.close();
                } catch (Throwable t$iv) {
    ...
    public final <T> T m1623write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
