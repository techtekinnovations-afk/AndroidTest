...
final class EocdRecord {
    ...
    public EocdRecord(long entryCount2, long centralDirectoryOffset2, int commentByteCount2) {
        this.entryCount = entryCount2;
        this.centralDirectoryOffset = centralDirectoryOffset2;
        this.commentByteCount = commentByteCount2;
    }
